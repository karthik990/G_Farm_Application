...
final class C2447Utils {
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public boolean equals(Object obj) {
            return (obj instanceof GenericArrayType) && C2447Utils.equals(this, (GenericArrayType) obj);
        }
        ...
        public String toString() {
            ...
            sb.append(C2447Utils.typeToString(this.componentType));
            sb.append("[]");
            return sb.toString();
        }
    }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            for (Type type3 : typeArr) {
                C2447Utils.checkNotNull(type3, "typeArgument == null");
                C2447Utils.checkNotPrimitive(type3);
            }
            this.ownerType = type;
            this.rawType = type2;
        ...
        public boolean equals(Object obj) {
            return (obj instanceof ParameterizedType) && C2447Utils.equals(this, (ParameterizedType) obj);
        }

        public int hashCode() {
            return (Arrays.hashCode(this.typeArguments) ^ this.rawType.hashCode()) ^ C2447Utils.hashCodeOrZero(this.ownerType);
        }

        public String toString() {
            Type[] typeArr = this.typeArguments;
            if (typeArr.length == 0) {
                return C2447Utils.typeToString(this.rawType);
            }
            StringBuilder sb = new StringBuilder((typeArr.length + 1) * 30);
            sb.append(C2447Utils.typeToString(this.rawType));
            sb.append("<");
            sb.append(C2447Utils.typeToString(this.typeArguments[0]));
            for (int i = 1; i < this.typeArguments.length; i++) {
                sb.append(", ");
                sb.append(C2447Utils.typeToString(this.typeArguments[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            if (typeArr2.length > 1) {
                ...
                if (typeArr2[0] != null) {
                    C2447Utils.checkNotPrimitive(typeArr2[0]);
                ...
                C2447Utils.checkNotPrimitive(typeArr[0]);
        ...
        public Type[] getLowerBounds() {
            ...
            if (type == null) {
                return C2447Utils.EMPTY_TYPE_ARRAY;
            }
            return new Type[]{type};
        }

        public boolean equals(Object obj) {
            return (obj instanceof WildcardType) && C2447Utils.equals(this, (WildcardType) obj);
        }
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder sb = new StringBuilder();
                sb.append("? super ");
                sb.append(C2447Utils.typeToString(this.lowerBound));
                return sb.toString();
                ...
                sb2.append("? extends ");
                sb2.append(C2447Utils.typeToString(this.upperBound));
                return sb2.toString();
            }
        }
    }
    ...
    static java.lang.reflect.Type resolve(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10) {
        ...
        L_0x00b2:
            ...
            r0 = r3[r2]
            java.lang.reflect.Type r8 = resolve(r8, r9, r0)     // Catch:{ all -> 0x00cc }
            r9 = r3[r2]
            if (r8 == r9) goto L_0x00cb
            retrofit2.Utils$WildcardTypeImpl r9 = new retrofit2.Utils$WildcardTypeImpl
            java.lang.reflect.Type[] r10 = new java.lang.reflect.Type[r1]
        ...
        L_0x00cf:
            goto L_0x00ce
        */
        throw new UnsupportedOperationException("Method not decompiled: retrofit2.C2447Utils.resolve(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }

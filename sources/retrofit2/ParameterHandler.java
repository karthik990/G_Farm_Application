...
abstract class ParameterHandler<T> {
    ...
    static final class Field<T> extends ParameterHandler<T> {
        ...
        Field(String str, Converter<T, String> converter, boolean z) {
            this.name = (String) C2447Utils.checkNotNull(str, "name == null");
                ...
                for (Entry entry : map.entrySet()) {
                    ...
                    if (str != null) {
                        ...
                        if (value != null) {
                            ...
                            sb.append(str);
                            sb.append("\"");
                            requestBuilder.addPart(Headers.m1337of(HttpHeaders.CONTENT_DISPOSITION, sb.toString(), "Content-Transfer-Encoding", this.transferEncoding), (RequestBody) this.valueConverter.convert(value));
                        } else {
                            StringBuilder sb2 = new StringBuilder();
    ...
    static final class RelativeUrl extends ParameterHandler<Object> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable Object obj) {
            C2447Utils.checkNotNull(obj, "@Url parameter is null.");

...
final class BuiltInConverters extends Factory {
    ...
    static final class BufferingResponseBodyConverter implements Converter<ResponseBody, ResponseBody> {
        ...
        public ResponseBody convert(ResponseBody responseBody) throws IOException {
            try {
                return C2447Utils.buffer(responseBody);
            } finally {
                responseBody.close();
            }
        }
    ...
    public Converter<ResponseBody, ?> responseBodyConverter(Type type, Annotation[] annotationArr, Retrofit retrofit) {
        ...
        if (type == ResponseBody.class) {
            if (C2447Utils.isAnnotationPresent(annotationArr, Streaming.class)) {
    ...
    public Converter<?, RequestBody> requestBodyConverter(Type type, Annotation[] annotationArr, Annotation[] annotationArr2, Retrofit retrofit) {
        if (RequestBody.class.isAssignableFrom(C2447Utils.getRawType(type))) {

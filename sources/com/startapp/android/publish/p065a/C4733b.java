...
/* renamed from: com.startapp.android.publish.a.b */
/* compiled from: StartAppSDK */
public class C4733b extends LinearLayout {

    /* renamed from: a */
    private static Map<String, String> f2465a = new HashMap<String, String>() {
        {
    ...
    public void setRating(float f) {
        ...
        for (int i3 = 0; i3 < floor; i3++) {
            m2180a("filled_star.png");
        }
        if (i != 0) {
            m2180a("half_star.png");
        }
        for (int i4 = 0; i4 < i2; i4++) {
            m2180a("empty_star.png");
        }
    }

    /* renamed from: a */
    private void m2180a(String str) {
        try {
            int a = C4945h.m2891a(getContext(), 2);
            int a2 = C4945h.m2891a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a3 = C4934a.m2858a(getContext(), str);
            if (a3 == null) {
                a3 = C5150d.m3783a((String) f2465a.get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a3, C4945h.m2891a(getContext(), 15), C4945h.m2891a(getContext(), 15), true));

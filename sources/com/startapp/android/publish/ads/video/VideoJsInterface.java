...
public class VideoJsInterface extends JsInterface {
    ...
    public VideoJsInterface(Context context, Runnable runnable, Runnable runnable2, Runnable runnable3, Runnable runnable4, Runnable runnable5, C5002b bVar, boolean z) {
    ...
    public void replayVideo() {
        C5155g.m3807a(TAG, 3, "replayVideo called");
    ...
    public void skipVideo() {
        C5155g.m3807a(TAG, 3, "skipVideo called");
    ...
    public void toggleSound() {
        C5155g.m3807a(TAG, 3, "toggleSound called");

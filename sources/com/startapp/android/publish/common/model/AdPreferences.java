...
public class AdPreferences implements Serializable {
    ...
    /* renamed from: ai */
    private Boolean f3480ai = null;

    /* renamed from: as */
    private Boolean f3481as = null;
    ...
    private boolean hardwareAccelerated = C5059m.m3378a().mo62392d();
    ...
    public AdPreferences(AdPreferences adPreferences) {
        ...
        this.f3480ai = adPreferences.f3480ai;
        this.f3481as = adPreferences.f3481as;
    ...
    public Gender getGender(Context context) {
        ...
        return gender2 == null ? C5059m.m3378a().mo62399g(context).getGender() : gender2;
    }
    ...
    public String getAge(Context context) {
        String str = this.age;
        return str == null ? C5059m.m3378a().mo62399g(context).getAge() : str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Boolean bool = this.f3480ai;
        if (bool == null ? adPreferences.f3480ai != null : !bool.equals(adPreferences.f3480ai)) {
            return false;
        }
        Boolean bool2 = this.f3481as;
        if (bool2 == null ? adPreferences.f3481as != null : !bool2.equals(adPreferences.f3481as)) {
            return false;
        }

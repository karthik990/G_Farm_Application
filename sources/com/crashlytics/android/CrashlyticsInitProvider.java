    ...
    public boolean onCreate() {
        ...
        if (shouldInitializeFabric) {
            try {
                ...
                Fabric.getLogger().mo64079i(str, "CrashlyticsInitProvider initialization successful");
            } catch (IllegalStateException unused) {
                Fabric.getLogger().mo64079i(str, "CrashlyticsInitProvider initialization unsuccessful");
                return false;
            }
        } else {
            Fabric.getLogger().mo64079i(str, "CrashlyticsInitProvider skipping initialization");
        }
        return true;
    }

...
class MetaDataStore {
    ...
    public void writeUserData(String str, UserMetaData userMetaData) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Fabric.getLogger().mo64077e(CrashlyticsCore.TAG, "Error serializing user metadata.", e);
    ...
    public UserMetaData readUserData(String str) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Fabric.getLogger().mo64077e(CrashlyticsCore.TAG, "Error deserializing user metadata.", e);
    ...
    public void writeKeyData(String str, Map<String, String> map) {
        ...
        try {
            ...
            try {
                ...
                bufferedWriter = bufferedWriter2;
                try {
                    Fabric.getLogger().mo64077e(CrashlyticsCore.TAG, "Error serializing key/value metadata.", e);
                    CommonUtils.closeOrLog(bufferedWriter, str2);
                } catch (Throwable th) {
                    th = th;
                    CommonUtils.closeOrLog(bufferedWriter, str2);
    ...
    private static String userDataToJson(final UserMetaData userMetaData) throws JSONException {
        return new JSONObject() {
            {
                put(MetaDataStore.KEY_USER_ID, userMetaData.f262id);

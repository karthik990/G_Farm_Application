...
class CompositeCreateReportSpiCall implements CreateReportSpiCall {
    ...
    static /* synthetic */ class C12411 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.crashlytics.android.core.CompositeCreateReportSpiCall.C12411.<clinit>():void");
        }
    }
    ...
    public boolean invoke(CreateReportRequest createReportRequest) {
        int i = C12411.$SwitchMap$com$crashlytics$android$core$Report$Type[createReportRequest.report.getType().ordinal()];
        if (i == 1) {

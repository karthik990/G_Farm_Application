...
class BinaryImagesConverter {
    ...
    private JSONArray parseProcMapsJsonFromString(String str) {
        ...
        try {
            ...
            Fabric.getLogger().mo64088w(CrashlyticsCore.TAG, "Unable to parse proc maps string", e);
            return jSONArray;
        }
    }
        ...
        if (parse != null && isRelevant(parse)) {
            try {
                try {
                    ...
                    Fabric.getLogger().mo64075d(str2, "Could not create a binary image json string", e);
                    return null;
                }
                ...
                logger.mo64075d(str2, sb.toString(), e2);
            }
        }
        return null;
    }
    ...
    private File correctDataPath(File file) {
        ...
        if (file.getAbsolutePath().startsWith(DATA_DIR)) {
            try {
                ...
                Fabric.getLogger().mo64077e(CrashlyticsCore.TAG, "Error getting ApplicationInfo", e);
            }
        }
        return file;
    }
    ...
    private static byte[] generateBinaryImagesJsonString(JSONArray jSONArray) {
        ...
        try {
            ...
            Fabric.getLogger().mo64088w(CrashlyticsCore.TAG, "Binary images string is null", e);
            return new byte[0];
        }
    }
    ...
    private static JSONObject createBinaryImageJson(String str, ProcMapEntry procMapEntry) throws JSONException {
        ...
        jSONObject.put(PostalAddressParser.USER_ADDRESS_NAME_KEY, procMapEntry.path);

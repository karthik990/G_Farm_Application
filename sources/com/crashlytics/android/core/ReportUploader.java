...
import p043io.fabric.sdk.android.services.common.BackgroundPriorityRunnable;

class ReportUploader {
    static final Map<String, String> HEADER_INVALID_CLS_FILE = Collections.singletonMap("X-CRASHLYTICS-INVALID-SESSION", IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
    ...
    private class Worker extends BackgroundPriorityRunnable {
        ...
        public void onRun() {
            try {
                ...
                Fabric.getLogger().mo64077e(CrashlyticsCore.TAG, "An unexpected error occurred while attempting to upload crash reports.", e);
            }
    ...
    public synchronized void uploadReports(float f, SendCheck sendCheck) {
        if (this.uploadThread != null) {
            Fabric.getLogger().mo64074d(CrashlyticsCore.TAG, "Report upload has already been started.");
            return;
        }
    ...
    public List<Report> findReports() {
        ...
        Fabric.getLogger().mo64074d(CrashlyticsCore.TAG, "Checking for crash reports...");
        synchronized (this.fileAccessLock) {
        ...
        for (String str : hashMap.keySet()) {
            ...
            sb2.append(str);
            logger2.mo64074d(CrashlyticsCore.TAG, sb2.toString());
        ...
        if (linkedList.isEmpty()) {
            Fabric.getLogger().mo64074d(CrashlyticsCore.TAG, "No reports found.");
        }
        return linkedList;
    }
}

...
import p043io.fabric.sdk.android.services.common.ApiKey;
...
import p043io.fabric.sdk.android.services.common.ExecutorUtils;
import p043io.fabric.sdk.android.services.common.FirebaseInfo;
import p043io.fabric.sdk.android.services.common.IdManager;
import p043io.fabric.sdk.android.services.concurrency.DependsOn;
import p043io.fabric.sdk.android.services.concurrency.Priority;
import p043io.fabric.sdk.android.services.concurrency.PriorityCallable;
import p043io.fabric.sdk.android.services.concurrency.Task;
import p043io.fabric.sdk.android.services.concurrency.UnmetDependencyException;
import p043io.fabric.sdk.android.services.network.DefaultHttpRequestFactory;
...
import p043io.fabric.sdk.android.services.persistence.FileStoreImpl;
...
public class CrashlyticsCore extends Kit<Void> {
    ...
    private static final class CrashMarkerCheck implements Callable<Boolean> {
        ...
        public Boolean call() throws Exception {
            ...
            Fabric.getLogger().mo64074d(CrashlyticsCore.TAG, "Found previous crash marker.");
    ...
    public boolean onPreExecute(Context context) {
        ...
        if (!isDataCollectionEnabled) {
            Fabric.getLogger().mo64074d(str, "Crashlytics is disabled, because data collection is disabled by Firebase.");
            this.disabled = true;
        }
        if (this.disabled) {
            return false;
        ...
        if (isBuildIdValid(resolveBuildId, CommonUtils.getBooleanResourceValue(context2, CRASHLYTICS_REQUIRE_BUILD_ID, true))) {
            try {
                ...
                logger.mo64079i(str, sb.toString());
                ...
                if (!didPreviousInitializationFail || !CommonUtils.canTryConnection(context)) {
                    Fabric.getLogger().mo64074d(str, "Exception handling initialization successful");
                    return true;
                }
                Fabric.getLogger().mo64074d(str, "Crashlytics did not finish previous background initialization. Initializing synchronously.");
                finishInitSynchronously();
                return false;
            } catch (Exception e) {
                Fabric.getLogger().mo64077e(str, "Crashlytics was not started due to an exception during initialization", e);
    ...
    public Void doInBackground() {
        ...
        try {
            ...
            if (awaitSettingsData == null) {
                Fabric.getLogger().mo64087w(str, "Received null settings, skipping report submission!");
                markInitializationComplete();
                return null;
            }
            this.controller.registerAnalyticsEventListener(awaitSettingsData);
            if (!awaitSettingsData.featuresData.collectReports) {
                Fabric.getLogger().mo64074d(str, "Collection of crash reports disabled in Crashlytics settings.");
                markInitializationComplete();
                return null;
            } else if (!DataCollectionArbiter.getInstance(getContext()).isDataCollectionEnabled()) {
                Fabric.getLogger().mo64074d(str, "Automatic collection of crash reports disabled by Firebase settings.");
                markInitializationComplete();
                return null;
            } else {
                ...
                if (nativeCrashData != null && !this.controller.finalizeNativeReport(nativeCrashData)) {
                    Fabric.getLogger().mo64074d(str, "Could not finalize previous NDK sessions.");
                }
                if (!this.controller.finalizeSessions(awaitSettingsData.sessionData)) {
                    Fabric.getLogger().mo64074d(str, "Could not finalize previous sessions.");
                }
            ...
            Fabric.getLogger().mo64077e(str, "Crashlytics encountered a problem during asynchronous initialization.", e);
        } catch (Throwable th) {
            markInitializationComplete();
            throw th;
        }
        ...
        if (!this.disabled && ensureFabricWithCalled("prior to setting keys.")) {
            ...
            if (str == null) {
                ...
                if (context == null || !CommonUtils.isAppDebuggable(context)) {
                    Fabric.getLogger().mo64077e(str4, "Attempting to set custom attribute with null key, ignoring.", null);
                    return;
                }
            ...
            Fabric.getLogger().mo64074d(str4, "Exceeded maximum number of custom attributes (64)");
        }
    }
    ...
    public boolean verifyPinning(URL url) {
        try {
            ...
            Fabric.getLogger().mo64077e(TAG, "Could not verify SSL pinning", e);
            return false;
        }
    }
    ...
    public synchronized void setListener(CrashlyticsListener crashlyticsListener) {
        Fabric.getLogger().mo64087w(TAG, "Use of setListener is deprecated.");
        if (crashlyticsListener != null) {
            this.listener = crashlyticsListener;
        } else {
            throw new IllegalArgumentException("listener must not be null.");
    ...
    private void finishInitSynchronously() {
        C12791 r0 = new PriorityCallable<Void>() {
        ...
        Logger logger = Fabric.getLogger();
        String str = TAG;
        logger.mo64074d(str, "Crashlytics detected incomplete initialization on previous app launch. Will initialize synchronously.");
        try {
            submit.get(4, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
            Fabric.getLogger().mo64077e(str, "Crashlytics was interrupted during initialization.", e);
        } catch (ExecutionException e2) {
            Fabric.getLogger().mo64077e(str, "Problem encountered during Crashlytics initialization.", e2);
        } catch (TimeoutException e3) {
            Fabric.getLogger().mo64077e(str, "Crashlytics timed out during initialization.", e3);
        }
    }
    ...
    public void markInitializationStarted() {
        this.backgroundWorker.submitAndWait(new Callable<Void>() {
            public Void call() throws Exception {
                ...
                Fabric.getLogger().mo64074d(CrashlyticsCore.TAG, "Initialization marker file created.");
                return null;
            }
        });
    }
        ...
        this.backgroundWorker.submit((Callable<T>) new Callable<Boolean>() {
            public Boolean call() throws Exception {
                ...
                try {
                    ...
                    Fabric.getLogger().mo64077e(str, "Problem encountered deleting Crashlytics initialization marker.", e);
    ...
    private void checkForPreviousCrash() {
        if (Boolean.TRUE.equals((Boolean) this.backgroundWorker.submitAndWait(new CrashMarkerCheck(this.crashMarker)))) {
            try {
                ...
                Fabric.getLogger().mo64077e(TAG, "Exception thrown by CrashlyticsListener while notifying of previous crash.", e);
            }
        }
    }
    ...
    private static boolean ensureFabricWithCalled(String str) {
        ...
        sb.append(str);
        logger.mo64077e(TAG, sb.toString(), null);
        return false;
    }
    ...
    static boolean isBuildIdValid(String str, boolean z) {
        String str2 = TAG;
        if (!z) {
            Fabric.getLogger().mo64074d(str2, "Configured not to require a build ID.");
            return true;

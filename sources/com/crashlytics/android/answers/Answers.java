...
public class Answers extends Kit<Boolean> {
    ...
    public boolean onPreExecute() {
        ...
        try {
            ...
            Fabric.getLogger().mo64077e(TAG, "Error retrieving app properties", e);
            return false;
        }
    }
    ...
    public Boolean doInBackground() {
        String str = TAG;
        boolean isDataCollectionEnabled = DataCollectionArbiter.getInstance(getContext()).isDataCollectionEnabled();
        Boolean valueOf = Boolean.valueOf(false);
        if (!isDataCollectionEnabled) {
            Fabric.getLogger().mo64074d(Fabric.TAG, "Analytics collection disabled, because data collection is disabled by Firebase.");
        ...
        try {
            ...
            if (awaitSettingsData == null) {
                Fabric.getLogger().mo64076e(str, "Failed to retrieve settings");
                return valueOf;
            } else if (awaitSettingsData.featuresData.collectAnalytics) {
                Fabric.getLogger().mo64074d(str, "Analytics collection enabled");
                this.analyticsManager.setAnalyticsSettingsData(awaitSettingsData.analyticsSettingsData, getOverridenSpiEndpoint());
                return Boolean.valueOf(true);
            } else {
                Fabric.getLogger().mo64074d(str, "Analytics collection disabled");
                this.analyticsManager.disable();
                return valueOf;
            }
        } catch (Exception e) {
            Fabric.getLogger().mo64077e(str, "Error dealing with settings", e);
            return valueOf;
        }
    }
    ...
    private void logFirebaseModeEnabledWarning(String str) {
        ...
        logger.mo64087w(TAG, sb.toString());
    }
}

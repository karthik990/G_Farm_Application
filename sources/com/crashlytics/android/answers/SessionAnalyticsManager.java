...
import p043io.fabric.sdk.android.ActivityLifecycleManager;
...
class SessionAnalyticsManager implements Listener {
    ...
    public void onCustom(CustomEvent customEvent) {
        ...
        logger.mo64074d(Answers.TAG, sb.toString());
    ...
    public void onCrash(String str, String str2) {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            Fabric.getLogger().mo64074d(Answers.TAG, "Logged crash");
    ...
    public void onInstall(long j) {
        Fabric.getLogger().mo64074d(Answers.TAG, "Logged install");
    ...
    public void onBackground() {
        Fabric.getLogger().mo64074d(Answers.TAG, "Flush events when app is backgrounded");

...
import p043io.fabric.sdk.android.services.events.EventsStorageListener;
...
class AnswersEventsHandler implements EventsStorageListener {
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo64077e(Answers.TAG, "Failed to set analytics settings data", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo64077e(Answers.TAG, "Failed to disable events", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo64077e(Answers.TAG, "Failed to send events files", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo64077e(Answers.TAG, "Failed to enable events", e);
                }
            }
        });
    }
        ...
        executeAsync(new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo64077e(Answers.TAG, "Failed to flush events", e);
                }
            }
        });
    }
        ...
        C12336 r0 = new Runnable() {
            public void run() {
                try {
                    ...
                    Fabric.getLogger().mo64077e(Answers.TAG, "Failed to process event", e);
                }
            }
        };
        if (z) {
    ...
    private void executeSync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo64077e(Answers.TAG, "Failed to run events task", e);
        }
    }
    ...
    private void executeAsync(Runnable runnable) {
        try {
            ...
            Fabric.getLogger().mo64077e(Answers.TAG, "Failed to submit events task", e);
        }
    }
}

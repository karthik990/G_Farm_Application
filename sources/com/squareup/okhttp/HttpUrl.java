...
public final class HttpUrl {
    ...
    static /* synthetic */ class C46431 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.okhttp.HttpUrl.C46431.<clinit>():void");
        }
    }
    ...
    /* synthetic */ HttpUrl(Builder builder, C46431 r2) {
        this(builder);
    }
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C46431.$SwitchMap$com$squareup$okhttp$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i != 2) {
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z2) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte((int) HEX_DIGITS[readByte & Ascii.f1875SI]);
                    }
                } else {
                    buffer.writeUtf8CodePoint(codePointAt);
                }

...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f2366dn;
    private int end;
    private final int length = this.f2366dn.length();
    private int pos;

    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f2366dn = x500Principal.getName("RFC2253");
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f2366dn.toCharArray();

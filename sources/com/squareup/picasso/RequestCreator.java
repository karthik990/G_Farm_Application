...
public class RequestCreator {
    ...
    public Bitmap get() throws IOException {
        ...
        if (this.deferred) {
            ...
            GetAction getAction = new GetAction(this.picasso, createRequest, this.memoryPolicy, this.networkPolicy, this.tag, C4694Utils.createKey(createRequest, new StringBuilder()));
    ...
    public void fetch(Callback callback) {
        ...
        if (this.deferred) {
            ...
            Request createRequest = createRequest(nanoTime);
            String createKey = C4694Utils.createKey(createRequest, new StringBuilder());
            if (this.picasso.quickMemoryCacheCheck(createKey) != null) {
                if (this.picasso.loggingEnabled) {
                    ...
                    C4694Utils.log("Main", "completed", plainId, sb.toString());
                }
                if (callback != null) {
                    callback.onSuccess();
                    return;
    ...
    public void into(Target target) {
        ...
        if (target == null) {
            ...
            Request createRequest = createRequest(nanoTime);
            String createKey = C4694Utils.createKey(createRequest);
    ...
    public void into(RemoteViews remoteViews, int i, int i2, Notification notification) {
        ...
        if (remoteViews == null) {
            ...
            NotificationAction notificationAction = new NotificationAction(this.picasso, createRequest, remoteViews2, i3, i4, notification2, this.memoryPolicy, this.networkPolicy, C4694Utils.createKey(createRequest, new StringBuilder()), this.tag, this.errorResId);
    ...
    public void into(RemoteViews remoteViews, int i, int[] iArr) {
        ...
        if (remoteViews == null) {
            ...
            int i2 = i;
            int[] iArr2 = iArr;
            AppWidgetAction appWidgetAction = new AppWidgetAction(this.picasso, createRequest, remoteViews2, i2, iArr2, this.memoryPolicy, this.networkPolicy, C4694Utils.createKey(createRequest, new StringBuilder()), this.tag, this.errorResId);
    ...
    private Request createRequest(long j) {
        ...
        build.f2368id = andIncrement;
        build.started = j;
        boolean z = this.picasso.loggingEnabled;
        String str = "Main";
        if (z) {
            C4694Utils.log(str, "created", build.plainId(), build.toString());
        }
        Request transformRequest = this.picasso.transformRequest(build);
        if (transformRequest != build) {
            transformRequest.f2368id = andIncrement;
            ...
            if (z) {
                ...
                C4694Utils.log(str, "changed", logId, sb.toString());
            }
        }

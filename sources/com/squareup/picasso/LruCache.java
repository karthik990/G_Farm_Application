...
public class LruCache implements Cache {
    ...
    public LruCache(Context context) {
        this(C4694Utils.calculateMemoryCacheSize(context));
    }
    ...
    public void set(String str, Bitmap bitmap) {
        ...
        synchronized (this) {
            this.putCount++;
            this.size += C4694Utils.getBitmapBytes(bitmap);
            Bitmap bitmap2 = (Bitmap) this.map.put(str, bitmap);
            if (bitmap2 != null) {
                this.size -= C4694Utils.getBitmapBytes(bitmap2);
            }
        }
    ...
    private void trimToSize(int r4) {
        ...
        L_0x001e:
            ...
            int r0 = com.squareup.picasso.C4694Utils.getBitmapBytes(r0)     // Catch:{ all -> 0x0071 }
            int r1 = r1 - r0

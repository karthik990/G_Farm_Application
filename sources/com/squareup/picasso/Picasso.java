        ...
        public void handleMessage(Message message) {
            ...
            if (i != 3) {
                ...
                if (action2.getPicasso().loggingEnabled) {
                    C4694Utils.log("Main", "canceled", action2.request.logId(), "target got garbage collected");
                }
    ...
    public static class Builder {
        ...
        public Picasso build() {
            ...
            if (this.downloader == null) {
                this.downloader = C4694Utils.createDefaultDownloader(context2);
            }
            if (this.cache == null) {
    ...
    public void resumeAction(Action action) {
        ...
        if (quickMemoryCacheCheck != null) {
            ...
            if (this.loggingEnabled) {
                ...
                C4694Utils.log(str, "completed", logId, sb.toString());
                return;
            }
            return;
        }
        ...
        if (this.loggingEnabled) {
            C4694Utils.log(str, "resumed", action.request.logId());
        }
    }
    ...
    private void deliverAction(Bitmap bitmap, LoadedFrom loadedFrom, Action action) {
        if (!action.isCancelled()) {
            ...
            if (bitmap == null) {
                action.error();
                if (this.loggingEnabled) {
                    C4694Utils.log(str, "errored", action.request.logId());
                }

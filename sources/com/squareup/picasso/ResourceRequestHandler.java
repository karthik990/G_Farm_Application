...
class ResourceRequestHandler extends RequestHandler {
    ...
    public Result load(Request request, int i) throws IOException {
        Resources resources = C4694Utils.getResources(this.context, request);
        return new Result(decodeResource(resources, C4694Utils.getResourceId(resources, request), request), LoadedFrom.DISK);
    }

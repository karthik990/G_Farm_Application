...
public abstract class RequestHandler {
    ...
    public static final class Result {
        ...
        public Result(Bitmap bitmap2, LoadedFrom loadedFrom2) {
            this((Bitmap) C4694Utils.checkNotNull(bitmap2, "bitmap == null"), null, loadedFrom2, 0);
        }

        public Result(InputStream inputStream, LoadedFrom loadedFrom2) {
            this(null, (InputStream) C4694Utils.checkNotNull(inputStream, "stream == null"), loadedFrom2, 0);
        }
        ...
        Result(Bitmap bitmap2, InputStream inputStream, LoadedFrom loadedFrom2, int i) {
            ...
            if (z ^ z2) {
                ...
                this.loadedFrom = (LoadedFrom) C4694Utils.checkNotNull(loadedFrom2, "loadedFrom == null");

...
public class UrlConnectionDownloader implements Downloader {
    ...
    private static class ResponseCacheIcs {
        ...
        static Object install(Context context) throws IOException {
            File createDefaultCacheDir = C4694Utils.createDefaultCacheDir(context);
            HttpResponseCache installed = HttpResponseCache.getInstalled();
            return installed == null ? HttpResponseCache.install(createDefaultCacheDir, C4694Utils.calculateDiskCacheSize(createDefaultCacheDir)) : installed;
        }
    ...
    public Response load(Uri uri, int i) throws IOException {
        ...
        if (responseCode < 300) {
            ...
            return new Response(openConnection.getInputStream(), C4694Utils.parseResponseSourceHeader(openConnection.getHeaderField(RESPONSE_SOURCE)), headerFieldInt);
        }

...
public final class Context extends GeneratedMessageLite<Context, Builder> implements ContextOrBuilder {
    ...
    private ProtobufList<ContextRule> rules_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setRules(int i, com.google.api.ContextRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addRules(com.google.api.ContextRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((ContextRule) builder.build());
    }

    /* access modifiers changed from: private */
    public void addRules(int i, com.google.api.ContextRule.Builder builder) {
        ensureRulesIsMutable();

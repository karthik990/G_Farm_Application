...
public final class ConfigChange extends GeneratedMessageLite<ConfigChange, Builder> implements ConfigChangeOrBuilder {
    ...
    private ProtobufList<Advice> advices_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setAdvices(int i, com.google.api.Advice.Builder builder) {
        ensureAdvicesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addAdvices(com.google.api.Advice.Builder builder) {
        ensureAdvicesIsMutable();
        this.advices_.add((Advice) builder.build());
    }

    /* access modifiers changed from: private */
    public void addAdvices(int i, com.google.api.Advice.Builder builder) {
        ensureAdvicesIsMutable();

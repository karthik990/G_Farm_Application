...
public final class Quota extends GeneratedMessageLite<Quota, Builder> implements QuotaOrBuilder {
    ...
    private ProtobufList<QuotaLimit> limits_ = emptyProtobufList();
    private ProtobufList<MetricRule> metricRules_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setLimits(int i, com.google.api.QuotaLimit.Builder builder) {
        ensureLimitsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addLimits(com.google.api.QuotaLimit.Builder builder) {
        ensureLimitsIsMutable();
        this.limits_.add((QuotaLimit) builder.build());
    }

    /* access modifiers changed from: private */
    public void addLimits(int i, com.google.api.QuotaLimit.Builder builder) {
        ensureLimitsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setMetricRules(int i, com.google.api.MetricRule.Builder builder) {
        ensureMetricRulesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addMetricRules(com.google.api.MetricRule.Builder builder) {
        ensureMetricRulesIsMutable();
        this.metricRules_.add((MetricRule) builder.build());
    }

    /* access modifiers changed from: private */
    public void addMetricRules(int i, com.google.api.MetricRule.Builder builder) {
        ensureMetricRulesIsMutable();

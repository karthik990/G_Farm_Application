...
public final class Usage extends GeneratedMessageLite<Usage, Builder> implements UsageOrBuilder {
    ...
    private ProtobufList<UsageRule> rules_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setRules(int i, com.google.api.UsageRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addRules(com.google.api.UsageRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((UsageRule) builder.build());
    }

    /* access modifiers changed from: private */
    public void addRules(int i, com.google.api.UsageRule.Builder builder) {
        ensureRulesIsMutable();

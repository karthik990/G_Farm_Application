...
public final class LogDescriptor extends GeneratedMessageLite<LogDescriptor, Builder> implements LogDescriptorOrBuilder {
    ...
    private ProtobufList<LabelDescriptor> labels_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setLabels(int i, com.google.api.LabelDescriptor.Builder builder) {
        ensureLabelsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addLabels(com.google.api.LabelDescriptor.Builder builder) {
        ensureLabelsIsMutable();
        this.labels_.add((LabelDescriptor) builder.build());
    }

    /* access modifiers changed from: private */
    public void addLabels(int i, com.google.api.LabelDescriptor.Builder builder) {
        ensureLabelsIsMutable();

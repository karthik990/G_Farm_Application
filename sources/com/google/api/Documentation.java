...
public final class Documentation extends GeneratedMessageLite<Documentation, Builder> implements DocumentationOrBuilder {
    ...
    private ProtobufList<Page> pages_ = emptyProtobufList();
    private ProtobufList<DocumentationRule> rules_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setPages(int i, com.google.api.Page.Builder builder) {
        ensurePagesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addPages(com.google.api.Page.Builder builder) {
        ensurePagesIsMutable();
        this.pages_.add((Page) builder.build());
    }

    /* access modifiers changed from: private */
    public void addPages(int i, com.google.api.Page.Builder builder) {
        ensurePagesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setRules(int i, com.google.api.DocumentationRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addRules(com.google.api.DocumentationRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((DocumentationRule) builder.build());
    }

    /* access modifiers changed from: private */
    public void addRules(int i, com.google.api.DocumentationRule.Builder builder) {
        ensureRulesIsMutable();

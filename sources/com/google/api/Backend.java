...
public final class Backend extends GeneratedMessageLite<Backend, Builder> implements BackendOrBuilder {
    ...
    private ProtobufList<BackendRule> rules_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setRules(int i, com.google.api.BackendRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addRules(com.google.api.BackendRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((BackendRule) builder.build());
    }

    /* access modifiers changed from: private */
    public void addRules(int i, com.google.api.BackendRule.Builder builder) {
        ensureRulesIsMutable();

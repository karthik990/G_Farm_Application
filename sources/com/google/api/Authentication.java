...
public final class Authentication extends GeneratedMessageLite<Authentication, Builder> implements AuthenticationOrBuilder {
    ...
    private ProtobufList<AuthProvider> providers_ = emptyProtobufList();
    private ProtobufList<AuthenticationRule> rules_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setRules(int i, com.google.api.AuthenticationRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addRules(com.google.api.AuthenticationRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((AuthenticationRule) builder.build());
    }

    /* access modifiers changed from: private */
    public void addRules(int i, com.google.api.AuthenticationRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setProviders(int i, com.google.api.AuthProvider.Builder builder) {
        ensureProvidersIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addProviders(com.google.api.AuthProvider.Builder builder) {
        ensureProvidersIsMutable();
        this.providers_.add((AuthProvider) builder.build());
    }

    /* access modifiers changed from: private */
    public void addProviders(int i, com.google.api.AuthProvider.Builder builder) {
        ensureProvidersIsMutable();

...
public final class Http extends GeneratedMessageLite<Http, Builder> implements HttpOrBuilder {
    ...
    private ProtobufList<HttpRule> rules_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setRules(int i, com.google.api.HttpRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addRules(com.google.api.HttpRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((HttpRule) builder.build());
    }

    /* access modifiers changed from: private */
    public void addRules(int i, com.google.api.HttpRule.Builder builder) {
        ensureRulesIsMutable();

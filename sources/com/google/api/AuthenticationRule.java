...
public final class AuthenticationRule extends GeneratedMessageLite<AuthenticationRule, Builder> implements AuthenticationRuleOrBuilder {
    ...
    private ProtobufList<AuthRequirement> requirements_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setOauth(com.google.api.OAuthRequirements.Builder builder) {
    ...
    /* access modifiers changed from: private */
    public void setRequirements(int i, com.google.api.AuthRequirement.Builder builder) {
        ensureRequirementsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addRequirements(com.google.api.AuthRequirement.Builder builder) {
        ensureRequirementsIsMutable();
        this.requirements_.add((AuthRequirement) builder.build());
    }

    /* access modifiers changed from: private */
    public void addRequirements(int i, com.google.api.AuthRequirement.Builder builder) {
        ensureRequirementsIsMutable();

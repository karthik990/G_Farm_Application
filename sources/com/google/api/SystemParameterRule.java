...
public final class SystemParameterRule extends GeneratedMessageLite<SystemParameterRule, Builder> implements SystemParameterRuleOrBuilder {
    ...
    private ProtobufList<SystemParameter> parameters_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setParameters(int i, com.google.api.SystemParameter.Builder builder) {
        ensureParametersIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addParameters(com.google.api.SystemParameter.Builder builder) {
        ensureParametersIsMutable();
        this.parameters_.add((SystemParameter) builder.build());
    }

    /* access modifiers changed from: private */
    public void addParameters(int i, com.google.api.SystemParameter.Builder builder) {
        ensureParametersIsMutable();

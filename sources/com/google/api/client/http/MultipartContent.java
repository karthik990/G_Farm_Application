    ...
    public void writeTo(OutputStream outputStream) throws IOException {
        ...
        while (true) {
            ...
            if (hasNext) {
                ...
                acceptEncoding.setContentEncoding(null).setUserAgent(null).setContentType(null).setContentLength(null).set(str3, (Object) null);
                HttpContent httpContent = part.content;
                if (httpContent != 0) {
                    acceptEncoding.set(str3, (Object) Arrays.asList(new String[]{"binary"}));

...
public class TestCertificates {
    ...
    public static class CertData {
        ...
        public X509TrustManager getTrustManager() throws IOException, GeneralSecurityException {
            ...
            instance.setCertificateEntry("ca", getCertfificate());
    ...
    public static JsonWebSignature getJsonWebSignature() throws IOException {
        if (jsonWebSignature == null) {
            ...
            String str = JWS_SIGNATURE;
            int indexOf = str.indexOf(46, 2723);
            jsonWebSignature = new JsonWebSignature(header, payload, Base64.decodeBase64(str.substring(indexOf + 1)), StringUtils.getBytesUtf8(str.substring(0, indexOf)));
        }

...
public final class StoredChannel implements Serializable {
    ...
    public StoredChannel(UnparsedNotificationCallback unparsedNotificationCallback, String str) {
        ...
        this.f1785id = (String) Preconditions.checkNotNull(str);
    }
    ...
    public String toString() {
        ...
        ToStringHelper add = Objects.toStringHelper(StoredChannel.class).add("notificationCallback", getNotificationCallback()).add(str, getClientToken()).add(str2, getExpiration());
        return add.add(TtmlNode.ATTR_ID, getId()).add("topicId", getTopicId()).toString();
    }

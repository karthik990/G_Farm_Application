...
public abstract class AbstractNotification {
    ...
    public ToStringHelper toStringHelper() {
        String str = "resourceState";
        String str2 = "resourceId";
        String str3 = "resourceUri";
        ToStringHelper add = Objects.toStringHelper(this).add("messageNumber", Long.valueOf(this.messageNumber)).add(str, this.resourceState).add(str2, this.resourceId).add(str3, this.resourceUri);
        return add.add(YoutubeConstants.INTENT_EXTRA_CHANNEL_ID, this.channelId).add("channelExpiration", this.channelExpiration).add("channelToken", this.channelToken).add("changed", this.changed);
    }

...
public final class SystemParameters extends GeneratedMessageLite<SystemParameters, Builder> implements SystemParametersOrBuilder {
    ...
    private ProtobufList<SystemParameterRule> rules_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setRules(int i, com.google.api.SystemParameterRule.Builder builder) {
        ensureRulesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addRules(com.google.api.SystemParameterRule.Builder builder) {
        ensureRulesIsMutable();
        this.rules_.add((SystemParameterRule) builder.build());
    }

    /* access modifiers changed from: private */
    public void addRules(int i, com.google.api.SystemParameterRule.Builder builder) {
        ensureRulesIsMutable();

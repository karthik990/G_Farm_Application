...
public final class SourceInfo extends GeneratedMessageLite<SourceInfo, Builder> implements SourceInfoOrBuilder {
    ...
    private ProtobufList<Any> sourceFiles_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setSourceFiles(int i, com.google.protobuf.Any.Builder builder) {
        ensureSourceFilesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addSourceFiles(com.google.protobuf.Any.Builder builder) {
        ensureSourceFilesIsMutable();
        this.sourceFiles_.add((Any) builder.build());
    }

    /* access modifiers changed from: private */
    public void addSourceFiles(int i, com.google.protobuf.Any.Builder builder) {
        ensureSourceFilesIsMutable();

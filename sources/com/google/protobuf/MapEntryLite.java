...
public class MapEntryLite<K, V> {
    ...
    static /* synthetic */ class C37871 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.MapEntryLite.C37871.<clinit>():void");
        }
    }
    ...
    static <T> T parseField(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, FieldType fieldType, T t) throws IOException {
        int i = C37871.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()];
        if (i == 1) {

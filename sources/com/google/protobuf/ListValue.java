...
public final class ListValue extends GeneratedMessageLite<ListValue, Builder> implements ListValueOrBuilder {
    ...
    /* access modifiers changed from: private */
    public void setValues(int i, com.google.protobuf.Value.Builder builder) {
        ensureValuesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addValues(com.google.protobuf.Value.Builder builder) {
        ensureValuesIsMutable();
        this.values_.add((Value) builder.build());
    }

    /* access modifiers changed from: private */
    public void addValues(int i, com.google.protobuf.Value.Builder builder) {
        ensureValuesIsMutable();

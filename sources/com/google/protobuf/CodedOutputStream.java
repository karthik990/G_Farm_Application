...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    private static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferUInt32NoTag(int i) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((i & -128) != 0) {
                    long j2 = 1 + j;
                    UnsafeUtil.putByte(this.buffer, j, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                    j = j2;
                }
                long j3 = 1 + j;
            ...
            while ((i & -128) != 0) {
                ...
                this.position = i3 + 1;
                bArr[i3] = (byte) ((i & Opcodes.LAND) | 128);
                this.totalBytesWritten++;
                i >>>= 7;
            }
        ...
        public final void bufferUInt64NoTag(long j) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((j2 & -128) != 0) {
                    long j4 = j3 + 1;
                    UnsafeUtil.putByte(this.buffer, j3, (byte) ((((int) j2) & Opcodes.LAND) | 128));
                    j2 >>>= 7;
                    j3 = j4;
                }
                long j5 = 1 + j3;
            ...
            while ((j6 & -128) != 0) {
                ...
                this.position = i2 + 1;
                bArr[i2] = (byte) ((((int) j6) & Opcodes.LAND) | 128);
                this.totalBytesWritten++;
                j6 >>>= 7;
            }
            byte[] bArr2 = this.buffer;
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int i) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                while ((i & -128) != 0) {
                    long j = 1 + access$200;
                    UnsafeUtil.putByte(this.buffer, access$200, (byte) ((i & Opcodes.LAND) | 128));
                    this.position++;
                    i >>>= 7;
                    access$200 = j;
                }
        ...
        public final void writeUInt64NoTag(long j) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    UnsafeUtil.putByte(this.buffer, access$200, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    this.position++;
                    j >>>= 7;
                    access$200 = j2;
                }
    ...
    private static final class NioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int i) throws IOException {
            while ((i & -128) != 0) {
                this.buffer.put((byte) ((i & Opcodes.LAND) | 128));
                i >>>= 7;
            }
            try {
        ...
        public void writeUInt64NoTag(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.buffer.put((byte) ((((int) j) & Opcodes.LAND) | 128));
                j >>>= 7;
            }
            try {

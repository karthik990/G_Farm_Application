...
public final class PluginProtos {
    ...
    public static final class CodeGeneratorRequest extends GeneratedMessageLite<CodeGeneratorRequest, Builder> implements CodeGeneratorRequestOrBuilder {
        ...
        private ProtobufList<FileDescriptorProto> protoFile_ = emptyProtobufList();
        ...
        /* access modifiers changed from: private */
        public void setProtoFile(int i, FileDescriptorProto fileDescriptorProto) {
        ...
        /* access modifiers changed from: private */
        public void setProtoFile(int i, com.google.protobuf.DescriptorProtos.FileDescriptorProto.Builder builder) {
            ensureProtoFileIsMutable();
            this.protoFile_.set(i, (FileDescriptorProto) builder.build());
        }

        /* access modifiers changed from: private */
        public void addProtoFile(FileDescriptorProto fileDescriptorProto) {
            if (fileDescriptorProto != null) {
                ensureProtoFileIsMutable();
        ...
        /* access modifiers changed from: private */
        public void addProtoFile(int i, FileDescriptorProto fileDescriptorProto) {
            if (fileDescriptorProto != null) {
                ensureProtoFileIsMutable();
        ...
        /* access modifiers changed from: private */
        public void addProtoFile(com.google.protobuf.DescriptorProtos.FileDescriptorProto.Builder builder) {
            ensureProtoFileIsMutable();
            this.protoFile_.add((FileDescriptorProto) builder.build());
        }

        /* access modifiers changed from: private */
        public void addProtoFile(int i, com.google.protobuf.DescriptorProtos.FileDescriptorProto.Builder builder) {
            ensureProtoFileIsMutable();
            this.protoFile_.add(i, (FileDescriptorProto) builder.build());
        }

        /* access modifiers changed from: private */
        public void addAllProtoFile(Iterable<? extends FileDescriptorProto> iterable) {
            ensureProtoFileIsMutable();
        ...
        /* access modifiers changed from: private */
        public void setCompilerVersion(Builder builder) {
    ...
    public static final class CodeGeneratorResponse extends GeneratedMessageLite<CodeGeneratorResponse, Builder> implements CodeGeneratorResponseOrBuilder {
        ...
        private ProtobufList<File> file_ = emptyProtobufList();

...
public final class Api extends GeneratedMessageLite<Api, Builder> implements ApiOrBuilder {
    ...
    private ProtobufList<Method> methods_ = emptyProtobufList();
    private ProtobufList<Mixin> mixins_;
    private String name_;
    private ProtobufList<Option> options_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setMethods(int i, com.google.protobuf.Method.Builder builder) {
        ensureMethodsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addMethods(com.google.protobuf.Method.Builder builder) {
        ensureMethodsIsMutable();
        this.methods_.add((Method) builder.build());
    }

    /* access modifiers changed from: private */
    public void addMethods(int i, com.google.protobuf.Method.Builder builder) {
        ensureMethodsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setOptions(int i, com.google.protobuf.Option.Builder builder) {
        ensureOptionsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addOptions(com.google.protobuf.Option.Builder builder) {
        ensureOptionsIsMutable();
        this.options_.add((Option) builder.build());
    }

    /* access modifiers changed from: private */
    public void addOptions(int i, com.google.protobuf.Option.Builder builder) {
        ensureOptionsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setSourceContext(com.google.protobuf.SourceContext.Builder builder) {
    ...
    /* access modifiers changed from: private */
    public void setMixins(int i, com.google.protobuf.Mixin.Builder builder) {
        ensureMixinsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addMixins(com.google.protobuf.Mixin.Builder builder) {
        ensureMixinsIsMutable();
        this.mixins_.add((Mixin) builder.build());
    }

    /* access modifiers changed from: private */
    public void addMixins(int i, com.google.protobuf.Mixin.Builder builder) {
        ensureMixinsIsMutable();

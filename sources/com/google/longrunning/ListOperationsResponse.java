...
public final class ListOperationsResponse extends GeneratedMessageLite<ListOperationsResponse, Builder> implements ListOperationsResponseOrBuilder {
    ...
    private ProtobufList<Operation> operations_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setOperations(int i, com.google.longrunning.Operation.Builder builder) {
        ensureOperationsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addOperations(com.google.longrunning.Operation.Builder builder) {
        ensureOperationsIsMutable();
        this.operations_.add((Operation) builder.build());
    }

    /* access modifiers changed from: private */
    public void addOperations(int i, com.google.longrunning.Operation.Builder builder) {
        ensureOperationsIsMutable();

...
public final class WriteResult extends GeneratedMessageLite<WriteResult, Builder> implements WriteResultOrBuilder {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<WriteResult, Builder> implements WriteResultOrBuilder {
        ...
        public Builder setTransformResults(int i, com.google.firestore.p050v1.Value.Builder builder) {
            copyOnWrite();
        ...
        public Builder addTransformResults(com.google.firestore.p050v1.Value.Builder builder) {
            copyOnWrite();
            ((WriteResult) this.instance).addTransformResults(builder);
            return this;
        }

        public Builder addTransformResults(int i, com.google.firestore.p050v1.Value.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setTransformResults(int i, com.google.firestore.p050v1.Value.Builder builder) {
        ensureTransformResultsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addTransformResults(com.google.firestore.p050v1.Value.Builder builder) {
        ensureTransformResultsIsMutable();
        this.transformResults_.add((Value) builder.build());
    }

    /* access modifiers changed from: private */
    public void addTransformResults(int i, com.google.firestore.p050v1.Value.Builder builder) {
        ensureTransformResultsIsMutable();

...
public final class ListenRequest extends GeneratedMessageLite<ListenRequest, Builder> implements ListenRequestOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    static /* synthetic */ class C37241 {

        /* renamed from: $SwitchMap$com$google$firestore$v1$ListenRequest$TargetChangeCase */
        static final /* synthetic */ int[] f2081x539cc855 = new int[TargetChangeCase.values().length];
        ...
        static {
            /*
                ...
                f2082xa1df5c61 = r0
                r0 = 1
                int[] r1 = f2082xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f2082xa1df5c61     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                r2 = 3
                int[] r3 = f2082xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r3 = f2082xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r3 = f2082xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                int[] r3 = f2082xa1df5c61     // Catch:{ NoSuchFieldError -> 0x004b }
            ...
            L_0x004b:
                int[] r3 = f2082xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0056 }
            ...
            L_0x0056:
                int[] r3 = f2082xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0062 }
            ...
            L_0x0062:
                com.google.firestore.v1.ListenRequest$TargetChangeCase[] r3 = com.google.firestore.p050v1.ListenRequest.TargetChangeCase.values()
                int r3 = r3.length
                int[] r3 = new int[r3]
                f2081x539cc855 = r3
                int[] r3 = f2081x539cc855     // Catch:{ NoSuchFieldError -> 0x0075 }
                com.google.firestore.v1.ListenRequest$TargetChangeCase r4 = com.google.firestore.p050v1.ListenRequest.TargetChangeCase.ADD_TARGET     // Catch:{ NoSuchFieldError -> 0x0075 }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0075 }
                r3[r4] = r0     // Catch:{ NoSuchFieldError -> 0x0075 }
            L_0x0075:
                int[] r0 = f2081x539cc855     // Catch:{ NoSuchFieldError -> 0x007f }
                com.google.firestore.v1.ListenRequest$TargetChangeCase r3 = com.google.firestore.p050v1.ListenRequest.TargetChangeCase.REMOVE_TARGET     // Catch:{ NoSuchFieldError -> 0x007f }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x007f }
                r0[r3] = r1     // Catch:{ NoSuchFieldError -> 0x007f }
            L_0x007f:
                int[] r0 = f2081x539cc855     // Catch:{ NoSuchFieldError -> 0x0089 }
                com.google.firestore.v1.ListenRequest$TargetChangeCase r1 = com.google.firestore.p050v1.ListenRequest.TargetChangeCase.TARGETCHANGE_NOT_SET     // Catch:{ NoSuchFieldError -> 0x0089 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0089 }
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0089 }
            L_0x0089:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firestore.p050v1.ListenRequest.C37241.<clinit>():void");
        }
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ListenRequest, Builder> implements ListenRequestOrBuilder {
        ...
        public Builder setAddTarget(com.google.firestore.p050v1.Target.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setAddTarget(com.google.firestore.p050v1.Target.Builder builder) {
    ...
    public void mergeAddTarget(Target target) {
        if (this.targetChangeCase_ != 2 || this.targetChange_ == Target.getDefaultInstance()) {
            ...
            this.targetChange_ = ((com.google.firestore.p050v1.Target.Builder) Target.newBuilder((Target) this.targetChange_).mergeFrom(target)).buildPartial();
        }
        this.targetChangeCase_ = 2;
    }
    ...
    public final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                int i = C37241.f2081x539cc855[listenRequest.getTargetChangeCase().ordinal()];
                if (i == 1) {
                    if (this.targetChangeCase_ == 2) {
                        z = true;
                    }
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.firestore.p050v1.Target.Builder builder = this.targetChangeCase_ == 2 ? (com.google.firestore.p050v1.Target.Builder) ((Target) this.targetChange_).toBuilder() : null;

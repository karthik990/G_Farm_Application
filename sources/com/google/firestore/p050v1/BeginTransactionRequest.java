...
public final class BeginTransactionRequest extends GeneratedMessageLite<BeginTransactionRequest, Builder> implements BeginTransactionRequestOrBuilder {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<BeginTransactionRequest, Builder> implements BeginTransactionRequestOrBuilder {
        ...
        public Builder setOptions(com.google.firestore.p050v1.TransactionOptions.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setOptions(com.google.firestore.p050v1.TransactionOptions.Builder builder) {
    ...
    public void mergeOptions(TransactionOptions transactionOptions) {
        ...
        if (transactionOptions2 == null || transactionOptions2 == TransactionOptions.getDefaultInstance()) {
            ...
            this.options_ = (TransactionOptions) ((com.google.firestore.p050v1.TransactionOptions.Builder) TransactionOptions.newBuilder(this.options_).mergeFrom(transactionOptions)).buildPartial();
        }
    }
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.firestore.p050v1.TransactionOptions.Builder builder = this.options_ != null ? (com.google.firestore.p050v1.TransactionOptions.Builder) this.options_.toBuilder() : null;

...
public final class DocumentTransform extends GeneratedMessageLite<DocumentTransform, Builder> implements DocumentTransformOrBuilder {
    ...
    public static final class FieldTransform extends GeneratedMessageLite<FieldTransform, Builder> implements FieldTransformOrBuilder {
        ...
        public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<FieldTransform, Builder> implements FieldTransformOrBuilder {
            ...
            public Builder setIncrement(com.google.firestore.p050v1.Value.Builder builder) {
                copyOnWrite();
            ...
            public Builder setMaximum(com.google.firestore.p050v1.Value.Builder builder) {
                copyOnWrite();
            ...
            public Builder setMinimum(com.google.firestore.p050v1.Value.Builder builder) {
                copyOnWrite();
            ...
            public Builder setAppendMissingElements(com.google.firestore.p050v1.ArrayValue.Builder builder) {
                copyOnWrite();
            ...
            public Builder setRemoveAllFromArray(com.google.firestore.p050v1.ArrayValue.Builder builder) {
                copyOnWrite();
        ...
        /* access modifiers changed from: private */
        public void setIncrement(com.google.firestore.p050v1.Value.Builder builder) {
        ...
        public void mergeIncrement(Value value) {
            if (this.transformTypeCase_ != 3 || this.transformType_ == Value.getDefaultInstance()) {
                ...
                this.transformType_ = ((com.google.firestore.p050v1.Value.Builder) Value.newBuilder((Value) this.transformType_).mergeFrom(value)).buildPartial();
            }
            this.transformTypeCase_ = 3;
        }
        ...
        /* access modifiers changed from: private */
        public void setMaximum(com.google.firestore.p050v1.Value.Builder builder) {
            this.transformType_ = builder.build();
            this.transformTypeCase_ = 4;
        }
        ...
        /* access modifiers changed from: private */
        public void setMinimum(com.google.firestore.p050v1.Value.Builder builder) {
            this.transformType_ = builder.build();
            this.transformTypeCase_ = 5;
        }
        ...
        /* access modifiers changed from: private */
        public void setAppendMissingElements(com.google.firestore.p050v1.ArrayValue.Builder builder) {
            this.transformType_ = builder.build();
            this.transformTypeCase_ = 6;
        }
        ...
        public void mergeAppendMissingElements(ArrayValue arrayValue) {
            if (this.transformTypeCase_ != 6 || this.transformType_ == ArrayValue.getDefaultInstance()) {
                ...
                this.transformType_ = ((com.google.firestore.p050v1.ArrayValue.Builder) ArrayValue.newBuilder((ArrayValue) this.transformType_).mergeFrom(arrayValue)).buildPartial();
            }
            this.transformTypeCase_ = 6;
        }
        ...
        /* access modifiers changed from: private */
        public void setRemoveAllFromArray(com.google.firestore.p050v1.ArrayValue.Builder builder) {
            this.transformType_ = builder.build();
            this.transformTypeCase_ = 7;
        }
                        ...
                        try {
                            ...
                            if (readTag != 0) {
                                if (readTag == 10) {
                                    ...
                                    com.google.firestore.p050v1.Value.Builder builder = this.transformTypeCase_ == 3 ? (com.google.firestore.p050v1.Value.Builder) ((Value) this.transformType_).toBuilder() : null;
                                    ...
                                    com.google.firestore.p050v1.Value.Builder builder2 = this.transformTypeCase_ == 4 ? (com.google.firestore.p050v1.Value.Builder) ((Value) this.transformType_).toBuilder() : null;
                                    this.transformType_ = codedInputStream.readMessage(Value.parser(), extensionRegistryLite);
                                    if (builder2 != null) {
                                    ...
                                    com.google.firestore.p050v1.Value.Builder builder3 = this.transformTypeCase_ == 5 ? (com.google.firestore.p050v1.Value.Builder) ((Value) this.transformType_).toBuilder() : null;
                                    this.transformType_ = codedInputStream.readMessage(Value.parser(), extensionRegistryLite);
                                    if (builder3 != null) {
                                    ...
                                    com.google.firestore.p050v1.ArrayValue.Builder builder4 = this.transformTypeCase_ == 6 ? (com.google.firestore.p050v1.ArrayValue.Builder) ((ArrayValue) this.transformType_).toBuilder() : null;
                                    ...
                                    com.google.firestore.p050v1.ArrayValue.Builder builder5 = this.transformTypeCase_ == 7 ? (com.google.firestore.p050v1.ArrayValue.Builder) ((ArrayValue) this.transformType_).toBuilder() : null;
                                    this.transformType_ = codedInputStream.readMessage(ArrayValue.parser(), extensionRegistryLite);
                                    if (builder5 != null) {

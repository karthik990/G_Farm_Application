...
public final class ArrayValue extends GeneratedMessageLite<ArrayValue, Builder> implements ArrayValueOrBuilder {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ArrayValue, Builder> implements ArrayValueOrBuilder {
        ...
        public Builder setValues(int i, com.google.firestore.p050v1.Value.Builder builder) {
            copyOnWrite();
        ...
        public Builder addValues(com.google.firestore.p050v1.Value.Builder builder) {
            copyOnWrite();
            ((ArrayValue) this.instance).addValues(builder);
            return this;
        }

        public Builder addValues(int i, com.google.firestore.p050v1.Value.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setValues(int i, com.google.firestore.p050v1.Value.Builder builder) {
        ensureValuesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addValues(com.google.firestore.p050v1.Value.Builder builder) {
        ensureValuesIsMutable();
        this.values_.add((Value) builder.build());
    }

    /* access modifiers changed from: private */
    public void addValues(int i, com.google.firestore.p050v1.Value.Builder builder) {
        ensureValuesIsMutable();

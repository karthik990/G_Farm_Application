...
public final class ListenResponse extends GeneratedMessageLite<ListenResponse, Builder> implements ListenResponseOrBuilder {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ListenResponse, Builder> implements ListenResponseOrBuilder {
        ...
        public Builder setTargetChange(com.google.firestore.p050v1.TargetChange.Builder builder) {
            copyOnWrite();
        ...
        public Builder setDocumentChange(com.google.firestore.p050v1.DocumentChange.Builder builder) {
            copyOnWrite();
        ...
        public Builder setDocumentDelete(com.google.firestore.p050v1.DocumentDelete.Builder builder) {
            copyOnWrite();
        ...
        public Builder setDocumentRemove(com.google.firestore.p050v1.DocumentRemove.Builder builder) {
            copyOnWrite();
        ...
        public Builder setFilter(com.google.firestore.p050v1.ExistenceFilter.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setTargetChange(com.google.firestore.p050v1.TargetChange.Builder builder) {
    ...
    public void mergeTargetChange(TargetChange targetChange) {
        if (this.responseTypeCase_ != 2 || this.responseType_ == TargetChange.getDefaultInstance()) {
            ...
            this.responseType_ = ((com.google.firestore.p050v1.TargetChange.Builder) TargetChange.newBuilder((TargetChange) this.responseType_).mergeFrom(targetChange)).buildPartial();
        }
        this.responseTypeCase_ = 2;
    }
    ...
    /* access modifiers changed from: private */
    public void setDocumentChange(com.google.firestore.p050v1.DocumentChange.Builder builder) {
        this.responseType_ = builder.build();
        this.responseTypeCase_ = 3;
    }
    ...
    public void mergeDocumentChange(DocumentChange documentChange) {
        if (this.responseTypeCase_ != 3 || this.responseType_ == DocumentChange.getDefaultInstance()) {
            ...
            this.responseType_ = ((com.google.firestore.p050v1.DocumentChange.Builder) DocumentChange.newBuilder((DocumentChange) this.responseType_).mergeFrom(documentChange)).buildPartial();
        }
        this.responseTypeCase_ = 3;
    }
    ...
    /* access modifiers changed from: private */
    public void setDocumentDelete(com.google.firestore.p050v1.DocumentDelete.Builder builder) {
        this.responseType_ = builder.build();
        this.responseTypeCase_ = 4;
    }
    ...
    public void mergeDocumentDelete(DocumentDelete documentDelete) {
        if (this.responseTypeCase_ != 4 || this.responseType_ == DocumentDelete.getDefaultInstance()) {
            ...
            this.responseType_ = ((com.google.firestore.p050v1.DocumentDelete.Builder) DocumentDelete.newBuilder((DocumentDelete) this.responseType_).mergeFrom(documentDelete)).buildPartial();
        }
        this.responseTypeCase_ = 4;
    }
    ...
    /* access modifiers changed from: private */
    public void setDocumentRemove(com.google.firestore.p050v1.DocumentRemove.Builder builder) {
        this.responseType_ = builder.build();
        this.responseTypeCase_ = 6;
    }
    ...
    public void mergeDocumentRemove(DocumentRemove documentRemove) {
        if (this.responseTypeCase_ != 6 || this.responseType_ == DocumentRemove.getDefaultInstance()) {
            ...
            this.responseType_ = ((com.google.firestore.p050v1.DocumentRemove.Builder) DocumentRemove.newBuilder((DocumentRemove) this.responseType_).mergeFrom(documentRemove)).buildPartial();
        }
        this.responseTypeCase_ = 6;
    }
    ...
    /* access modifiers changed from: private */
    public void setFilter(com.google.firestore.p050v1.ExistenceFilter.Builder builder) {
        this.responseType_ = builder.build();
        this.responseTypeCase_ = 5;
    }
    ...
    public void mergeFilter(ExistenceFilter existenceFilter) {
        if (this.responseTypeCase_ != 5 || this.responseType_ == ExistenceFilter.getDefaultInstance()) {
            ...
            this.responseType_ = ((com.google.firestore.p050v1.ExistenceFilter.Builder) ExistenceFilter.newBuilder((ExistenceFilter) this.responseType_).mergeFrom(existenceFilter)).buildPartial();
        }
        this.responseTypeCase_ = 5;
    }
            ...
            case MERGE_FROM_STREAM:
                ...
                while (!z) {
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 18) {
                                com.google.firestore.p050v1.TargetChange.Builder builder = this.responseTypeCase_ == 2 ? (com.google.firestore.p050v1.TargetChange.Builder) ((TargetChange) this.responseType_).toBuilder() : null;
                                ...
                                com.google.firestore.p050v1.DocumentChange.Builder builder2 = this.responseTypeCase_ == 3 ? (com.google.firestore.p050v1.DocumentChange.Builder) ((DocumentChange) this.responseType_).toBuilder() : null;
                                ...
                                com.google.firestore.p050v1.DocumentDelete.Builder builder3 = this.responseTypeCase_ == 4 ? (com.google.firestore.p050v1.DocumentDelete.Builder) ((DocumentDelete) this.responseType_).toBuilder() : null;
                                ...
                                com.google.firestore.p050v1.ExistenceFilter.Builder builder4 = this.responseTypeCase_ == 5 ? (com.google.firestore.p050v1.ExistenceFilter.Builder) ((ExistenceFilter) this.responseType_).toBuilder() : null;
                                ...
                                com.google.firestore.p050v1.DocumentRemove.Builder builder5 = this.responseTypeCase_ == 6 ? (com.google.firestore.p050v1.DocumentRemove.Builder) ((DocumentRemove) this.responseType_).toBuilder() : null;

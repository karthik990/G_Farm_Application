...
public final class WriteResponse extends GeneratedMessageLite<WriteResponse, Builder> implements WriteResponseOrBuilder {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<WriteResponse, Builder> implements WriteResponseOrBuilder {
        ...
        public Builder setWriteResults(int i, com.google.firestore.p050v1.WriteResult.Builder builder) {
            copyOnWrite();
        ...
        public Builder addWriteResults(com.google.firestore.p050v1.WriteResult.Builder builder) {
            copyOnWrite();
            ((WriteResponse) this.instance).addWriteResults(builder);
            return this;
        }

        public Builder addWriteResults(int i, com.google.firestore.p050v1.WriteResult.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setWriteResults(int i, com.google.firestore.p050v1.WriteResult.Builder builder) {
        ensureWriteResultsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addWriteResults(com.google.firestore.p050v1.WriteResult.Builder builder) {
        ensureWriteResultsIsMutable();
        this.writeResults_.add((WriteResult) builder.build());
    }

    /* access modifiers changed from: private */
    public void addWriteResults(int i, com.google.firestore.p050v1.WriteResult.Builder builder) {
        ensureWriteResultsIsMutable();

...
public final class RunQueryRequest extends GeneratedMessageLite<RunQueryRequest, Builder> implements RunQueryRequestOrBuilder {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    static /* synthetic */ class C37291 {

        /* renamed from: $SwitchMap$com$google$firestore$v1$RunQueryRequest$ConsistencySelectorCase */
        static final /* synthetic */ int[] f2089xb8ef648d = new int[ConsistencySelectorCase.values().length];
        ...
        static {
            /*
                ...
                f2090xa1df5c61 = r0
                r0 = 1
                int[] r1 = f2090xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f2090xa1df5c61     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                r2 = 3
                int[] r3 = f2090xa1df5c61     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                r3 = 4
                int[] r4 = f2090xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r4 = f2090xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                int[] r4 = f2090xa1df5c61     // Catch:{ NoSuchFieldError -> 0x004b }
            ...
            L_0x004b:
                int[] r4 = f2090xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0056 }
            ...
            L_0x0056:
                int[] r4 = f2090xa1df5c61     // Catch:{ NoSuchFieldError -> 0x0062 }
            ...
            L_0x0062:
                com.google.firestore.v1.RunQueryRequest$ConsistencySelectorCase[] r4 = com.google.firestore.p050v1.RunQueryRequest.ConsistencySelectorCase.values()
                int r4 = r4.length
                int[] r4 = new int[r4]
                f2089xb8ef648d = r4
                int[] r4 = f2089xb8ef648d     // Catch:{ NoSuchFieldError -> 0x0075 }
                com.google.firestore.v1.RunQueryRequest$ConsistencySelectorCase r5 = com.google.firestore.p050v1.RunQueryRequest.ConsistencySelectorCase.TRANSACTION     // Catch:{ NoSuchFieldError -> 0x0075 }
                int r5 = r5.ordinal()     // Catch:{ NoSuchFieldError -> 0x0075 }
                r4[r5] = r0     // Catch:{ NoSuchFieldError -> 0x0075 }
            L_0x0075:
                int[] r4 = f2089xb8ef648d     // Catch:{ NoSuchFieldError -> 0x007f }
                com.google.firestore.v1.RunQueryRequest$ConsistencySelectorCase r5 = com.google.firestore.p050v1.RunQueryRequest.ConsistencySelectorCase.NEW_TRANSACTION     // Catch:{ NoSuchFieldError -> 0x007f }
                int r5 = r5.ordinal()     // Catch:{ NoSuchFieldError -> 0x007f }
                r4[r5] = r1     // Catch:{ NoSuchFieldError -> 0x007f }
            L_0x007f:
                int[] r4 = f2089xb8ef648d     // Catch:{ NoSuchFieldError -> 0x0089 }
                com.google.firestore.v1.RunQueryRequest$ConsistencySelectorCase r5 = com.google.firestore.p050v1.RunQueryRequest.ConsistencySelectorCase.READ_TIME     // Catch:{ NoSuchFieldError -> 0x0089 }
                int r5 = r5.ordinal()     // Catch:{ NoSuchFieldError -> 0x0089 }
                r4[r5] = r2     // Catch:{ NoSuchFieldError -> 0x0089 }
            L_0x0089:
                int[] r2 = f2089xb8ef648d     // Catch:{ NoSuchFieldError -> 0x0093 }
                com.google.firestore.v1.RunQueryRequest$ConsistencySelectorCase r4 = com.google.firestore.p050v1.RunQueryRequest.ConsistencySelectorCase.CONSISTENCYSELECTOR_NOT_SET     // Catch:{ NoSuchFieldError -> 0x0093 }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0093 }
                r2[r4] = r3     // Catch:{ NoSuchFieldError -> 0x0093 }
            L_0x0093:
                com.google.firestore.v1.RunQueryRequest$QueryTypeCase[] r2 = com.google.firestore.p050v1.RunQueryRequest.QueryTypeCase.values()
                int r2 = r2.length
                int[] r2 = new int[r2]
                ...
                com.google.firestore.v1.RunQueryRequest$QueryTypeCase r3 = com.google.firestore.p050v1.RunQueryRequest.QueryTypeCase.STRUCTURED_QUERY     // Catch:{ NoSuchFieldError -> 0x00a6 }
            ...
            L_0x00a6:
                ...
                com.google.firestore.v1.RunQueryRequest$QueryTypeCase r2 = com.google.firestore.p050v1.RunQueryRequest.QueryTypeCase.QUERYTYPE_NOT_SET     // Catch:{ NoSuchFieldError -> 0x00b0 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x00b0 }
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x00b0 }
            L_0x00b0:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firestore.p050v1.RunQueryRequest.C37291.<clinit>():void");
        }
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<RunQueryRequest, Builder> implements RunQueryRequestOrBuilder {
        ...
        public Builder setStructuredQuery(com.google.firestore.p050v1.StructuredQuery.Builder builder) {
            copyOnWrite();
        ...
        public Builder setNewTransaction(com.google.firestore.p050v1.TransactionOptions.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setStructuredQuery(com.google.firestore.p050v1.StructuredQuery.Builder builder) {
    ...
    public void mergeStructuredQuery(StructuredQuery structuredQuery) {
        if (this.queryTypeCase_ != 2 || this.queryType_ == StructuredQuery.getDefaultInstance()) {
            ...
            this.queryType_ = ((com.google.firestore.p050v1.StructuredQuery.Builder) StructuredQuery.newBuilder((StructuredQuery) this.queryType_).mergeFrom(structuredQuery)).buildPartial();
        }
        this.queryTypeCase_ = 2;
    }
    ...
    /* access modifiers changed from: private */
    public void setNewTransaction(com.google.firestore.p050v1.TransactionOptions.Builder builder) {
    ...
    public void mergeNewTransaction(TransactionOptions transactionOptions) {
        if (this.consistencySelectorCase_ != 6 || this.consistencySelector_ == TransactionOptions.getDefaultInstance()) {
            ...
            this.consistencySelector_ = ((com.google.firestore.p050v1.TransactionOptions.Builder) TransactionOptions.newBuilder((TransactionOptions) this.consistencySelector_).mergeFrom(transactionOptions)).buildPartial();
        }
        this.consistencySelectorCase_ = 6;
    }
    ...
    public final Object dynamicMethod(MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (methodToInvoke) {
            ...
            case VISIT:
                ...
                int i = C37291.$SwitchMap$com$google$firestore$v1$RunQueryRequest$QueryTypeCase[runQueryRequest.getQueryTypeCase().ordinal()];
                if (i == 1) {
                ...
                int i2 = C37291.f2089xb8ef648d[runQueryRequest.getConsistencySelectorCase().ordinal()];
                if (i2 == 1) {
                    if (this.consistencySelectorCase_ == 5) {
                        z = true;
                    }
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 10) {
                                ...
                                com.google.firestore.p050v1.StructuredQuery.Builder builder = this.queryTypeCase_ == 2 ? (com.google.firestore.p050v1.StructuredQuery.Builder) ((StructuredQuery) this.queryType_).toBuilder() : null;
                                ...
                                com.google.firestore.p050v1.TransactionOptions.Builder builder2 = this.consistencySelectorCase_ == 6 ? (com.google.firestore.p050v1.TransactionOptions.Builder) ((TransactionOptions) this.consistencySelector_).toBuilder() : null;

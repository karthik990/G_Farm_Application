...
public final class ListDocumentsResponse extends GeneratedMessageLite<ListDocumentsResponse, Builder> implements ListDocumentsResponseOrBuilder {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<ListDocumentsResponse, Builder> implements ListDocumentsResponseOrBuilder {
        ...
        public Builder setDocuments(int i, com.google.firestore.p050v1.Document.Builder builder) {
            copyOnWrite();
        ...
        public Builder addDocuments(com.google.firestore.p050v1.Document.Builder builder) {
            copyOnWrite();
            ((ListDocumentsResponse) this.instance).addDocuments(builder);
            return this;
        }

        public Builder addDocuments(int i, com.google.firestore.p050v1.Document.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setDocuments(int i, com.google.firestore.p050v1.Document.Builder builder) {
        ensureDocumentsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addDocuments(com.google.firestore.p050v1.Document.Builder builder) {
        ensureDocumentsIsMutable();
        this.documents_.add((Document) builder.build());
    }

    /* access modifiers changed from: private */
    public void addDocuments(int i, com.google.firestore.p050v1.Document.Builder builder) {
        ensureDocumentsIsMutable();

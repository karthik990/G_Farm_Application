...
public final class Status extends GeneratedMessageLite<Status, Builder> implements StatusOrBuilder {
    ...
    private int code_;
    private ProtobufList<Any> details_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setDetails(int i, com.google.protobuf.Any.Builder builder) {
        ensureDetailsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addDetails(com.google.protobuf.Any.Builder builder) {
        ensureDetailsIsMutable();
        this.details_.add((Any) builder.build());
    }

    /* access modifiers changed from: private */
    public void addDetails(int i, com.google.protobuf.Any.Builder builder) {
        ensureDetailsIsMutable();

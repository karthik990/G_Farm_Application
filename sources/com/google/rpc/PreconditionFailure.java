...
public final class PreconditionFailure extends GeneratedMessageLite<PreconditionFailure, Builder> implements PreconditionFailureOrBuilder {
    ...
    private ProtobufList<Violation> violations_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setViolations(int i, Builder builder) {
        ensureViolationsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addViolations(Builder builder) {
        ensureViolationsIsMutable();
        this.violations_.add((Violation) builder.build());
    }

    /* access modifiers changed from: private */
    public void addViolations(int i, Builder builder) {
        ensureViolationsIsMutable();

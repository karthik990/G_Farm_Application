...
public final class Help extends GeneratedMessageLite<Help, Builder> implements HelpOrBuilder {
    ...
    private ProtobufList<Link> links_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setLinks(int i, Builder builder) {
        ensureLinksIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addLinks(Builder builder) {
        ensureLinksIsMutable();
        this.links_.add((Link) builder.build());
    }

    /* access modifiers changed from: private */
    public void addLinks(int i, Builder builder) {
        ensureLinksIsMutable();

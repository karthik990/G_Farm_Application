...
public final class BadRequest extends GeneratedMessageLite<BadRequest, Builder> implements BadRequestOrBuilder {
    ...
    private ProtobufList<FieldViolation> fieldViolations_ = emptyProtobufList();
    ...
    /* access modifiers changed from: private */
    public void setFieldViolations(int i, Builder builder) {
        ensureFieldViolationsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addFieldViolations(Builder builder) {
        ensureFieldViolationsIsMutable();
        this.fieldViolations_.add((FieldViolation) builder.build());
    }

    /* access modifiers changed from: private */
    public void addFieldViolations(int i, Builder builder) {
        ensureFieldViolationsIsMutable();

...
public class MaterialAlertDialogBuilder extends Builder {
    private static final int DEF_STYLE_ATTR = C2556R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C2556R.C2562style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C2556R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C2556R.attr.colorSurface, getClass().getCanonicalName());

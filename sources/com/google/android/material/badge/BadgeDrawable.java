...
public class BadgeDrawable extends Drawable implements TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C2556R.C2562style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C2556R.attr.badgeStyle;
    ...
    public static final class SavedState implements Parcelable {
        ...
        public SavedState(Context context) {
            this.badgeTextColor = new TextAppearance(context, C2556R.C2562style.TextAppearance_MaterialComponents_Badge).textColor.getDefaultColor();
            this.contentDescriptionNumberless = context.getString(C2556R.C2561string.mtrl_badge_numberless_content_description);
            this.contentDescriptionQuantityStrings = C2556R.plurals.mtrl_badge_content_description;
        }
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2556R.styleable.Badge, i, i2, new int[0]);
        setMaxCharacterCount(obtainStyledAttributes.getInt(C2556R.styleable.Badge_maxCharacterCount, 4));
        if (obtainStyledAttributes.hasValue(C2556R.styleable.Badge_number)) {
            setNumber(obtainStyledAttributes.getInt(C2556R.styleable.Badge_number, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, obtainStyledAttributes, C2556R.styleable.Badge_backgroundColor));
        if (obtainStyledAttributes.hasValue(C2556R.styleable.Badge_badgeTextColor)) {
            setBadgeTextColor(readColorFromAttributes(context, obtainStyledAttributes, C2556R.styleable.Badge_badgeTextColor));
        }
        setBadgeGravity(obtainStyledAttributes.getInt(C2556R.styleable.Badge_badgeGravity, TOP_END));
        setHorizontalOffset(obtainStyledAttributes.getDimensionPixelOffset(C2556R.styleable.Badge_horizontalOffset, 0));
        setVerticalOffset(obtainStyledAttributes.getDimensionPixelOffset(C2556R.styleable.Badge_verticalOffset, 0));
    ...
    private BadgeDrawable(Context context) {
        ...
        this.badgeRadius = (float) resources.getDimensionPixelSize(C2556R.dimen.mtrl_badge_radius);
        this.badgeWidePadding = (float) resources.getDimensionPixelSize(C2556R.dimen.mtrl_badge_long_text_horizontal_padding);
        this.badgeWithTextRadius = (float) resources.getDimensionPixelSize(C2556R.dimen.mtrl_badge_with_text_radius);
        this.textDrawableHelper = new TextDrawableHelper(this);
        this.textDrawableHelper.getTextPaint().setTextAlign(Align.CENTER);
        this.savedState = new SavedState(context);
        setTextAppearanceResource(C2556R.C2562style.TextAppearance_MaterialComponents_Badge);
    }
    ...
    private void calculateCenterAndBounds(Context context, Rect rect, View view) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(hasNumber() ? C2556R.dimen.mtrl_badge_text_horizontal_edge_offset : C2556R.dimen.mtrl_badge_horizontal_edge_offset);
    ...
    private String getBadgeText() {
        ...
        return context.getString(C2556R.C2561string.mtrl_exceed_max_badge_number_suffix, new Object[]{Integer.valueOf(this.maxBadgeNumber), "+"});
    }

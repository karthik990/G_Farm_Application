...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C2556R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C2556R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C2556R.attr.colorSurface, 0);

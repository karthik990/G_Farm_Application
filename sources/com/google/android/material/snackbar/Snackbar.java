...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C2556R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C2556R.attr.snackbarButtonStyle, C2556R.attr.snackbarTextViewStyle};
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(hasSnackbarContentStyleAttrs(findSuitableParent.getContext()) ? C2556R.layout.mtrl_layout_snackbar_include : C2556R.layout.design_layout_snackbar_include, findSuitableParent, false);

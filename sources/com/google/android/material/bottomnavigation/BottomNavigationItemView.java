...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C2556R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C2556R.C2558drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C2556R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C2556R.C2559id.icon);
        this.smallLabel = (TextView) findViewById(C2556R.C2559id.smallLabel);
        this.largeLabel = (TextView) findViewById(C2556R.C2559id.largeLabel);

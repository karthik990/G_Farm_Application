...
final class IndicatorViewController {
    ...
    private final float captionTranslationYPx = ((float) this.context.getResources().getDimensionPixelSize(C2556R.dimen.design_textinput_caption_translate_y));
    ...
    private void updateCaptionViewsVisibility(int i, int i2, boolean z) {
        ...
        if (i != i2) {
            if (z2) {
                ...
                final int i5 = i2;
                final int i6 = i;
                C27271 r0 = new AnimatorListenerAdapter() {
    ...
    public void setErrorEnabled(boolean z) {
        if (this.errorEnabled != z) {
            ...
            if (z) {
                ...
                this.errorView.setId(C2556R.C2559id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            ...
            if (z) {
                ...
                this.helperTextView.setId(C2556R.C2559id.textinput_helper_text);
                if (VERSION.SDK_INT >= 17) {

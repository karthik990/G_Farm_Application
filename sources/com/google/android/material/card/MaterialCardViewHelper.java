...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView materialCardView2, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = materialCardView2.getContext().obtainStyledAttributes(attributeSet, C2556R.styleable.CardView, i, C2556R.C2562style.CardView);
        if (obtainStyledAttributes.hasValue(C2556R.styleable.CardView_cardCornerRadius)) {
            builder.setAllCornerSizes(obtainStyledAttributes.getDimension(C2556R.styleable.CardView_cardCornerRadius, 0.0f));
        }
        this.foregroundContentDrawable = new MaterialShapeDrawable();
        setShapeAppearanceModel(builder.build());
        Resources resources = materialCardView2.getResources();
        this.checkedIconMargin = resources.getDimensionPixelSize(C2556R.dimen.mtrl_card_checked_icon_margin);
        this.checkedIconSize = resources.getDimensionPixelSize(C2556R.dimen.mtrl_card_checked_icon_size);
        obtainStyledAttributes.recycle();
    }

    /* access modifiers changed from: 0000 */
    public void loadFromAttributes(TypedArray typedArray) {
        this.strokeColor = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C2556R.styleable.MaterialCardView_strokeColor);
        if (this.strokeColor == null) {
            this.strokeColor = ColorStateList.valueOf(-1);
        }
        this.strokeWidth = typedArray.getDimensionPixelSize(C2556R.styleable.MaterialCardView_strokeWidth, 0);
        this.checkable = typedArray.getBoolean(C2556R.styleable.MaterialCardView_android_checkable, false);
        this.materialCardView.setLongClickable(this.checkable);
        this.checkedIconTint = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C2556R.styleable.MaterialCardView_checkedIconTint);
        setCheckedIcon(MaterialResources.getDrawable(this.materialCardView.getContext(), typedArray, C2556R.styleable.MaterialCardView_checkedIcon));
        this.rippleColor = MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C2556R.styleable.MaterialCardView_rippleColor);
        if (this.rippleColor == null) {
            this.rippleColor = ColorStateList.valueOf(MaterialColors.getColor(this.materialCardView, C2556R.attr.colorControlHighlight));
        }
        setCardForegroundColor(MaterialResources.getColorStateList(this.materialCardView.getContext(), typedArray, C2556R.styleable.MaterialCardView_cardForegroundColor));
        updateRippleColor();
        updateElevation();
        updateStroke();
    ...
    public void setCheckedIcon(Drawable drawable) {
        ...
        if (this.clickableForegroundDrawable != null) {
            this.clickableForegroundDrawable.setDrawableByLayerId(C2556R.C2559id.mtrl_card_checked_layer_id, createCheckedIconLayer());
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            if ((VERSION.SDK_INT < 21) || this.materialCardView.getUseCompatPadding()) {
                i9 -= (int) Math.ceil((double) (calculateVerticalBackgroundPadding() * 2.0f));
                i8 -= (int) Math.ceil((double) (calculateHorizontalBackgroundPadding() * 2.0f));
            }
            int i10 = i9;
            ...
            this.clickableForegroundDrawable.setLayerInset(2, i4, this.checkedIconMargin, i3, i10);
        }
    }
    ...
    private Drawable insetDrawable(Drawable drawable) {
        ...
        C26061 r2 = new InsetDrawable(drawable, i2, i, i2, i) {
    ...
    private Drawable getClickableForeground() {
        ...
        if (this.clickableForegroundDrawable == null) {
            ...
            this.clickableForegroundDrawable.setId(2, C2556R.C2559id.mtrl_card_checked_layer_id);
        }

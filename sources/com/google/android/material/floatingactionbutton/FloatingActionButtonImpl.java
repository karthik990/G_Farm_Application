...
class FloatingActionButtonImpl {
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C2556R.animator.design_fab_show_motion_spec);
        }
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C2556R.animator.design_fab_hide_motion_spec);
        }
    ...
    private AnimatorSet createAnimator(MotionSpec motionSpec, float f, float f2, float f3) {
        ...
        String str = SlidingMenu.SCALED_MENU;

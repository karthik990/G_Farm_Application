...
public class ExtendedFloatingActionButton extends MaterialButton implements AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C2556R.C2562style.Widget_MaterialComponents_ExtendedFloatingActionButton_Icon;
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C2556R.animator.mtrl_extended_fab_change_size_motion_spec;
        }
        ...
        public AnimatorSet createAnimator() {
            ...
            String str2 = SettingsJsonConstants.ICON_HEIGHT_KEY;
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends Behavior<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2556R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = obtainStyledAttributes.getBoolean(C2556R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
            this.autoShrinkEnabled = obtainStyledAttributes.getBoolean(C2556R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
    ...
    class HideStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C2556R.animator.mtrl_extended_fab_hide_motion_spec;
        }
    ...
    class ShowStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C2556R.animator.mtrl_extended_fab_show_motion_spec;
        }
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2556R.attr.extendedFloatingActionButtonStyle);
    }
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2556R.styleable.ExtendedFloatingActionButton, i, DEF_STYLE_RES, new int[0]);
        MotionSpec createFromAttribute = MotionSpec.createFromAttribute(context2, obtainStyledAttributes, C2556R.styleable.ExtendedFloatingActionButton_showMotionSpec);
        MotionSpec createFromAttribute2 = MotionSpec.createFromAttribute(context2, obtainStyledAttributes, C2556R.styleable.ExtendedFloatingActionButton_hideMotionSpec);
        MotionSpec createFromAttribute3 = MotionSpec.createFromAttribute(context2, obtainStyledAttributes, C2556R.styleable.ExtendedFloatingActionButton_extendMotionSpec);
        MotionSpec createFromAttribute4 = MotionSpec.createFromAttribute(context2, obtainStyledAttributes, C2556R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec);

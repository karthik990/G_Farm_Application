...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            this.container = (FrameLayout) View.inflate(getContext(), C2556R.layout.design_bottom_sheet_dialog, null);
            this.behavior = BottomSheetBehavior.from((FrameLayout) this.container.findViewById(C2556R.C2559id.design_bottom_sheet));
    ...
    private View wrapInBottomSheet(int i, View view, LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(C2556R.C2559id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout = (FrameLayout) this.container.findViewById(C2556R.C2559id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C2556R.C2559id.touch_outside).setOnClickListener(new OnClickListener() {
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C2556R.attr.bottomSheetDialogTheme, typedValue, true)) {
            return typedValue.resourceId;
        }
        return C2556R.C2562style.Theme_Design_Light_BottomSheetDialog;
    }

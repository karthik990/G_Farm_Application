...
final class MediaPeriodHolder {
    ...
    public MediaPeriodHolder(RendererCapabilities[] rendererCapabilitiesArr, long j, TrackSelector trackSelector2, Allocator allocator, MediaSource mediaSource2, MediaPeriodInfo mediaPeriodInfo, TrackSelectorResult trackSelectorResult2) {
        ...
        this.uid = mediaPeriodInfo.f1475id.periodUid;
        this.info = mediaPeriodInfo;
        this.trackSelectorResult = trackSelectorResult2;
        this.sampleStreams = new SampleStream[rendererCapabilitiesArr.length];
        this.mayRetainStreamFlags = new boolean[rendererCapabilitiesArr.length];
        this.mediaPeriod = createMediaPeriod(mediaPeriodInfo.f1475id, mediaSource2, allocator, mediaPeriodInfo.startPositionUs, mediaPeriodInfo.endPositionUs);
    }
    ...
    public TrackSelectorResult selectTracks(float f, Timeline timeline) throws ExoPlaybackException {
        TrackSelection[] all;
        TrackSelectorResult selectTracks = this.trackSelector.selectTracks(this.rendererCapabilities, getTrackGroups(), this.info.f1475id, timeline);
    ...
    private static MediaPeriod createMediaPeriod(MediaPeriodId mediaPeriodId, MediaSource mediaSource2, Allocator allocator, long j, long j2) {
        ...
        if (j2 == C1996C.TIME_UNSET || j2 == Long.MIN_VALUE) {
            return createPeriod;
        }
    ...
    private static void releaseMediaPeriod(long j, MediaSource mediaSource2, MediaPeriod mediaPeriod2) {
        if (j == C1996C.TIME_UNSET || j == Long.MIN_VALUE) {
        ...
        try {
            ...
            Log.m1393e(TAG, "Period release failed.", e);
        }
    }
}

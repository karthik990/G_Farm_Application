...
public final class ClippingMediaPeriod implements MediaPeriod, Callback {
    ...
    public ClippingMediaPeriod(MediaPeriod mediaPeriod2, boolean z, long j, long j2) {
        ...
        this.pendingInitialDiscontinuityPositionUs = z ? j : C1996C.TIME_UNSET;
        this.startUs = j;
        this.endUs = j2;
    }
    ...
    public long readDiscontinuity() {
        if (isPendingInitialDiscontinuity()) {
            ...
            this.pendingInitialDiscontinuityPositionUs = C1996C.TIME_UNSET;
        ...
        if (readDiscontinuity2 == C1996C.TIME_UNSET) {
    ...
    public boolean isPendingInitialDiscontinuity() {
        return this.pendingInitialDiscontinuityPositionUs != C1996C.TIME_UNSET;
    }

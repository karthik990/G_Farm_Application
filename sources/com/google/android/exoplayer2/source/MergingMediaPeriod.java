...
final class MergingMediaPeriod implements MediaPeriod, Callback {
    ...
    public long selectTracks(TrackSelection[] trackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        while (i4 < this.periods.length) {
            ...
            for (int i7 = 0; i7 < trackSelectionArr2.length; i7++) {
                boolean z2 = true;
                if (iArr2[i7] == i6) {
                    SampleStream sampleStream = (SampleStream) Assertions.checkNotNull(sampleStreamArr4[i7]);
                    sampleStreamArr3[i7] = sampleStreamArr4[i7];
                    this.streamPeriodIndices.put(sampleStream, Integer.valueOf(i6));
                    z = true;
                } else if (iArr[i7] == i6) {
    ...
    public long readDiscontinuity() {
        ...
        while (true) {
            ...
            } else if (mediaPeriodArr[i].readDiscontinuity() == C1996C.TIME_UNSET) {
                i++;
            } else {

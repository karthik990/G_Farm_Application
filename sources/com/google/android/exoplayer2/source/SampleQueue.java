...
public class SampleQueue implements TrackOutput {
    ...
    private void readToBuffer(DecoderInputBuffer decoderInputBuffer, SampleExtrasHolder sampleExtrasHolder) {
    ...
    private void readEncryptionData(DecoderInputBuffer decoderInputBuffer, SampleExtrasHolder sampleExtrasHolder) {
        ...
        if (decoderInputBuffer2.cryptoInfo.f1477iv == null) {
            decoderInputBuffer2.cryptoInfo.f1477iv = new byte[16];
        }
        readData(j2, decoderInputBuffer2.cryptoInfo.f1477iv, (int) b2);
        long j3 = j2 + ((long) b2);
        if (z) {
        ...
        decoderInputBuffer2.cryptoInfo.set(i, iArr2, iArr4, cryptoData.encryptionKey, decoderInputBuffer2.cryptoInfo.f1477iv, cryptoData.cryptoMode, cryptoData.encryptedBlocks, cryptoData.clearBlocks);

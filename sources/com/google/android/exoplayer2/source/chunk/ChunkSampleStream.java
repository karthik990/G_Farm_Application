...
public class ChunkSampleStream<T extends ChunkSource> implements SampleStream, SequenceableLoader, Callback<Chunk>, com.google.android.exoplayer2.upstream.Loader.ReleaseCallback {
    ...
    public ChunkSampleStream(int i, int[] iArr, Format[] formatArr, T t, SequenceableLoader.Callback<ChunkSampleStream<T>> callback2, Allocator allocator, long j, DrmSessionManager<?> drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, EventDispatcher eventDispatcher2) {
        int i2;
        ...
        this.primarySampleQueue = new SampleQueue(allocator, drmSessionManager);
        iArr2[0] = i;
        sampleQueueArr[0] = this.primarySampleQueue;
        while (i3 < i2) {
            SampleQueue sampleQueue = new SampleQueue(allocator, CC.getDummyDrmSessionManager());
    ...
    public void seekToUs(long j) {
        ...
        while (true) {
            ...
            if (j2 == j && baseMediaChunk2.clippedStartTimeUs == C1996C.TIME_UNSET) {
    ...
    public LoadErrorAction onLoadError(Chunk chunk, long j, long j2, IOException iOException, int i) {
        ...
        if (this.chunkSource.onChunkLoadError(chunk, z, iOException, z ? this.loadErrorHandlingPolicy.getBlacklistDurationMsFor(chunk2.type, j2, iOException, i) : -9223372036854775807L)) {
            if (z) {
                ...
                Log.m1396w(TAG, "Ignoring attempt to cancel non-cancelable load.");
            }
        }
    ...
    public void reevaluateBuffer(long j) {
        if (!this.loader.isLoading() && !this.loader.hasFatalError() && !isPendingReset()) {

...
final class DashMediaPeriod implements MediaPeriod, Callback<ChunkSampleStream<DashChunkSource>>, ReleaseCallback<DashChunkSource> {
    ...
    public DashMediaPeriod(int i, DashManifest dashManifest, int i2, Factory factory, TransferListener transferListener2, DrmSessionManager<?> drmSessionManager2, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, EventDispatcher eventDispatcher2, long j, LoaderErrorThrower loaderErrorThrower, Allocator allocator2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory2, PlayerEmsgCallback playerEmsgCallback) {
        this.f1519id = i;
        ...
        Pair buildTrackGroups = buildTrackGroups(drmSessionManager2, period.adaptationSets, this.eventStreams);
    ...
    public void updateManifest(DashManifest dashManifest, int i) {
        ...
        for (EventSampleStream eventSampleStream : this.eventSampleStreams) {
            ...
            while (true) {
                ...
                if (eventStream.mo23405id().equals(eventSampleStream.eventStreamId())) {
                    boolean z = true;
            ...
            if (trackGroupInfo.trackGroupCategory == 0) {
                ...
                for (int i5 : iArr2) {
                    while (true) {
                        ...
                        i3++;
                        i2 = ((AdaptationSet) list2.get(iArr[i3])).representations.size();
                        i4 = i6;
                    }
    ...
    private static int[][] getGroupedAdaptationSetIndices(List<AdaptationSet> list) {
        ...
        for (int i = 0; i < size; i++) {
            sparseIntArray.put(((AdaptationSet) list.get(i)).f1520id, i);
        }
    ...
    private static int buildPrimaryAndEmbeddedTrackGroupInfos(DrmSessionManager<?> drmSessionManager2, List<AdaptationSet> list, int[][] iArr, int i, boolean[] zArr, Format[][] formatArr, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr) {
        ...
        while (i5 < i4) {
            ...
            if (i9 != -1) {
                ...
                sb.append(adaptationSet.f1520id);
                sb.append(":emsg");
    ...
    private static void buildManifestEventTrackGroupInfos(List<EventStream> list, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr, int i) {
        ...
        int i3 = 0;
        while (i3 < list.size()) {
            trackGroupArr[i2] = new TrackGroup(Format.createSampleFormat(((EventStream) list.get(i3)).mo23405id(), MimeTypes.APPLICATION_EMSG, null, -1, null));
            int i4 = i2 + 1;
        ...
        for (int i : iArr) {
            ...
            for (int i2 = 0; i2 < list2.size(); i2++) {
                ...
                if ("urn:scte:dash:cc:cea-608:2015".equals(descriptor.schemeIdUri)) {
                    ...
                    if (str == null) {
                        return new Format[]{buildCea608TrackFormat(adaptationSet.f1520id)};
                    }
                    ...
                    for (int i3 = 0; i3 < split.length; i3++) {
                        ...
                        formatArr[i3] = buildCea608TrackFormat(adaptationSet.f1520id, matcher.group(2), Integer.parseInt(matcher.group(1)));
                    }
                    return formatArr;
                }
            }

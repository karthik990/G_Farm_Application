...
public class DashManifest implements FilterableManifest<DashManifest> {
    ...
    public final long getPeriodDurationUs(int i) {
        return C1996C.msToUs(getPeriodDurationMs(i));
    }
    ...
    public final DashManifest copy(List<StreamKey> list) {
        ...
        while (true) {
            ...
            if (((StreamKey) linkedList.peek()).periodIndex != i) {
                ...
                if (periodDurationMs != C1996C.TIME_UNSET) {
                    j2 += periodDurationMs;
                }
            } else {
                Period period = getPeriod(i);
                Period period2 = new Period(period.f1522id, period.startMs - j2, copyAdaptationSets(period.adaptationSets, linkedList), period.eventStreams);
    ...
    private static ArrayList<AdaptationSet> copyAdaptationSets(List<AdaptationSet> list, LinkedList<StreamKey> linkedList) {
        ...
        do {
            ...
            AdaptationSet adaptationSet2 = new AdaptationSet(adaptationSet.f1520id, adaptationSet.type, arrayList2, adaptationSet.accessibilityDescriptors, adaptationSet.supplementalProperties);

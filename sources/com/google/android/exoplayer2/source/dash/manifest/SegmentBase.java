...
public abstract class SegmentBase {
    ...
    public static class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            RangedUri rangedUri = new RangedUri(urlTemplate.buildUri(representation.format.f1474id, 0, representation.format.bitrate, 0), 0, -1);
            return rangedUri;
        }
        ...
        public RangedUri getSegmentUrl(Representation representation, long j) {
            ...
            long j3 = j2;
            RangedUri rangedUri = new RangedUri(this.mediaTemplate.buildUri(representation2.format.f1474id, j, representation2.format.bitrate, j3), 0, -1);
            return rangedUri;
        }

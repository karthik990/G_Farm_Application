...
public final class PlayerEmsgHandler implements Callback {
    ...
    private long lastLoadedChunkEndTimeBeforeRefreshUs = C1996C.TIME_UNSET;
    private long lastLoadedChunkEndTimeUs = C1996C.TIME_UNSET;
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private void parsePlayerEmsgEvent(long j, EventMessage eventMessage) {
            ...
            if (access$100 != C1996C.TIME_UNSET) {
    ...
    public boolean maybeRefreshManifestOnLoadingError(Chunk chunk) {
        ...
        if (!(j != C1996C.TIME_UNSET && j < chunk.startTimeUs)) {
            return false;
        }
        maybeNotifyDashManifestRefreshNeeded();
        return true;
    ...
    /* access modifiers changed from: 0000 */
    public void onChunkLoadCompleted(Chunk chunk) {
        if (this.lastLoadedChunkEndTimeUs != C1996C.TIME_UNSET || chunk.endTimeUs > this.lastLoadedChunkEndTimeUs) {
    ...
    public PlayerTrackEmsgHandler newPlayerTrackEmsgHandler() {
        return new PlayerTrackEmsgHandler(new SampleQueue(this.allocator, CC.getDummyDrmSessionManager()));
    }
    ...
    private void maybeNotifyDashManifestRefreshNeeded() {
        ...
        if (j == C1996C.TIME_UNSET || j != this.lastLoadedChunkEndTimeUs) {

...
class HlsChunkSource {
    ...
    private long liveEdgeInPeriodTimeUs = C1996C.TIME_UNSET;
    ...
    public void getNextChunk(long r29, long r31, java.util.List<com.google.android.exoplayer2.source.hls.HlsMediaChunk> r33, boolean r34, com.google.android.exoplayer2.source.hls.HlsChunkSource.HlsChunkHolder r35) {
        ...
        L_0x0140:
            ...
            com.google.android.exoplayer2.source.chunk.Chunk r5 = r8.maybeCreateEncryptionChunkFor(r1, r10)
            r9.chunk = r5
            com.google.android.exoplayer2.source.chunk.Chunk r5 = r9.chunk
    ...
    public boolean onPlaylistError(Uri uri, long j) {
        ...
        if (j == C1996C.TIME_UNSET || this.trackSelection.blacklist(indexOf, j)) {
            z = true;
        }
        return z;
    }
    ...
    private long resolveTimeToLiveEdgeUs(long j) {
        if (this.liveEdgeInPeriodTimeUs != C1996C.TIME_UNSET) {
    ...
    private static Uri getFullEncryptionKeyUri(HlsMediaPlaylist hlsMediaPlaylist, Segment segment) {

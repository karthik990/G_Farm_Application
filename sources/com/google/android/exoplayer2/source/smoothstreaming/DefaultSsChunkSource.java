...
public class DefaultSsChunkSource implements SsChunkSource {
    ...
    public DefaultSsChunkSource(LoaderErrorThrower loaderErrorThrower, SsManifest ssManifest, int i, TrackSelection trackSelection2, DataSource dataSource2) {
        ...
        while (i3 < this.extractorWrappers.length) {
            ...
            int i4 = i3;
            Track track = r7;
            Track track2 = new Track(indexInTrackGroup, streamElement.type, streamElement.timescale, C1996C.TIME_UNSET, ssManifest2.durationUs, format, 0, format.drmInitData != null ? ssManifest2.protectionElement.trackEncryptionBoxes : null, streamElement.type == 2 ? 4 : 0, null, null);
    ...
    private static MediaChunk newMediaChunk(Format format, DataSource dataSource2, Uri uri, String str, int i, long j, long j2, long j3, int i2, Object obj, ChunkExtractorWrapper chunkExtractorWrapper) {
        ...
        ContainerMediaChunk containerMediaChunk = new ContainerMediaChunk(dataSource3, dataSpec, format2, i3, obj2, j4, j6, j7, C1996C.TIME_UNSET, (long) i, 1, j5, chunkExtractorWrapper2);

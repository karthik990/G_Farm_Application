...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Callback<ExtractingLoadable>, ReleaseCallback, UpstreamFormatChangedListener {
    ...
    final class ExtractingLoadable implements Loadable, com.google.android.exoplayer2.source.IcyDataSource.Listener {
        ...
        private DataSpec buildDataSpec(long j) {
            DataSpec dataSpec2 = new DataSpec(this.uri, j, -1, ProgressiveMediaPeriod.this.customCacheKey, 6, ProgressiveMediaPeriod.ICY_METADATA_HEADERS);
            return dataSpec2;
        }
    ...
    private static final class TrackId {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(this.f1494id == trackId.f1494id && this.isIcyTrack == trackId.isIcyTrack)) {
                z = false;
            }
            return z;
        }
        ...
        public int hashCode() {
            return (this.f1494id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }
    ...
    public ProgressiveMediaPeriod(Uri uri2, DataSource dataSource2, Extractor[] extractorArr, DrmSessionManager<?> drmSessionManager2, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, EventDispatcher eventDispatcher2, Listener listener2, Allocator allocator2, String str, int i) {
        this.uri = uri2;
    ...
    public void onLoadCompleted(ExtractingLoadable extractingLoadable, long j, long j2) {
        if (this.durationUs == C1996C.TIME_UNSET) {
    ...
    public void seekMap(SeekMap seekMap2) {
        if (this.icyHeaders != null) {
            seekMap2 = new Unseekable(C1996C.TIME_UNSET);
        }
        this.seekMap = seekMap2;
        this.handler.post(this.maybeFinishPrepareRunnable);
    }
    ...
    public void maybeFinishPrepare() {
        ...
        if (!this.released && !this.prepared && this.sampleQueuesBuilt && seekMap2 != null) {
            ...
            if (this.length == -1 && seekMap2.getDurationUs() == C1996C.TIME_UNSET) {
                z = true;
            }
            this.isLive = z;
    ...
    private void startLoading() {
        ...
        if (this.prepared) {
            ...
            if (j == C1996C.TIME_UNSET || this.pendingResetPositionUs <= j) {
    ...
    private boolean configureRetry(ExtractingLoadable extractingLoadable, int i) {
        if (this.length == -1) {
            SeekMap seekMap2 = this.seekMap;
            if (seekMap2 == null || seekMap2.getDurationUs() == C1996C.TIME_UNSET) {

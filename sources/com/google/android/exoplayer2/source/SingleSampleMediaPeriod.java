...
final class SingleSampleMediaPeriod implements MediaPeriod, Callback<SourceLoadable> {
    ...
    public SingleSampleMediaPeriod(DataSpec dataSpec2, Factory factory, TransferListener transferListener2, Format format2, long j, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, EventDispatcher eventDispatcher2, boolean z) {
        this.dataSpec = dataSpec2;
    ...
    public LoadErrorAction onLoadError(SourceLoadable sourceLoadable, long j, long j2, IOException iOException, int i) {
        ...
        boolean z = retryDelayMsFor == C1996C.TIME_UNSET || i >= this.loadErrorHandlingPolicy.getMinimumLoadableRetryCount(1);

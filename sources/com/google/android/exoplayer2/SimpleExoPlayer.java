...
public class SimpleExoPlayer extends BasePlayer implements ExoPlayer, AudioComponent, VideoComponent, TextComponent, MetadataComponent {
    ...
    public static final class Builder {
        ...
        public Builder(Context context2, RenderersFactory renderersFactory2) {
            this(context2, renderersFactory2, new DefaultTrackSelector(context2), new DefaultLoadControl(), DefaultBandwidthMeter.getSingletonInstance(context2), Util.getLooper(), new AnalyticsCollector(Clock.DEFAULT), true, Clock.DEFAULT);
        }

        public Builder(Context context2, RenderersFactory renderersFactory2, TrackSelector trackSelector2, LoadControl loadControl2, BandwidthMeter bandwidthMeter2, Looper looper2, AnalyticsCollector analyticsCollector2, boolean z, Clock clock2) {
    ...
    private final class ComponentListener implements VideoRendererEventListener, AudioRendererEventListener, TextOutput, MetadataOutput, Callback, SurfaceTextureListener, PlayerControl, EventListener, Player.EventListener {
    ...
    protected SimpleExoPlayer(Context context, RenderersFactory renderersFactory, TrackSelector trackSelector, LoadControl loadControl, BandwidthMeter bandwidthMeter2, AnalyticsCollector analyticsCollector2, Clock clock, Looper looper) {
        this(context, renderersFactory, trackSelector, loadControl, DrmSessionManager.CC.getDummyDrmSessionManager(), bandwidthMeter2, analyticsCollector2, clock, looper);
    }

    @Deprecated
    protected SimpleExoPlayer(Context context, RenderersFactory renderersFactory, TrackSelector trackSelector, LoadControl loadControl, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, BandwidthMeter bandwidthMeter2, AnalyticsCollector analyticsCollector2, Clock clock, Looper looper) {
        ...
        if (drmSessionManager2 instanceof DefaultDrmSessionManager) {
            ((DefaultDrmSessionManager) drmSessionManager2).addListener(this.eventHandler, analyticsCollector3);
        }
    ...
    public void setVideoTextureView(TextureView textureView2) {
        ...
        if (textureView2.getSurfaceTextureListener() != null) {
            Log.m1396w(TAG, "Replacing existing SurfaceTextureListener.");
        }
    ...
    public void setAudioStreamType(int i) {
        ...
        setAudioAttributes(new com.google.android.exoplayer2.audio.AudioAttributes.Builder().setUsage(audioUsageForStreamType).setContentType(Util.getAudioContentTypeForStreamType(i)).build());
    }
    ...
    private void removeSurfaceCallbacks() {
        ...
        if (textureView2 != null) {
            if (textureView2.getSurfaceTextureListener() != this.componentListener) {
                Log.m1396w(TAG, "SurfaceTextureListener already unset or replaced.");
            } else {
    ...
    private void verifyApplicationThread() {
        if (Looper.myLooper() != getApplicationLooper()) {
            Log.m1397w(TAG, "Player is accessed on the wrong thread. See https://exoplayer.dev/issues/player-accessed-on-wrong-thread", this.hasNotifiedFullWrongThreadWarning ? null : new IllegalStateException());

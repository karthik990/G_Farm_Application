...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f1487id.equals(textInformationFrame.f1487id) || !Util.areEqual(this.description, textInformationFrame.description) || !Util.areEqual(this.value, textInformationFrame.value)) {
            z = false;
        }
        return z;
    }

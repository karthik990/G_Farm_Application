...
public final class Id3Decoder implements MetadataDecoder {
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        ...
        String str = TAG;
        if (bytesLeft < 10) {
            Log.m1396w(str, "Data too short to be an ID3 tag");
            return null;
        }
        ...
        if (readUnsignedInt24 != 4801587) {
            ...
            sb.append(String.format("%06X", new Object[]{Integer.valueOf(readUnsignedInt24)}));
        ...
        if (readUnsignedByte == 2) {
            if ((readUnsignedByte2 & 64) != 0) {
                Log.m1396w(str, "Skipped ID3 tag with majorVersion=2 and undefined compression scheme");
                return null;
            }
    ...
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r19, com.google.android.exoplayer2.util.ParsableByteArray r20, boolean r21, int r22, com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r23) {
        ...
        L_0x0067:
            ...
            com.google.android.exoplayer2.util.Log.m1396w(r4, r0)
            int r0 = r20.limit()
            r7.setPosition(r0)
            return r16
        L_0x0082:
        ...
        L_0x01f9:
            ...
            com.google.android.exoplayer2.util.Log.m1396w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x021f }
        L_0x021b:
            r7.setPosition(r14)
            return r1
        L_0x021f:
            java.lang.String r0 = "Unsupported character encoding"
            com.google.android.exoplayer2.util.Log.m1396w(r12, r0)     // Catch:{ all -> 0x012f }
            r7.setPosition(r14)
            return r16
        L_0x0228:
            r7.setPosition(r14)
        ...
        L_0x022c:
            ...
            com.google.android.exoplayer2.util.Log.m1396w(r12, r0)
            r7.setPosition(r14)
            return r16
        */

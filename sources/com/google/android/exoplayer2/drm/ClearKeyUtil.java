...
final class ClearKeyUtil {
    ...
    public static byte[] adjustResponseData(byte[] bArr) {
        ...
        try {
            ...
            Log.m1393e(TAG, sb2.toString(), e);
            return bArr;
        }
    }

    private static String base64ToBase64Url(String str) {
        return str.replace(SignatureVisitor.EXTENDS, '-').replace(JsonPointer.SEPARATOR, '_');
    }

    private static String base64UrlToBase64(String str) {
        return str.replace('-', SignatureVisitor.EXTENDS).replace('_', JsonPointer.SEPARATOR);
    }
}

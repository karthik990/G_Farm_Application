...
public class TrackSelectionView extends LinearLayout {
    ...
    public TrackSelectionView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.disableView.setText(C2489R.C2493string.exo_track_selection_none);
        ...
        addView(this.inflater.inflate(C2489R.layout.exo_list_divider, this, false));
        ...
        this.defaultView.setText(C2489R.C2493string.exo_track_selection_auto);
    ...
    public void init(MappedTrackInfo mappedTrackInfo2, int i, boolean z, List<SelectionOverride> list, TrackSelectionListener trackSelectionListener) {

...
final class SimpleCacheSpan extends CacheSpan {
    ...
    public static SimpleCacheSpan createLookup(String str, long j) {
        SimpleCacheSpan simpleCacheSpan = new SimpleCacheSpan(str, j, -1, C1996C.TIME_UNSET, null);
    ...
    public static SimpleCacheSpan createClosedHole(String str, long j, long j2) {
        SimpleCacheSpan simpleCacheSpan = new SimpleCacheSpan(str, j, j2, C1996C.TIME_UNSET, null);
        return simpleCacheSpan;
    }

    public static SimpleCacheSpan createCacheEntry(File file, long j, CachedContentIndex cachedContentIndex) {
        return createCacheEntry(file, j, C1996C.TIME_UNSET, cachedContentIndex);
    }
    ...
    public static SimpleCacheSpan createCacheEntry(File file, long j, long j2, CachedContentIndex cachedContentIndex) {
        ...
        SimpleCacheSpan simpleCacheSpan = new SimpleCacheSpan(keyForId, Long.parseLong(matcher.group(2)), length, j2 == C1996C.TIME_UNSET ? Long.parseLong(matcher.group(3)) : j2, file2);
        return simpleCacheSpan;
    }

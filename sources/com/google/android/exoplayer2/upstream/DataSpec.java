...
public final class DataSpec {
    ...
    public DataSpec subrange(long j, long j2) {
        ...
        DataSpec dataSpec = new DataSpec(this.uri, this.httpMethod, this.httpBody, this.absoluteStreamPosition + j, this.position + j, j2, this.key, this.flags, this.httpRequestHeaders);
        return dataSpec;
    }

    public DataSpec withUri(Uri uri2) {
        DataSpec dataSpec = new DataSpec(uri2, this.httpMethod, this.httpBody, this.absoluteStreamPosition, this.position, this.length, this.key, this.flags, this.httpRequestHeaders);
        return dataSpec;
    }

    public DataSpec withRequestHeaders(Map<String, String> map) {
        DataSpec dataSpec = new DataSpec(this.uri, this.httpMethod, this.httpBody, this.absoluteStreamPosition, this.position, this.length, this.key, this.flags, map);
        return dataSpec;
    }
    ...
    public DataSpec withAdditionalHeaders(Map<String, String> map) {
        ...
        hashMap.putAll(map);
        DataSpec dataSpec = new DataSpec(this.uri, this.httpMethod, this.httpBody, this.absoluteStreamPosition, this.position, this.length, this.key, this.flags, hashMap);
        return dataSpec;
    }
}

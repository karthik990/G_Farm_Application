...
final class WavHeader implements SeekMap {
    ...
    public SeekPoints getSeekPoints(long j) {
        ...
        long j3 = (((long) this.averageBytesPerSecond) * j) / 1000000;
        int i = this.blockAlignment;
        long constrainValue = Util.constrainValue((j3 / ((long) i)) * ((long) i), 0, j2 - ((long) i));
        long j4 = ((long) this.dataStartPosition) + constrainValue;

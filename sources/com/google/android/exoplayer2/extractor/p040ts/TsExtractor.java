...
import com.google.android.exoplayer2.extractor.p040ts.TsPayloadReader.DvbSubtitleInfo;
...
public final class TsExtractor implements Extractor {
    ...
    public void seek(long j, long j2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((timestampAdjuster.getTimestampOffsetUs() == C1996C.TIME_UNSET) || !(timestampAdjuster.getTimestampOffsetUs() == 0 || timestampAdjuster.getFirstSampleTimestampUs() == j2)) {
    ...
    private void maybeOutputSeekMap(long j) {
        if (!this.hasOutputSeekMap) {
            ...
            if (this.durationReader.getDurationUs() != C1996C.TIME_UNSET) {

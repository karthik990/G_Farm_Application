...
final class FlacReader extends StreamReader {
    ...
    public boolean readHeaders(ParsableByteArray parsableByteArray, long j, SetupData setupData) {
        ...
        if (this.streamMetadata == null) {
            ...
            int i = this.streamMetadata.maxFrameSize == 0 ? -1 : this.streamMetadata.maxFrameSize;
            byte[] copyOfRange = Arrays.copyOfRange(bArr, 9, parsableByteArray.limit());
            copyOfRange[4] = Byte.MIN_VALUE;
            setupData2.format = Format.createAudioSampleFormat(null, MimeTypes.AUDIO_FLAC, null, this.streamMetadata.bitRate(), i, this.streamMetadata.channels, this.streamMetadata.sampleRate, Collections.singletonList(copyOfRange), null, 0, null);
        } else if ((bArr[0] & Byte.MAX_VALUE) == 3) {
            this.flacOggSeeker = new FlacOggSeeker();
            this.flacOggSeeker.parseSeekTable(parsableByteArray2);

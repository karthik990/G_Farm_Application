...
public final class PlaybackStats {
    ...
    public final List<Pair<EventTime, Format>> audioFormatHistory;
    ...
    public final List<Pair<EventTime, Integer>> playbackStateHistory;
    ...
    public final List<Pair<EventTime, Format>> videoFormatHistory;
    ...
    public static PlaybackStats merge(PlaybackStats... playbackStatsArr) {
        ...
        long j10 = 0;
        int i3 = -1;
        long j11 = C1996C.TIME_UNSET;
        int i4 = 0;
        int i5 = 0;
        long j12 = C1996C.TIME_UNSET;
        int i6 = 0;
        int i7 = 0;
        int i8 = 0;
        int i9 = 0;
        long j13 = C1996C.TIME_UNSET;
        int i10 = 0;
        int i11 = 0;
        int i12 = 0;
        int i13 = 0;
        ...
        int i24 = i3;
        PlaybackStats playbackStats2 = new PlaybackStats(i5, jArr, Collections.emptyList(), Collections.emptyList(), j12, i6, i7, i8, i9, j13, i10, i11, i12, i13, i14, j11, i15, Collections.emptyList(), Collections.emptyList(), j, j2, j3, j4, j5, j6, i16, i17, i24, j14, i18, j15, j7, j8, j9, j10, i19, i20, i21, Collections.emptyList(), Collections.emptyList());
        return playbackStats2;
    }

    PlaybackStats(int i, long[] jArr, List<Pair<EventTime, Integer>> list, List<long[]> list2, long j, int i2, int i3, int i4, int i5, long j2, int i6, int i7, int i8, int i9, int i10, long j3, int i11, List<Pair<EventTime, Format>> list3, List<Pair<EventTime, Format>> list4, long j4, long j5, long j6, long j7, long j8, long j9, int i12, int i13, int i14, long j10, int i15, long j11, long j12, long j13, long j14, long j15, int i16, int i17, int i18, List<Pair<EventTime, Exception>> list5, List<Pair<EventTime, Exception>> list6) {
    ...
    public int getPlaybackStateAtTime(long j) {
        int i = 0;
        for (Pair pair : this.playbackStateHistory) {
            if (((EventTime) pair.first).realtimeMs > j) {
                break;
            }
    ...
    public long getMediaTimeMsAtRealtimeMs(long j) {
        ...
        int i = 0;
        while (i < this.mediaTimeHistory.size() && ((long[]) this.mediaTimeHistory.get(i))[0] <= j) {
            i++;
        }
        if (i == 0) {
        ...
        if (i == this.mediaTimeHistory.size()) {
            ...
            return ((long[]) list.get(list.size() - 1))[1];
        }
        int i2 = i - 1;
        long j2 = ((long[]) this.mediaTimeHistory.get(i2))[0];
        long j3 = ((long[]) this.mediaTimeHistory.get(i2))[1];
        long j4 = ((long[]) this.mediaTimeHistory.get(i))[0];
        long j5 = ((long[]) this.mediaTimeHistory.get(i))[1];
        long j6 = j4 - j2;
        if (j6 == 0) {
            return j3;
        }
    ...
    public long getMeanJoinTimeMs() {
        ...
        return i == 0 ? C1996C.TIME_UNSET : this.totalValidJoinTimeMs / ((long) i);
    }
    ...
    public long getMeanSingleSeekTimeMs() {
        return this.totalSeekCount == 0 ? C1996C.TIME_UNSET : getTotalSeekTimeMs() / ((long) this.totalSeekCount);
    }
    ...
    public long getMeanElapsedTimeMs() {
        return this.playbackCount == 0 ? C1996C.TIME_UNSET : getTotalElapsedTimeMs() / ((long) this.playbackCount);
    }

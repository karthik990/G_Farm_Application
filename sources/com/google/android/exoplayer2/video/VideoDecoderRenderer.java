...
class VideoDecoderRenderer implements Renderer, VideoDecoderOutputBufferRenderer {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        if (videoDecoderOutputBuffer != null || this.renderedOutputBuffer != null) {
            ...
            VideoDecoderOutputBuffer videoDecoderOutputBuffer3 = this.renderedOutputBuffer;
            ...
            while (i2 < 3) {
                ...
                GLES20.glTexImage2D(3553, 0, 6409, videoDecoderOutputBuffer3.yuvStrides[i2], i3, 0, 6409, 5121, videoDecoderOutputBuffer3.yuvPlanes[i2]);
                i2++;
            }
            int[] iArr = new int[3];
            iArr[0] = videoDecoderOutputBuffer3.width;
            int i4 = (iArr[0] + 1) / 2;
            iArr[2] = i4;
            iArr[1] = i4;
            for (int i5 = 0; i5 < 3; i5++) {
                if (this.previousWidths[i5] != iArr[i5] || this.previousStrides[i5] != videoDecoderOutputBuffer3.yuvStrides[i5]) {
                    Assertions.checkState(videoDecoderOutputBuffer3.yuvStrides[i5] != 0);
                    float f = ((float) iArr[i5]) / ((float) videoDecoderOutputBuffer3.yuvStrides[i5]);
                    ...
                    this.previousStrides[i5] = videoDecoderOutputBuffer3.yuvStrides[i5];
                }
            }

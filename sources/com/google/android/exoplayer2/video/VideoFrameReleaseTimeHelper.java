...
public final class VideoFrameReleaseTimeHelper {
    ...
    private static final class VSyncSampler implements FrameCallback, Callback {
        ...
        public volatile long sampledVsyncTimeNs = C1996C.TIME_UNSET;
        ...
        private void removeObserverInternal() {
            ...
            if (this.observerCount == 0) {
                ...
                this.sampledVsyncTimeNs = C1996C.TIME_UNSET;
            }
        }
    }
    ...
    public VideoFrameReleaseTimeHelper(Context context) {
        ...
        this.vsyncDurationNs = C1996C.TIME_UNSET;
        this.vsyncOffsetNs = C1996C.TIME_UNSET;
    }

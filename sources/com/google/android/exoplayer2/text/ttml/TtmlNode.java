...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        TtmlNode ttmlNode = new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(str), C1996C.TIME_UNSET, C1996C.TIME_UNSET, null, null, "", null);
        return ttmlNode;
    }
    ...
    public boolean isActive(long j) {
        return (this.startTimeUs == C1996C.TIME_UNSET && this.endTimeUs == C1996C.TIME_UNSET) || (this.startTimeUs <= j && this.endTimeUs == C1996C.TIME_UNSET) || ((this.startTimeUs == C1996C.TIME_UNSET && j < this.endTimeUs) || (this.startTimeUs <= j && j < this.endTimeUs));
    }

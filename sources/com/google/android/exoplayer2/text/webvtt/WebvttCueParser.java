...
public final class WebvttCueParser {
    ...
    static void parseCueSettingsList(String str, Builder builder) {
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                } else if (Constants.KEY_RSS_POSITION.equals(group)) {
    ...
    private static int parsePositionAnchor(java.lang.String r5) {
        ...
        L_0x0035:
            ...
            com.google.android.exoplayer2.util.Log.m1396w(r0, r5)
    ...
    private static int parseTextAlignment(java.lang.String r6) {
        ...
        L_0x004a:
            ...
            java.lang.String r0 = "WebvttCueParser"
            com.google.android.exoplayer2.util.Log.m1396w(r0, r6)
            return r5
        L_0x006d:
            return r1
        L_0x006e:
    ...
    private static void applyEntity(java.lang.String r5, android.text.SpannableStringBuilder r6) {
        ...
        L_0x0043:
            ...
            com.google.android.exoplayer2.util.Log.m1396w(r6, r5)
            goto L_0x007e
        L_0x0067:
            r5 = 38
            r6.append(r5)
    ...
    private static void applyStyleToText(SpannableStringBuilder spannableStringBuilder, WebvttCssStyle webvttCssStyle, int i, int i2) {
        if (webvttCssStyle != null) {
            ...
            Alignment textAlign = webvttCssStyle.getTextAlign();
            if (textAlign != null) {
                spannableStringBuilder.setSpan(new Standard(textAlign), i, i2, 33);
            }

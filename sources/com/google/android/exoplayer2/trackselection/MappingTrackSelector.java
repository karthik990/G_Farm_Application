...
public abstract class MappingTrackSelector extends TrackSelector {
    ...
    public static final class MappedTrackInfo {
        ...
        public int getRendererSupport(int i) {
            ...
            while (i2 < length2) {
                ...
                for (int formatSupport : iArr[i2]) {
                    int formatSupport2 = CC.getFormatSupport(formatSupport);
                    int i5 = 2;
        ...
        public int getTrackSupport(int i, int i2, int i3) {
            return CC.getFormatSupport(this.rendererFormatSupports[i][i2][i3]);
        }
        ...
        public int getAdaptiveSupport(int i, int i2, int[] iArr) {
            ...
            while (i3 < iArr.length) {
                ...
                i5 = Math.min(i5, CC.getAdaptiveSupport(this.rendererFormatSupports[i][i2][i3]));
                i3++;
                i4 = i6;
            }
    ...
    private static int findRenderer(RendererCapabilities[] rendererCapabilitiesArr, TrackGroup trackGroup) throws ExoPlaybackException {
        ...
        while (i < rendererCapabilitiesArr.length) {
            ...
            for (int i5 = 0; i5 < trackGroup.length; i5++) {
                int formatSupport = CC.getFormatSupport(rendererCapabilities.supportsFormat(trackGroup.getFormat(i5)));
                if (formatSupport > i3) {
                    if (formatSupport == 4) {
                        return i;
                    }

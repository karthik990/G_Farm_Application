...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public static class Factory implements com.google.android.exoplayer2.trackselection.TrackSelection.Factory {
        ...
        public Factory(BandwidthMeter bandwidthMeter2) {
            this(bandwidthMeter2, 10000, 25000, 25000, 0.7f, 0.75f, AdaptiveTrackSelection.DEFAULT_MIN_TIME_BETWEEN_BUFFER_REEVALUTATION_MS, Clock.DEFAULT);
        }
        ...
        public final TrackSelection[] createTrackSelections(Definition[] definitionArr, BandwidthMeter bandwidthMeter2) {
            ...
            for (int i4 = 0; i4 < definitionArr.length; i4++) {
                Definition definition2 = definitionArr[i4];
        ...
        public AdaptiveTrackSelection createAdaptiveTrackSelection(TrackGroup trackGroup, BandwidthMeter bandwidthMeter2, int[] iArr, int i) {
            ...
            int[] iArr2 = iArr;
            AdaptiveTrackSelection adaptiveTrackSelection = new AdaptiveTrackSelection(trackGroup2, iArr2, new DefaultBandwidthProvider(bandwidthMeter2, this.bandwidthFraction, (long) i), (long) this.minDurationForQualityIncreaseMs, (long) this.maxDurationForQualityDecreaseMs, (long) this.minDurationToRetainAfterDiscardMs, this.bufferedFractionToLiveEdgeForQualityIncrease, this.minTimeBetweenBufferReevaluationMs, this.clock);
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter) {
        this(trackGroup, iArr, bandwidthMeter, 0, WorkRequest.MIN_BACKOFF_MILLIS, 25000, 25000, 0.7f, 0.75f, DEFAULT_MIN_TIME_BETWEEN_BUFFER_REEVALUTATION_MS, Clock.DEFAULT);
    }
    ...
    private AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthProvider bandwidthProvider2, long j, long j2, long j3, float f, long j4, Clock clock2) {
        ...
        this.reason = 0;
        this.lastBufferEvaluationMs = C1996C.TIME_UNSET;
    }
    ...
    public boolean shouldEvaluateQueueSize(long j) {
        ...
        return j2 == C1996C.TIME_UNSET || j - j2 >= this.minTimeBetweenBufferReevaluationMs;
    }
    ...
    private long minDurationForQualityIncreaseUs(long j) {
        return (j > C1996C.TIME_UNSET ? 1 : (j == C1996C.TIME_UNSET ? 0 : -1)) != 0 && (j > this.minDurationForQualityIncreaseUs ? 1 : (j == this.minDurationForQualityIncreaseUs ? 0 : -1)) <= 0 ? (long) (((float) j) * this.bufferedFractionToLiveEdgeForQualityIncrease) : this.minDurationForQualityIncreaseUs;
    }

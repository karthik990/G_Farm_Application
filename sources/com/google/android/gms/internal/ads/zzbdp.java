...
class zzbdp<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private final int zza(K k) {
        ...
        if (size >= 0) {
            int compareTo = k.compareTo((Comparable) ((zzbdw) this.zzdyk.get(size)).getKey());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = k.compareTo((Comparable) ((zzbdw) this.zzdyk.get(i2)).getKey());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza((K) comparable) >= 0 || this.zzdyl.containsKey(comparable);
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zzdyj;
        if (size == i2) {
            zzbdw zzbdw = (zzbdw) this.zzdyk.remove(i2 - 1);
    ...
    public final Set<Entry<K, V>> zzafu() {
        if (this.zzdyo == null) {

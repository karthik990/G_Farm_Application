...
public final class zzjj extends AbstractSafeParcelable {
    ...
    public final zzjj zzhv() {
        ...
        Bundle bundle = this.zzaqg.getBundle(str);
        if (bundle == null) {
            bundle = this.extras;
            this.zzaqg.putBundle(str, bundle);
        }
        zzjj zzjj = new zzjj(this.versionCode, this.zzapw, bundle, this.zzapx, this.zzapy, this.zzapz, this.zzaqa, this.zzaqb, this.zzaqc, this.zzaqd, this.zzaqe, this.zzaqf, this.zzaqg, this.zzaqh, this.zzaqi, this.zzaqj, this.zzaqk, this.zzaql);
        return zzjj;
    }
}

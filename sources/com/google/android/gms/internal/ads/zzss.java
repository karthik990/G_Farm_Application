...
public final class zzss {
    ...
    public final zzal zzav(String str) {
        zzal zzal = new zzal(this.mContext, new zzjn(), str, this.zzwh, this.zzyf, this.zzwc);
        return zzal;
    }

    public final zzal zzaw(String str) {
        zzal zzal = new zzal(this.mContext.getApplicationContext(), new zzjn(), str, this.zzwh, this.zzyf, this.zzwc);
        return zzal;
    }

...
public final class zzalt {
    ...
    public final <T> zzanz<T> zza(String str, zzalz<T> zzalz) {
        ...
        return zzano.zza(zzano.zza((zzanz<A>) zzaoj, (zzank<A, B>) new zzalw<A,B>(this, zzalz), (Executor) zzaki.zzcrj), Throwable.class, (zzanj<? super X, ? extends V>) new zzalv<Object,Object>(this, zzalz), zzaoe.zzcvz);
    }

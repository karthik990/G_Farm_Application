...
public final class zzagr extends zzd implements zzahu {
    ...
    public zzagr(Context context, zzw zzw, zzjn zzjn, zzxn zzxn, zzang zzang) {
        ...
        zzago zzago = new zzago(this.zzvw, this.zzwh, this, this, this);
        this.zzclg = zzago;
    }

    private static zzaji zzc(zzaji zzaji) {
        zzaji zzaji2 = zzaji;
        zzakb.m1419v("Creating mediation ad response for non-mediated rewarded ad.");
        try {
            ...
            zzwy zzwy = new zzwy(Arrays.asList(new zzwx[]{zzwx}), ((Long) zzkb.zzik().zzd(zznk.zzbao)).longValue(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), false, "", -1, 0, 1, null, 0, -1, -1, false);
            zzaji zzaji3 = new zzaji(zzaji2.zzcgs, zzaji2.zzcos, zzwy, zzaji2.zzacv, zzaji2.errorCode, zzaji2.zzcoh, zzaji2.zzcoi, zzaji2.zzcob, zzaji2.zzcoq, null);
            return zzaji3;
        } catch (JSONException e) {
            zzakb.zzb("Unable to generate ad state for non-mediated rewarded video.", e);
            zzaji zzaji4 = new zzaji(zzaji2.zzcgs, zzaji2.zzcos, null, zzaji2.zzacv, 0, zzaji2.zzcoh, zzaji2.zzcoi, zzaji2.zzcob, zzaji2.zzcoq, null);
            return zzaji4;
        }
    }

            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        zzakb.m1419v("Could not close Clearcut output stream.");
                    }
                } catch (IOException unused2) {
                    zzakb.m1419v("Could not write Clearcut to file.");
                    try {
                        fileOutputStream.close();
                ...
                zzakb.m1419v("Could not find file for Clearcut");
            } catch (Throwable th) {
                try {
                    fileOutputStream.close();
        ...
        while (true) {
            ...
            while (i < length) {
                try {
                    ...
                    zzakb.m1419v("Experiment ID is not a number");
                }
                i++;
            }
        }

...
public enum zzbbj {
    ...
    private zzbbj(int i, zzbbl zzbbl, zzbbw zzbbw) {
        ...
        this.zzdtc = zzbbl;
        this.zzdtb = zzbbw;
        int i2 = zzbbk.zzdti[zzbbl.ordinal()];
        this.zzdtd = (i2 == 1 || i2 == 2) ? zzbbw.zzadt() : null;
        boolean z = false;
        if (zzbbl == zzbbl.SCALAR) {
            int i3 = zzbbk.zzdtj[zzbbw.ordinal()];
            if (!(i3 == 1 || i3 == 2 || i3 == 3)) {
                z = true;
            }
        }

...
public final class zzarl extends zzlp {
    ...
    public final void zza(float f, int i, boolean z, float f2) {
        ...
        zzarn zzarn = new zzarn(this, i2, i, z2, z);
        executor.execute(zzarn);
    }
    ...
    public final void zzb(zzmu zzmu) {
        ...
        zzf("initialState", CollectionUtils.mapOf("muteStart", zzmu.zzato ? IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE : "0", "customControlsRequested", zzmu.zzatp ? IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE : "0", "clickToExpandRequested", zzmu.zzatq ? IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE : "0"));
    }

...
public final class zzagb {
    ...
    private final void zzp(Context context) {
        ...
        if (registerReceiver != null) {
            ...
            this.zzckc = (double) (((float) registerReceiver.getIntExtra(Param.LEVEL, -1)) / ((float) registerReceiver.getIntExtra(SlidingMenu.SCALED_MENU, -1)));

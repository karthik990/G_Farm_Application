                    ...
                    synchronized (obj2) {
                        try {
                            if (this.zzbuf) {
                                ...
                                obj = obj2;
                                try {
                                    zzxb zzxb2 = new zzxb(context, str2, zzxn, zzwy2, zzwx, zzjj3, zzjn, zzang, z, z2, zzpl, this.zzbuc.zzads, this.zzbuc.zzcdk, this.zzbuc.zzcef, this.zzbto);
                                    this.zzbum = zzxb;
                                    zzxe zza = this.zzbum.zza(this.mStartTime, this.zzbud);
                                    this.zzbui.add(zza);
                                    if (zza.zzbtv == 0) {
                                        zzakb.zzck("Adapter succeeded.");
                                        this.zzvr.zze("mediation_network_succeed", str2);

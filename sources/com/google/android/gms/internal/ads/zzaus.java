...
class zzaus implements zzaug<zzatz> {
    ...
    zzaus() throws GeneralSecurityException {
        zzauo.zza("type.googleapis.com/google.crypto.tink.AesCtrKey", (zzaug<P>) new zzaut<P>());
    }
    ...
    public final zzbcu zzb(zzbcu zzbcu) throws GeneralSecurityException {
        if (zzbcu instanceof zzavq) {
            ...
            zzavs zzavs = (zzavs) zzauo.zza("type.googleapis.com/google.crypto.tink.AesCtrKey", (zzbcu) zzavq.zzwr());
            return zzavo.zzwp().zzb(zzavs).zzb((zzaxc) zzauo.zza("type.googleapis.com/google.crypto.tink.HmacKey", (zzbcu) zzavq.zzws())).zzal(0).zzadi();
        }

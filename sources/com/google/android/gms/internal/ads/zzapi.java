...
public final class zzapi extends FrameLayout implements zzapf {
    ...
    public zzapi(Context context, zzapw zzapw, int i, boolean z, zznx zznx, zzapv zzapv) {
        ...
        this.zzcxr = zzapw.zzbi().zzwz.zza(context, zzapw2, i, z, zznx2, zzapv);
        zzapg zzapg = this.zzcxr;
        if (zzapg != null) {
            this.zzcxn.addView(zzapg, new LayoutParams(-1, -1, 17));
        ...
        if (zznx3 != null) {
            zznx3.zze("spinner_used", this.zzcxv ? IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE : "0");
        }
    ...
    public final void zzsv() {
        ...
        if (zzapg != null && this.zzcxx == 0) {
            zza("canplaythrough", "duration", String.valueOf(((float) zzapg.getDuration()) / 1000.0f), "videoWidth", String.valueOf(this.zzcxr.getVideoWidth()), "videoHeight", String.valueOf(this.zzcxr.getVideoHeight()));
        }
    }

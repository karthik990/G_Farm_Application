    ...
    public final zzaue zza(zzbah zzbah) throws GeneralSecurityException {
        try {
            ...
            if (zzx instanceof zzaws) {
                ...
                zzayo zzayo = new zzayo((ECPrivateKey) ((KeyFactory) zzayy.zzdof.zzek("EC")).generatePrivate(new ECPrivateKeySpec(new BigInteger(1, byteArray), zzayt.zza(zza))), zzxu.zzyj().toByteArray(), zzavh.zza(zzxu.zzyi()), zzavh.zza(zzxs.zzxw()), new zzavj(zzxs.zzxv().zzxp()));
                return zzayo;
            }

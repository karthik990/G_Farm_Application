...
public final class zzjm {
    ...
    public static zzjj zza(Context context, zzlw zzlw) {
        ...
        zzjj zzjj = new zzjj(7, time, networkExtrasBundle, gender, list, isTestDevice, zzit, manualImpressionsEnabled, publisherProvidedId, zzmq, location, contentUrl, zzlw.zzis(), zzlw.getCustomTargeting(), Collections.unmodifiableList(new ArrayList(zzlw.zziu())), zzlw.zzip(), str, zzlw.isDesignedForFamilies());
        return zzjj;
    }
}

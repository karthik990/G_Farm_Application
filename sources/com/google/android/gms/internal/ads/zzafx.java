...
public final class zzafx {
    ...
    public final zzaej zza(long j, boolean z) {
        ...
        String str18 = str;
        long j4 = j;
        zzaej zzaej = new zzaej(zzaef, str2, str3, list, list2, j2, z2, -1, list3, j3, i2, str18, j4, str17, str16, z23, z24, z20, z21, false, str15, z22, z8, zzaig, list4, list8, z19, zzael2, z17, str14, list7, z18, str12, zzaiq2, str13, z15, z16, z14, i, this.zzcjb, this.zzcid, this.zzcjc, this.zzcae);
        return zzaej;
    }
    ...
    public final void zzl(Map<String, List<String>> map) {
        ...
        this.zzcij = "native".equals(zza(map, str2));
        ...
        this.zzbtn = "native_express".equals(zza(map, str2));

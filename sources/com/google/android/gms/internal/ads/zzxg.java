    ...
    public static void zza(Context context, String str, zzajh zzajh, String str2, boolean z, List<String> list) {
        if (list != null && !list.isEmpty()) {
            ...
            for (String zza : list) {
                ...
                String zza2 = zza(zza(zza(zza(zza(zza(zza(zza, "@gw_adlocid@", str2), "@gw_adnetrefresh@", str3), "@gw_qdata@", zzajh.zzcod.zzbst), "@gw_sdkver@", str), "@gw_sessid@", zzkb.zzih()), str4, zzajh.zzccy), str5, zzajh.zzcoe);
                if (zzajh.zzbtw != null) {
    ...
    public static void zza(Context context, String str, List<String> list, String str2, zzaig zzaig) {
        if (list != null && !list.isEmpty()) {
            ...
            for (String zza : list) {
                ...
                String zza2 = zza(zza(zza, "@gw_rwd_userid@", Uri.encode(str2)), str3, Long.toString(currentTimeMillis));
                if (zzaig != null) {
                    String str4 = "@gw_rwd_amt@";
                    zza2 = zza(zza(zza2, "@gw_rwd_itm@", Uri.encode(zzaig.type)), str4, Integer.toString(zzaig.zzcmk));
                }
                zzbv.zzek();

...
public class zzpd implements zzoz {
        ...
        synchronized (map) {
            for (Entry entry : map.entrySet()) {
                ...
                if (view2 != null) {
                    ...
                    try {
                        jSONObject4.put(SettingsJsonConstants.ICON_WIDTH_KEY, zzv(view2.getMeasuredWidth()));
                        jSONObject4.put(SettingsJsonConstants.ICON_HEIGHT_KEY, zzv(view2.getMeasuredHeight()));
    ...
    private final void zza(View view, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, JSONObject jSONObject6) {
        ...
        try {
            ...
            jSONObject8.put(str2, this.zzbiw.zzr(this.zzbjb.getCustomTemplateId()) != null);
    ...
    private final JSONObject zzb(Rect rect) throws JSONException {
        ...
        jSONObject.put(SettingsJsonConstants.ICON_WIDTH_KEY, zzv(rect.right - rect.left));
        jSONObject.put(SettingsJsonConstants.ICON_HEIGHT_KEY, zzv(rect.bottom - rect.top));
    ...
    private final JSONObject zzo(View view) {
        ...
        String str3 = "y";
        String str4 = "x";
        String str5 = SettingsJsonConstants.ICON_HEIGHT_KEY;
        String str6 = SettingsJsonConstants.ICON_WIDTH_KEY;
        JSONObject jSONObject2 = new JSONObject();
        if (view == null) {
            return jSONObject2;
        }
        try {
            int[] zzn = zzn(view);
            JSONObject jSONObject3 = new JSONObject();
            jSONObject3.put(str6, zzv(view.getMeasuredWidth()));
            jSONObject3.put(str5, zzv(view.getMeasuredHeight()));
            jSONObject3.put(str4, zzv(zzn[0]));
            jSONObject3.put(str3, zzv(zzn[1]));
            ...
            if (view.getGlobalVisibleRect(rect)) {
                ...
                jSONObject.put(str4, zzv(zzn[0]));
                jSONObject.put(str3, zzv(zzn[1]));
    ...
    private final JSONObject zzq(View view) {
        ...
        try {
            zzbv.zzek();
            jSONObject.put(str, zzakk.zzw(view));
            zzbv.zzek();
    ...
    public final void performClick(Bundle bundle) {
        if (bundle == null) {
            ...
            zzakb.m1272e("The ad slot cannot handle external click events. You must be whitelisted to be able to report your click events.");
        } else {
    ...
    public final boolean recordImpression(Bundle bundle) {
        if (!zzaq("impression_reporting")) {
            zzakb.m1272e("The ad slot cannot handle external impression events. You must be whitelisted to whitelisted to be able to report your impression events.");
            return false;
        }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        if (bundle == null) {
            ...
            zzakb.m1272e("The ad slot cannot handle external touch events. You must be whitelisted to be able to report your touch events.");
        } else {
    ...
    public void zza(View view, Map<String, WeakReference<View>> map, Bundle bundle, View view2) {
        ...
        if ("6".equals(this.zzbjb.zzkb())) {
            ...
            if (ExifInterface.GPS_MEASUREMENT_2D.equals(this.zzbjb.zzkb())) {
                ...
                if (IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(this.zzbjb.zzkb())) {

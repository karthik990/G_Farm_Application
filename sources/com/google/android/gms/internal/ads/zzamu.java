...
public final class zzamu {
    ...
    public static String zzbc(Context context) {
        ...
        String string = contentResolver == null ? null : Secure.getString(contentResolver, C5985b.f4233f);
        if (string == null || zzsg()) {
            string = "emulator";
        }
        return zzde(string);
    ...
    public static String zzbd(Context context) {
        ...
        return Secure.getString(contentResolver, C5985b.f4233f);
    }
    ...
    public static boolean zzdf(String str) {
        ...
        try {
            ...
            zzane.zza(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2), e);
            return false;
        }
    }

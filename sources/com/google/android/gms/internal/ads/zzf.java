...
final class zzf implements zzt {
    ...
    public final synchronized boolean zzb(com.google.android.gms.internal.ads.zzr<?> r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            java.lang.String r0 = r6.getUrl()     // Catch:{ all -> 0x0052 }
        ...
        L_0x001e:
            ...
            com.google.android.gms.internal.ads.zzaf.m1416d(r6, r1)     // Catch:{ all -> 0x0052 }
        L_0x0038:
            monitor-exit(r5)
            return r2
        L_0x003a:
    ...
    public final synchronized void zza(zzr<?> zzr) {
        ...
        if (list != null && !list.isEmpty()) {
            if (zzaf.DEBUG) {
                zzaf.m1418v("%d waiting requests for cacheKey=%s; resend to network", Integer.valueOf(list.size()), url);
            }
            ...
            try {
                ...
                zzaf.m1417e("Couldn't add request to queue. %s", e.toString());
    ...
    public final void zza(zzr<?> zzr, zzx<?> zzx) {
        ...
        if (list != null) {
            if (zzaf.DEBUG) {
                zzaf.m1418v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(list.size()), url);
            }
            for (zzr zzb : list) {

...
public class zzjr {
    ...
    public final zzqa zza(Context context, FrameLayout frameLayout, FrameLayout frameLayout2) {
        return (zzqa) zza(context, false, (zza<T>) new zzjx<T>(this, frameLayout, frameLayout2, context));
    }

    public final zzqf zza(View view, HashMap<String, View> hashMap, HashMap<String, View> hashMap2) {
        return (zzqf) zza(view.getContext(), false, (zza<T>) new zzjy<T>(this, view, hashMap, hashMap2));
    }
    ...
    public final zzaap zzb(Activity activity) {
        ...
        if (!intent.hasExtra(str)) {
            zzane.m1272e("useClientJar flag not found in activity intent extras.");
        } else {
            z = intent.getBooleanExtra(str, false);
        }
        return (zzaap) zza((Context) activity, z, (zza<T>) new zzka<T>(this, activity));
    }

    public final zzkn zzb(Context context, String str, zzxn zzxn) {
        return (zzkn) zza(context, false, (zza<T>) new zzjv<T>(this, context, str, zzxn));
    }
}

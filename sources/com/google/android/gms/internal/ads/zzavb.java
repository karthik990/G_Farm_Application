    ...
    public final zzauf zza(zzbah zzbah) throws GeneralSecurityException {
        try {
            ...
            if (zzab instanceof zzawu) {
                ...
                zzayp zzayp = new zzayp(zzayt.zza(zzavh.zza(zzxu.zzyh()), zzawu.zzyc().toByteArray(), zzawu.zzyd().toByteArray()), zzxu.zzyj().toByteArray(), zzavh.zza(zzxu.zzyi()), zzavh.zza(zzxs.zzxw()), new zzavj(zzxs.zzxv().zzxp()));
                return zzayp;
            }

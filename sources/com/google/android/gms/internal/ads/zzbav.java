...
public abstract class zzbav extends zzbag {
    ...
    static class zza extends zzbav {
        ...
        public final void zzca(int i) throws IOException {
            if (!zzbav.zzdqm || zzack() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    this.position = i4 + 1;
                    zzbek.zza(bArr3, (long) i4, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                }
        ...
        public final void zzcc(int r5) throws java.io.IOException {
            /*
                r4 = this;
            ...
            L_0x0032:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbav.zza.zzcc(int):void");
        }
        ...
        public final void zzm(long j) throws IOException {
            if (!zzbav.zzdqm || zzack() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zzbek.zza(bArr3, (long) i3, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;

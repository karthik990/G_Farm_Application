...
public final class zzafa extends zzajx {
    ...
    public zzafa(Context context, zzaeg zzaeg, zzadj zzadj, zzhx zzhx) {
        ...
        synchronized (sLock) {
            if (!zzcgd) {
                ...
                zzcgh = new zzafi();
                zzvf zzvf = new zzvf(this.mContext.getApplicationContext(), this.zzccg.zzacr, (String) zzkb.zzik().zzd(zznk.zzaub), new zzafh(), new zzafg());
                zzcge = zzvf;
                zzcgd = true;
            }
        }
    ...
    private final zzaej zzc(zzaef zzaef) {
        ...
        try {
            ...
            if (zza2.errorCode != -3 && TextUtils.isEmpty(zza2.zzceo)) {
                zza2 = new zzaej(3);
            }
            return zza2;
    ...
    public final void zzdn() {
        ...
        long elapsedRealtime = zzbv.zzer().elapsedRealtime();
        zzaef zzaef2 = zzaef;
        zzaji zzaji = new zzaji(zzaef2, zzc, null, null, zzc.errorCode, elapsedRealtime, zzc.zzceu, null, this.zzcci);

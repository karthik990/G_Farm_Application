...
import com.google.android.gms.internal.firebase_remote_config.zzbd.zza;
...
public abstract class zzbb {
    private static WeakHashMap<Class<?>, Field> zzde = new WeakHashMap<>();
    private static final Lock zzdf = new ReentrantLock();
    ...
    public abstract zzax zzba();

    public abstract zzbf zzbb() throws IOException;

    public abstract zzbf zzbc();

    public abstract String zzbd() throws IOException;

    public abstract zzbb zzbe() throws IOException;

    public abstract byte zzbf() throws IOException;

    public abstract short zzbg() throws IOException;

    public abstract float zzbh() throws IOException;

    public abstract long zzbi() throws IOException;

    public abstract double zzbj() throws IOException;

    public abstract BigInteger zzbk() throws IOException;

    public abstract BigDecimal zzbl() throws IOException;

    public final <T> T zza(Class<T> cls, zzav zzav) throws IOException {
        try {
    ...
    private final zzbf zzbm() throws IOException {
        zzbf zzbc = zzbc();
        if (zzbc == null) {
            zzbc = zzbb();
        }
    ...
    private final zzbf zzbn() throws IOException {
        zzbf zzbm = zzbm();
        int i = zzbc.zzdg[zzbm.ordinal()];
        boolean z = true;
        if (i == 1) {
            zzbf zzbb = zzbb();
            if (!(zzbb == zzbf.FIELD_NAME || zzbb == zzbf.END_OBJECT)) {
                z = false;
            }
            if (z) {
                return zzbb;
            }
            throw new IllegalArgumentException(String.valueOf(zzbb));
        } else if (i != 2) {
            return zzbm;
        } else {
            return zzbb();
    ...
    public final Object zza(Type type, boolean z, zzav zzav) throws IOException {
        try {
    ...
    private final void zza(Field field, Map<String, Object> map, Type type, ArrayList<Type> arrayList, zzav zzav) throws IOException {
        zzbf zzbn = zzbn();
        while (zzbn == zzbf.FIELD_NAME) {
            String text = getText();
            zzbb();
            if (zzav == null) {
                map.put(text, zza(field, type, arrayList, map, zzav, true));
                zzbn = zzbb();
            } else {
    ...
    private final java.lang.Object zza(java.lang.reflect.Field r20, java.lang.reflect.Type r21, java.util.ArrayList<java.lang.reflect.Type> r22, java.lang.Object r23, com.google.android.gms.internal.firebase_remote_config.zzav r24, boolean r25) throws java.io.IOException {
        /*
            r19 = this;
            r8 = r20
            r0 = r22
            r1 = r21
            java.lang.reflect.Type r9 = com.google.android.gms.internal.firebase_remote_config.zzbs.zza(r0, r1)
        ...
        L_0x0014:
            ...
            java.lang.Class r1 = com.google.android.gms.internal.firebase_remote_config.zzcn.zza(r1)
        L_0x001f:
            ...
            return r10
        L_0x0027:
            com.google.android.gms.internal.firebase_remote_config.zzbf r2 = r19.zzbc()
            int[] r3 = com.google.android.gms.internal.firebase_remote_config.zzbc.zzdg     // Catch:{ IllegalArgumentException -> 0x045a }
            com.google.android.gms.internal.firebase_remote_config.zzbf r4 = r19.zzbc()     // Catch:{ IllegalArgumentException -> 0x045a }
        ...
        L_0x0049:
            ...
            boolean r2 = com.google.android.gms.internal.firebase_remote_config.zzcn.zza(r1, r2)     // Catch:{ IllegalArgumentException -> 0x045a }
            if (r2 == 0) goto L_0x006c
            java.util.Collection r0 = com.google.android.gms.internal.firebase_remote_config.zzbs.zzb(r9)     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Class r0 = r0.getClass()     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Object r0 = com.google.android.gms.internal.firebase_remote_config.zzbs.zzd(r0)     // Catch:{ IllegalArgumentException -> 0x045a }
            return r0
        L_0x006c:
            java.lang.Class<java.util.Map> r2 = java.util.Map.class
            boolean r2 = com.google.android.gms.internal.firebase_remote_config.zzcn.zza(r1, r2)     // Catch:{ IllegalArgumentException -> 0x045a }
            if (r2 == 0) goto L_0x0081
            java.util.Map r0 = com.google.android.gms.internal.firebase_remote_config.zzbs.zze(r1)     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Class r0 = r0.getClass()     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Object r0 = com.google.android.gms.internal.firebase_remote_config.zzbs.zzd(r0)     // Catch:{ IllegalArgumentException -> 0x045a }
            return r0
        L_0x0081:
            java.lang.Class r0 = com.google.android.gms.internal.firebase_remote_config.zzcn.zzb(r0, r9)     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Object r0 = com.google.android.gms.internal.firebase_remote_config.zzbs.zzd(r0)     // Catch:{ IllegalArgumentException -> 0x045a }
            return r0
        L_0x008a:
            java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException     // Catch:{ IllegalArgumentException -> 0x045a }
        ...
        L_0x00e6:
            java.lang.String r0 = r19.getText()     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Object r0 = com.google.android.gms.internal.firebase_remote_config.zzbs.zza(r9, r0)     // Catch:{ IllegalArgumentException -> 0x045a }
            return r0
        L_0x00ef:
        ...
        L_0x010a:
            ...
            java.math.BigInteger r0 = r19.zzbk()     // Catch:{ IllegalArgumentException -> 0x045a }
            return r0
        L_0x0113:
        ...
        L_0x014b:
            ...
            throw r0     // Catch:{ IllegalArgumentException -> 0x045a }
        L_0x0170:
            byte r0 = r19.zzbf()     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Byte r0 = java.lang.Byte.valueOf(r0)     // Catch:{ IllegalArgumentException -> 0x045a }
            return r0
        L_0x0179:
            short r0 = r19.zzbg()     // Catch:{ IllegalArgumentException -> 0x045a }
        ...
        L_0x01c5:
            ...
            com.google.android.gms.internal.firebase_remote_config.zzbf r0 = com.google.android.gms.internal.firebase_remote_config.zzbf.VALUE_TRUE     // Catch:{ IllegalArgumentException -> 0x045a }
        ...
        L_0x01d7:
            java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.String r1 = com.google.android.gms.internal.firebase_remote_config.zzdz.zza(r1, r3)     // Catch:{ IllegalArgumentException -> 0x045a }
            r0.<init>(r1)     // Catch:{ IllegalArgumentException -> 0x045a }
            throw r0     // Catch:{ IllegalArgumentException -> 0x045a }
        L_0x01e1:
            boolean r13 = com.google.android.gms.internal.firebase_remote_config.zzcn.zzc(r9)     // Catch:{ IllegalArgumentException -> 0x045a }
        ...
        L_0x0204:
            ...
            throw r0     // Catch:{ IllegalArgumentException -> 0x045a }
        L_0x020a:
            java.util.Collection r11 = com.google.android.gms.internal.firebase_remote_config.zzbs.zzb(r9)     // Catch:{ IllegalArgumentException -> 0x045a }
            if (r13 == 0) goto L_0x0215
            java.lang.reflect.Type r10 = com.google.android.gms.internal.firebase_remote_config.zzcn.zzd(r9)     // Catch:{ IllegalArgumentException -> 0x045a }
            goto L_0x0223
        L_0x0215:
            ...
            if (r1 == 0) goto L_0x0223
            java.lang.reflect.Type r10 = com.google.android.gms.internal.firebase_remote_config.zzcn.zze(r9)     // Catch:{ IllegalArgumentException -> 0x045a }
        L_0x0223:
            java.lang.reflect.Type r9 = com.google.android.gms.internal.firebase_remote_config.zzbs.zza(r0, r10)     // Catch:{ IllegalArgumentException -> 0x045a }
            com.google.android.gms.internal.firebase_remote_config.zzbf r1 = r19.zzbn()     // Catch:{ IllegalArgumentException -> 0x045a }
        L_0x022b:
            com.google.android.gms.internal.firebase_remote_config.zzbf r2 = com.google.android.gms.internal.firebase_remote_config.zzbf.END_ARRAY     // Catch:{ IllegalArgumentException -> 0x045a }
            ...
            com.google.android.gms.internal.firebase_remote_config.zzbf r1 = r19.zzbb()     // Catch:{ IllegalArgumentException -> 0x045a }
            goto L_0x022b
        L_0x0246:
            if (r13 == 0) goto L_0x0251
            java.lang.Class r0 = com.google.android.gms.internal.firebase_remote_config.zzcn.zzb(r0, r9)     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Object r0 = com.google.android.gms.internal.firebase_remote_config.zzcn.zza(r11, r0)     // Catch:{ IllegalArgumentException -> 0x045a }
            return r0
        L_0x0251:
            return r11
        L_0x0252:
            java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.String r1 = com.google.android.gms.internal.firebase_remote_config.zzdz.zza(r3, r4)     // Catch:{ IllegalArgumentException -> 0x045a }
            r0.<init>(r1)     // Catch:{ IllegalArgumentException -> 0x045a }
            throw r0     // Catch:{ IllegalArgumentException -> 0x045a }
        L_0x025c:
            boolean r2 = com.google.android.gms.internal.firebase_remote_config.zzcn.zzc(r9)     // Catch:{ IllegalArgumentException -> 0x045a }
        ...
        L_0x028e:
            ...
            com.google.android.gms.internal.firebase_remote_config.zzaw r3 = new com.google.android.gms.internal.firebase_remote_config.zzaw     // Catch:{ IllegalArgumentException -> 0x045a }
        ...
        L_0x0296:
            ...
            goto L_0x02a0
        L_0x029b:
            java.lang.Object r3 = com.google.android.gms.internal.firebase_remote_config.zzcn.zzf(r1)     // Catch:{ IllegalArgumentException -> 0x045a }
            goto L_0x02a4
        L_0x02a0:
            java.util.Map r3 = com.google.android.gms.internal.firebase_remote_config.zzbs.zze(r1)     // Catch:{ IllegalArgumentException -> 0x045a }
        L_0x02a4:
            r14 = r3
        ...
        L_0x02ae:
            ...
            java.lang.Class<com.google.android.gms.internal.firebase_remote_config.zzbz> r2 = com.google.android.gms.internal.firebase_remote_config.zzbz.class
            boolean r2 = r2.isAssignableFrom(r1)     // Catch:{ IllegalArgumentException -> 0x045a }
            if (r2 != 0) goto L_0x02d8
            java.lang.Class<java.util.Map> r2 = java.util.Map.class
            boolean r1 = r2.isAssignableFrom(r1)     // Catch:{ IllegalArgumentException -> 0x045a }
            if (r1 == 0) goto L_0x02c6
            java.lang.reflect.Type r1 = com.google.android.gms.internal.firebase_remote_config.zzcn.zzf(r9)     // Catch:{ IllegalArgumentException -> 0x045a }
            r4 = r1
            goto L_0x02c7
        L_0x02c6:
            r4 = r10
        L_0x02c7:
            ...
            return r14
        L_0x02d8:
            boolean r1 = r14 instanceof com.google.android.gms.internal.firebase_remote_config.zzaw     // Catch:{ IllegalArgumentException -> 0x045a }
            if (r1 == 0) goto L_0x02e6
            r1 = r14
            com.google.android.gms.internal.firebase_remote_config.zzaw r1 = (com.google.android.gms.internal.firebase_remote_config.zzaw) r1     // Catch:{ IllegalArgumentException -> 0x045a }
            com.google.android.gms.internal.firebase_remote_config.zzax r2 = r19.zzba()     // Catch:{ IllegalArgumentException -> 0x045a }
            r1.zza(r2)     // Catch:{ IllegalArgumentException -> 0x045a }
        L_0x02e6:
            com.google.android.gms.internal.firebase_remote_config.zzbf r1 = r19.zzbn()     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Class r2 = r14.getClass()     // Catch:{ IllegalArgumentException -> 0x045a }
            com.google.android.gms.internal.firebase_remote_config.zzbq r7 = com.google.android.gms.internal.firebase_remote_config.zzbq.zzc(r2)     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.Class<com.google.android.gms.internal.firebase_remote_config.zzbz> r3 = com.google.android.gms.internal.firebase_remote_config.zzbz.class
            ...
            java.util.Map r3 = (java.util.Map) r3     // Catch:{ IllegalArgumentException -> 0x045a }
            r4 = 0
            java.lang.reflect.Type r5 = com.google.android.gms.internal.firebase_remote_config.zzcn.zzf(r2)     // Catch:{ IllegalArgumentException -> 0x045a }
            r1 = r19
            r2 = r4
            r4 = r5
            r5 = r22
            ...
            goto L_0x03a0
        L_0x0317:
            com.google.android.gms.internal.firebase_remote_config.zzbf r2 = com.google.android.gms.internal.firebase_remote_config.zzbf.FIELD_NAME     // Catch:{ IllegalArgumentException -> 0x045a }
            if (r1 != r2) goto L_0x03a0
            java.lang.String r6 = r19.getText()     // Catch:{ IllegalArgumentException -> 0x045a }
            r19.zzbb()     // Catch:{ IllegalArgumentException -> 0x045a }
            if (r24 != 0) goto L_0x039a
            com.google.android.gms.internal.firebase_remote_config.zzby r5 = r7.zzae(r6)     // Catch:{ IllegalArgumentException -> 0x045a }
        ...
        L_0x036c:
            ...
            r10 = r14
            com.google.android.gms.internal.firebase_remote_config.zzbz r10 = (com.google.android.gms.internal.firebase_remote_config.zzbz) r10     // Catch:{ IllegalArgumentException -> 0x045a }
            r2 = 0
            r3 = 0
            r7 = 1
            r1 = r19
        ...
        L_0x0386:
            ...
            r19.zzbe()     // Catch:{ IllegalArgumentException -> 0x045a }
        L_0x038b:
            com.google.android.gms.internal.firebase_remote_config.zzbf r1 = r19.zzbb()     // Catch:{ IllegalArgumentException -> 0x045a }
            r7 = r18
            r10 = 0
        ...
        L_0x03b8:
            ...
            java.lang.Class<com.google.android.gms.internal.firebase_remote_config.zzbd> r2 = com.google.android.gms.internal.firebase_remote_config.zzbd.class
            java.lang.annotation.Annotation r2 = r13.getAnnotation(r2)     // Catch:{ IllegalArgumentException -> 0x045a }
            com.google.android.gms.internal.firebase_remote_config.zzbd r2 = (com.google.android.gms.internal.firebase_remote_config.zzbd) r2     // Catch:{ IllegalArgumentException -> 0x045a }
            com.google.android.gms.internal.firebase_remote_config.zzbd$zza[] r2 = r2.zzbo()     // Catch:{ IllegalArgumentException -> 0x045a }
        ...
        L_0x03ce:
            ...
            java.lang.String r6 = r5.zzbp()     // Catch:{ IllegalArgumentException -> 0x045a }
            boolean r6 = r6.equals(r1)     // Catch:{ IllegalArgumentException -> 0x045a }
            if (r6 == 0) goto L_0x03e2
            java.lang.Class r2 = r5.zzbq()     // Catch:{ IllegalArgumentException -> 0x045a }
            r3 = r2
            goto L_0x03e6
        L_0x03e2:
            int r4 = r4 + 1
        ...
        L_0x0400:
            ...
            com.google.android.gms.internal.firebase_remote_config.zzax r1 = r19.zzba()     // Catch:{ IllegalArgumentException -> 0x045a }
            java.lang.String r2 = r1.toString(r14)     // Catch:{ IllegalArgumentException -> 0x045a }
            com.google.android.gms.internal.firebase_remote_config.zzbb r1 = r1.zzac(r2)     // Catch:{ IllegalArgumentException -> 0x045a }
            r1.zzbm()     // Catch:{ IllegalArgumentException -> 0x045a }
            r5 = 0
            r6 = 0
            r7 = 0
            r2 = r20
        ...
        L_0x048a:
            goto L_0x0489
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase_remote_config.zzbb.zza(java.lang.reflect.Field, java.lang.reflect.Type, java.util.ArrayList, java.lang.Object, com.google.android.gms.internal.firebase_remote_config.zzav, boolean):java.lang.Object");
    }
    ...
    private static Field zzb(Class<?> cls) {
        ...
        zzdf.lock();
        try {
            if (zzde.containsKey(cls)) {
                return (Field) zzde.get(cls);
            }
            for (zzby zzbz : zzbq.zzc(cls).zzbx()) {
                Field zzbz2 = zzbz.zzbz();
                zzbd zzbd = (zzbd) zzbz2.getAnnotation(zzbd.class);
                if (zzbd != null) {
                    ...
                    if (field == null) {
                        ...
                        if (zzbs.zza(zzbz2.getType())) {
                            zza[] zzbo = zzbd.zzbo();
                            HashSet hashSet = new HashSet();
                            String str3 = "@JsonPolymorphicTypeMap must have at least one @TypeDef";
                            if (zzbo.length > 0) {
                                int length = zzbo.length;
                                int i = 0;
                                while (i < length) {
                                    zza zza = zzbo[i];
                                    String str4 = "Class contains two @TypeDef annotations with identical key: %s";
                                    Object[] objArr3 = {zza.zzbp()};
                                    if (hashSet.add(zza.zzbp())) {
                                        i++;
                                    } else {
                                        throw new IllegalArgumentException(zzdz.zza(str4, objArr3));
                                    }
                                }
                                field = zzbz2;
                            } else {
                            ...
                            throw new IllegalArgumentException(zzdz.zza(str2, objArr2));
                        }
                    } else {

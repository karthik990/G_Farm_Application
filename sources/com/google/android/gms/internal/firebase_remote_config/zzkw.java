...
interface zzkw {
    ...
    void zza(int i, zzfw zzfw) throws IOException;

    <K, V> void zza(int i, zzih<K, V> zzih, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzjj zzjj) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzjj zzjj) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzjj zzjj) throws IOException;

    void zzb(int i, String str) throws IOException;

    void zzb(int i, List<zzfw> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzjj zzjj) throws IOException;
    ...
    @Deprecated
    void zzba(int i) throws IOException;

    @Deprecated
    void zzbb(int i) throws IOException;

...
public abstract class zzcw extends zzcs {
    ...
    public final String zza(String str, int i) {
            ...
            if (i < length) {
                ...
                if (charAt >= 0) {
                    ...
                    if (zzj != null) {
                        ...
                        if (zzce.length < length2) {
                            zzce = zza(zzce, i4, ((length2 + length) - i) + 32);
                        }
                        if (i9 > 0) {
                            str.getChars(i3, i, zzce, i4);
                            i4 = i10;
                        }
                        if (zzj.length > 0) {
                            System.arraycopy(zzj, 0, zzce, i4, zzj.length);
                            i4 += zzj.length;
                        }
                        i3 = i8;
                    }
        ...
        if (i11 > 0) {
            ...
            str.getChars(i3, length, zzce, i4);
        } else {
            i2 = i4;
        }
        return new String(zzce, 0, i2);
    }

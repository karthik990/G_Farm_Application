...
public abstract class zzqj extends zzpr {
        ...
        public final void zzp(long j) throws IOException {
            if (!zzqj.zzawt || zzoi() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zztx.zza(bArr3, (long) i3, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    static final class zzd extends zzqj {
        ...
        public final void zzay(int i) throws IOException {
            while ((i & -128) != 0) {
                this.zzawy.put((byte) ((i & Opcodes.LAND) | 128));
                i >>>= 7;
            }
            try {
        ...
        public final void zzp(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.zzawy.put((byte) ((((int) j) & Opcodes.LAND) | 128));
                j >>>= 7;
            }
            try {
        ...
        public final void zzay(int i) throws IOException {
            if (this.zzaxd <= this.zzaxc) {
                while ((i & -128) != 0) {
                    long j = this.zzaxd;
                    this.zzaxd = j + 1;
                    zztx.zza(j, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                }
                long j2 = this.zzaxd;
                this.zzaxd = 1 + j2;
            ...
            while (true) {
                ...
                if (j3 >= this.zzaxb) {
                    ...
                    this.zzaxd = j3 + 1;
                    zztx.zza(j3, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                }
            }
        }
        ...
        public final void zzp(long j) throws IOException {
            if (this.zzaxd <= this.zzaxc) {
                while ((j & -128) != 0) {
                    long j2 = this.zzaxd;
                    this.zzaxd = j2 + 1;
                    zztx.zza(j2, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                }
                long j3 = this.zzaxd;
                this.zzaxd = 1 + j3;
            ...
            while (true) {
                ...
                if (j4 >= this.zzaxb) {
                    ...
                    this.zzaxd = j4 + 1;
                    zztx.zza(j4, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                }
            }
        }

...
final class zzxq extends zzxn {
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            long j6 = 1 + j4;
            zzxj.zza(bArr2, j4, (byte) charAt2);
            i6++;
            j4 = j6;
        }
        if (i6 == length) {
        ...
        while (i6 < length) {
            ...
            if (charAt3 < c && j4 < j5) {
                long j7 = j4 + j;
                zzxj.zza(bArr2, j4, (byte) charAt3);
                j3 = j;
                j2 = j7;
            } else if (charAt3 < 2048 && j4 <= j5 - 2) {
                long j8 = j4 + j;
                zzxj.zza(bArr2, j4, (byte) ((charAt3 >>> 6) | 960));
                long j9 = j8 + j;
                ...
                long j11 = j4 + j;
                zzxj.zza(bArr2, j4, (byte) ((charAt3 >>> 12) | 480));
                long j12 = j11 + j;
                zzxj.zza(bArr2, j11, (byte) (((charAt3 >>> 6) & 63) | 128));
                long j13 = j12 + 1;
                zzxj.zza(bArr2, j12, (byte) ((charAt3 & '?') | 128));
                j2 = j13;
                j3 = 1;
            } else if (j4 <= j5 - 4) {
                int i7 = i6 + 1;
                if (i7 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j14 = j4 + 1;
                        zzxj.zza(bArr2, j4, (byte) ((codePoint >>> 18) | PsExtractor.VIDEO_STREAM_MASK));
                        long j15 = j14 + 1;
                        zzxj.zza(bArr2, j14, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j16 = j15 + 1;
                        zzxj.zza(bArr2, j15, (byte) (((codePoint >>> 6) & 63) | 128));
                        j3 = 1;
                        j2 = j16 + 1;
                        zzxj.zza(bArr2, j16, (byte) ((codePoint & 63) | 128));
                        i6 = i7;
                        i6++;
                        c = 128;
                        long j102 = j3;
            ...
            while (i < length) {
                ...
                if (charAt2 < c && j < limit) {
                    ...
                    if ((charAt2 < 55296 || 57343 < charAt2) && j <= limit - 3) {
                        long j5 = j + 1;
                        zzxj.zza(j, (byte) ((charAt2 >>> 12) | 480));
                        long j6 = j5 + 1;
                        zzxj.zza(j5, (byte) (((charAt2 >>> 6) & 63) | 128));
                        long j7 = j6 + 1;
                        zzxj.zza(j6, (byte) ((charAt2 & '?') | 128));
                        j = j7;
                    } else if (j <= limit - 4) {
                        int i2 = i + 1;
                        if (i2 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                long j8 = j + 1;
                                zzxj.zza(j, (byte) ((codePoint >>> 18) | PsExtractor.VIDEO_STREAM_MASK));
                                long j9 = j8 + 1;
                    ...
                    j2 = zzb;
                    long j12 = j + 1;
                    zzxj.zza(j, (byte) ((charAt2 >>> 6) | 960));
                    long j13 = j12 + 1;
                    zzxj.zza(j12, (byte) ((charAt2 & '?') | 128));
                    j = j13;
                }
                i++;

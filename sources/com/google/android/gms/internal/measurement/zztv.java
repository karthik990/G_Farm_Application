...
public abstract class zztv extends zztd {
        ...
        public final void zzba(int i) throws IOException {
            if (!zztv.zzbuo || zzvj() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    this.position = i4 + 1;
                    zzxj.zza(bArr3, (long) i4, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                }
        ...
        public final void zzat(long j) throws IOException {
            if (!zztv.zzbuo || zzvj() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zzxj.zza(bArr3, (long) i3, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    static final class zzd extends zztv {
        ...
        public final void zzba(int i) throws IOException {
            while ((i & -128) != 0) {
                this.zzbut.put((byte) ((i & Opcodes.LAND) | 128));
                i >>>= 7;
            }
            try {
        ...
        public final void zzat(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.zzbut.put((byte) ((((int) j) & Opcodes.LAND) | 128));
                j >>>= 7;
            }
            try {
        ...
        public final void zzba(int i) throws IOException {
            if (this.zzbuy <= this.zzbux) {
                while ((i & -128) != 0) {
                    long j = this.zzbuy;
                    this.zzbuy = j + 1;
                    zzxj.zza(j, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                }
                long j2 = this.zzbuy;
                this.zzbuy = 1 + j2;
            ...
            while (true) {
                ...
                if (j3 >= this.zzbuw) {
                    ...
                    this.zzbuy = j3 + 1;
                    zzxj.zza(j3, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                }
            }
        }
        ...
        public final void zzat(long j) throws IOException {
            if (this.zzbuy <= this.zzbux) {
                while ((j & -128) != 0) {
                    long j2 = this.zzbuy;
                    this.zzbuy = j2 + 1;
                    zzxj.zza(j2, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                }
                long j3 = this.zzbuy;
                this.zzbuy = 1 + j3;
            ...
            while (true) {
                ...
                if (j4 >= this.zzbuw) {
                    ...
                    this.zzbuy = j4 + 1;
                    zzxj.zza(j4, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                }
            }
        }

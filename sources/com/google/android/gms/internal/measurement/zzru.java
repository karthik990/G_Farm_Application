...
public class zzru {
    ...
    public static final AtomicBoolean zzbqs = new AtomicBoolean();
    ...
    public static java.lang.String zza(android.content.ContentResolver r13, java.lang.String r14, java.lang.String r15) {
        /*
            java.lang.Class<com.google.android.gms.internal.measurement.zzru> r15 = com.google.android.gms.internal.measurement.zzru.class
            monitor-enter(r15)
            zza(r13)     // Catch:{ all -> 0x00aa }
            java.lang.Object r0 = zzbqy     // Catch:{ all -> 0x00aa }
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzbqt     // Catch:{ all -> 0x00aa }
            boolean r1 = r1.containsKey(r14)     // Catch:{ all -> 0x00aa }
            r2 = 0
            if (r1 == 0) goto L_0x001f
            java.util.HashMap<java.lang.String, java.lang.String> r13 = zzbqt     // Catch:{ all -> 0x00aa }
        ...
        L_0x001d:
            ...
            return r13
        L_0x001f:
            java.lang.String[] r1 = zzbra     // Catch:{ all -> 0x00aa }
        ...
        L_0x0024:
            ...
            boolean r0 = zzbqz     // Catch:{ all -> 0x00aa }
            if (r0 == 0) goto L_0x003b
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzbqt     // Catch:{ all -> 0x00aa }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00aa }
            if (r0 == 0) goto L_0x005e
        L_0x003b:
            java.lang.String[] r0 = zzbra     // Catch:{ all -> 0x00aa }
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzbqt     // Catch:{ all -> 0x00aa }
            java.util.Map r13 = zza(r13, r0)     // Catch:{ all -> 0x00aa }
            r1.putAll(r13)     // Catch:{ all -> 0x00aa }
            zzbqz = r6     // Catch:{ all -> 0x00aa }
            java.util.HashMap<java.lang.String, java.lang.String> r13 = zzbqt     // Catch:{ all -> 0x00aa }
    ...
    private static Map<String, String> zza(ContentResolver contentResolver, String... strArr) {
        Cursor query = contentResolver.query(zzbqp, null, null, strArr, null);

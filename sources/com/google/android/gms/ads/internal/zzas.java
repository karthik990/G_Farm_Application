...
public final class zzas {
        ...
        if (bundle != null && !TextUtils.isEmpty(str)) {
            ...
            while (keys.hasNext()) {
                ...
                if (bundle.containsKey(str4)) {
                    if (TtmlNode.TAG_IMAGE.equals(jSONObject2.getString(str4))) {
                    ...
                    } else if (bundle.get(str4) instanceof Bitmap) {
                        str3 = "Invalid asset type. Bitmap should be returned only for image type";
                    } else {
                        str2 = String.valueOf(bundle.get(str4));
                        jSONObject.put(str4, str2);
                    }
                    zzakb.zzdk(str3);
                }
    ...
    public static boolean zza(com.google.android.gms.internal.ads.zzaqw r25, com.google.android.gms.internal.ads.zzxe r26, java.util.concurrent.CountDownLatch r27) {
        ...
        L_0x0026:
            ...
            r0.zza(r3, r4)     // Catch:{ RemoteException -> 0x012c, RuntimeException -> 0x0127 }
        ...
        L_0x00a5:
            r4.zza(r5)     // Catch:{ RemoteException -> 0x012c, RuntimeException -> 0x0127 }
            goto L_0x0100
        L_0x00a9:

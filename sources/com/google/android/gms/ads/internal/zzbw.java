...
public final class zzbw implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    private final void zzf(boolean z) {
        if (this.zzacs != null) {
            zzajh zzajh = this.zzacw;
            if (zzajh != null && zzajh.zzbyo != null && this.zzacw.zzbyo.zzuf() != null && (!z || this.zzadz.tryAcquire())) {
    ...
    public final void zzfm() {
        zzajh zzajh = this.zzacw;
        if (zzajh != null && zzajh.zzbyo != null) {
    ...
    public final void zzfn() {
        zzajh zzajh = this.zzacw;
        if (!(zzajh == null || zzajh.zzbtx == null)) {
            try {
    ...
    public final String zzfq() {
        String str = "";
        return (!this.zzaea || !this.zzaeb) ? this.zzaea ? this.zzaec ? "top-scrollable" : "top-locked" : this.zzaeb ? this.zzaec ? "bottom-scrollable" : "bottom-locked" : str : str;
    }
    ...
    public final void zzg(boolean z) {
        ...
        zzajx zzajx = this.zzact;
        if (zzajx != null) {
            zzajx.cancel();
        }
        zzalc zzalc = this.zzacu;
        if (zzalc != null) {
            zzalc.cancel();
        }
        if (z) {

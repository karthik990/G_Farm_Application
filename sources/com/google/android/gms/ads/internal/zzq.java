...
public final class zzq extends zzd implements zzpa {
    ...
    public final boolean zzb(zzjj zzjj) {
        zzjj zzjj2 = zzjj;
        if (this.zzvw.zzadn != null && this.zzvw.zzadn.size() == 1 && ((Integer) this.zzvw.zzadn.get(0)).intValue() == 2) {
            zzakb.m1272e("Requesting only banner Ad from AdLoader or calling loadAd on returned banner is not yet supported");
            zzi(0);
            return false;
            ...
            if (zzjj2.zzaqb != this.zzvm) {
                zzjj zzjj3 = new zzjj(zzjj2.versionCode, zzjj2.zzapw, zzjj2.extras, zzjj2.zzapx, zzjj2.zzapy, zzjj2.zzapz, zzjj2.zzaqa, zzjj2.zzaqb || this.zzvm, zzjj2.zzaqc, zzjj2.zzaqd, zzjj2.zzaqe, zzjj2.zzaqf, zzjj2.zzaqg, zzjj2.zzaqh, zzjj2.zzaqi, zzjj2.zzaqj, zzjj2.zzaqk, zzjj2.zzaql);
                zzjj2 = zzjj3;
            }
    ...
    public final void zzce() {
        if (this.zzvw.zzacw != null) {
            if ("com.google.ads.mediation.admob.AdMobAdapter".equals(this.zzvw.zzacw.zzbty) && this.zzvw.zzacw.zzbtw != null && this.zzvw.zzacw.zzbtw.zzmg()) {
                zzbs();
                return;
            }
        }

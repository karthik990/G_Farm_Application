...
public final class zzal extends zzi implements zzai, zzz {
    ...
    public zzal(Context context, zzjn zzjn, String str, zzxn zzxn, zzang zzang, zzw zzw) {
        ...
        this.zzyq = false;
        if (zzjn != null) {
            if ("reward_mb".equals(zzjn.zzarb)) {
                z = true;
            }
        }
    ...
    private static zzaji zzb(zzaji zzaji) {
        ...
        try {
            ...
            zzaej zzaej2 = new zzaej(zzaji2.zzcgs, zzaej.zzbyq, zzaej.zzceo, Collections.emptyList(), Collections.emptyList(), zzaej.zzcep, true, zzaej.zzcer, Collections.emptyList(), zzaej.zzbsu, zzaej.orientation, zzaej.zzcet, zzaej.zzceu, zzaej.zzcev, zzaej.zzcew, zzaej.zzcex, null, zzaej.zzcez, zzaej.zzare, zzaej.zzcdd, zzaej.zzcfa, zzaej.zzcfb, zzaej.zzamj, zzaej.zzarf, zzaej.zzarg, null, Collections.emptyList(), Collections.emptyList(), zzaej.zzcfh, zzaej.zzcfi, zzaej.zzcdr, zzaej.zzcds, zzaej.zzbsr, zzaej.zzbss, zzaej.zzcfj, null, zzaej.zzcfl, zzaej.zzcfm, zzaej.zzced, zzaej.zzzl, 0, zzaej.zzcfp, Collections.emptyList(), zzaej.zzzm, zzaej.zzcfq);
            zzaji zzaji3 = new zzaji(zzaji2.zzcgs, zzaej2, zzwy, zzaji2.zzacv, zzaji2.errorCode, zzaji2.zzcoh, zzaji2.zzcoi, null, zzaji2.zzcoq, null);
            return zzaji3;
    ...
    public final zzaqw zza(zzaji zzaji, zzx zzx, zzait zzait) throws zzarg {
        ...
        zza.zza("/reward", (zzv<? super zzaqw>) new zzah<Object>(this));
        return zza;
    }
    ...
    public final void zzcc() {
        ...
        if (this.zzwb != null && this.zzvw.zzacw != null && this.zzvw.zzacw.zzbyo != null) {
            this.zzvw.zzacw.zzbyo.zza("onSdkImpression", (Map<String, ?>) new HashMap<String,Object>());
        }
    }

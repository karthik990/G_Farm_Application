            ...
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    try {
                        ...
                        jSONObject2.optString(ChatConstants.ARG_USER_INFO_EMAIL);
                        ...
                        if (!TextUtils.isEmpty(optString7)) {
                            try {
                                ...
                                zzakb.zzb(valueOf.length() != 0 ? str3.concat(valueOf) : new String(str3), uRISyntaxException);
                            }
                        }
                        boolean z = true;
                        if (intent == null) {
                ...
                ((zzue) zzarr).zza(str2, jSONObject);
            } catch (JSONException unused) {
                ((zzue) zzarr).zza(str2, new JSONObject());
            }

...
final class zzt implements ServiceConnection {
    ...
    public final synchronized void zzd(int i, String str) {
        ...
        if (i2 == 0) {
            ...
            for (int i3 = 0; i3 < this.zzcf.size(); i3++) {
                ((zzz) this.zzcf.valueAt(i3)).zzd(zzaa);
            }
            this.zzcf.clear();
        } else if (i2 == 3) {
            this.state = 4;
    ...
    public final boolean zzd(android.os.Message r5) {
        ...
        L_0x0023:
            monitor-enter(r4)
            android.util.SparseArray<com.google.android.gms.iid.zzz<?>> r1 = r4.zzcf     // Catch:{ all -> 0x006f }
            ...
            return r2
        L_0x0049:
            android.util.SparseArray<com.google.android.gms.iid.zzz<?>> r3 = r4.zzcf     // Catch:{ all -> 0x006f }
            r3.remove(r0)     // Catch:{ all -> 0x006f }
            r4.zzs()     // Catch:{ all -> 0x006f }
            monitor-exit(r4)     // Catch:{ all -> 0x006f }
    ...
    public final synchronized boolean zze(com.google.android.gms.iid.zzz r6) {
        ...
        L_0x002e:
            ...
            return r2
        L_0x0030:
            java.util.Queue<com.google.android.gms.iid.zzz<?>> r0 = r5.zzce     // Catch:{ all -> 0x0097 }
            r0.add(r6)     // Catch:{ all -> 0x0097 }
            r5.zzr()     // Catch:{ all -> 0x0097 }
            monitor-exit(r5)
            return r3
        L_0x003a:
            java.util.Queue<com.google.android.gms.iid.zzz<?>> r0 = r5.zzce     // Catch:{ all -> 0x0097 }
        ...
        L_0x005f:
            ...
            com.google.android.gms.iid.zzr r1 = r5.zzcg     // Catch:{ all -> 0x0097 }
            android.content.Context r1 = r1.zzk     // Catch:{ all -> 0x0097 }
            ...
            goto L_0x0095
        L_0x0083:
            com.google.android.gms.iid.zzr r6 = r5.zzcg     // Catch:{ all -> 0x0097 }

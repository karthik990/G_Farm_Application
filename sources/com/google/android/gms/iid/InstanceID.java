...
public class InstanceID {
    ...
    public static synchronized InstanceID getInstance(Context context, Bundle bundle) {
        ...
        synchronized (InstanceID.class) {
            ...
            instanceID = (InstanceID) zzbq.get(string);
            if (instanceID == null) {
    ...
    static String zzd(KeyPair keyPair) {
        try {
            ...
            digest[0] = (byte) ((digest[0] & Ascii.f1875SI) + 112);
    ...
    public String getToken(String str, String str2, Bundle bundle) throws IOException {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            ...
            if (str4 != null && str4.equals(zzbu)) {
                String str5 = zzbs.get("lastToken");
                if (str5 != null) {
                    if ((System.currentTimeMillis() / 1000) - Long.valueOf(Long.parseLong(str5)).longValue() <= zzbr) {
                        z = false;
                    }
                }
            }
    ...
    public final void zzd(String str, String str2, Bundle bundle) throws IOException {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            ...
            bundle.putString("X-delete", str3);
            String str4 = "";
            bundle.putString("subtype", str4.equals(this.zzbv) ? str : this.zzbv);
            if (!str4.equals(this.zzbv)) {
                str = this.zzbv;
            }

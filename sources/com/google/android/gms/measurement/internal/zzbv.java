...
final class zzbv extends Thread {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:?, code lost:
        r6.zzape.zzapa.release();
        r6.zzape.zzaoz.notifyAll();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x0084, code lost:
        if (r6 != r6.zzape.zzaot) goto L_0x008c;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:44:0x0092, code lost:
        if (r6 != r6.zzape.zzaou) goto L_0x009a;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x009a, code lost:
        r6.zzape.zzgt().zzjg().zzby("Current scheduler thread is neither worker nor network");
     */
    ...
    public final void run() {
        ...
        L_0x0001:
            ...
            com.google.android.gms.measurement.internal.zzbr r1 = r6.zzape     // Catch:{ InterruptedException -> 0x000e }
            java.util.concurrent.Semaphore r1 = r1.zzapa     // Catch:{ InterruptedException -> 0x000e }
        ...
        L_0x001c:
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzbu<?>> r2 = r6.zzapi     // Catch:{ all -> 0x00b7 }
            ...
            boolean r3 = r2.zzapg     // Catch:{ all -> 0x00b7 }
        ...
        L_0x002e:
            ...
            goto L_0x001c
        L_0x0035:
            java.lang.Object r2 = r6.zzaph     // Catch:{ all -> 0x00b7 }
            monitor-enter(r2)     // Catch:{ all -> 0x00b7 }
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzbu<?>> r3 = r6.zzapi     // Catch:{ all -> 0x00b4 }
            java.lang.Object r3 = r3.peek()     // Catch:{ all -> 0x00b4 }
            if (r3 != 0) goto L_0x0054
            com.google.android.gms.measurement.internal.zzbr r3 = r6.zzape     // Catch:{ all -> 0x00b4 }
            boolean r3 = r3.zzapb     // Catch:{ all -> 0x00b4 }
            if (r3 != 0) goto L_0x0054
            java.lang.Object r3 = r6.zzaph     // Catch:{ InterruptedException -> 0x0050 }
        ...
        L_0x0054:
            ...
            com.google.android.gms.measurement.internal.zzbr r2 = r6.zzape     // Catch:{ all -> 0x00b7 }
            java.lang.Object r2 = r2.zzaoz     // Catch:{ all -> 0x00b7 }
            monitor-enter(r2)     // Catch:{ all -> 0x00b7 }
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzbu<?>> r3 = r6.zzapi     // Catch:{ all -> 0x00b1 }
            java.lang.Object r3 = r3.peek()     // Catch:{ all -> 0x00b1 }
            if (r3 != 0) goto L_0x00ae
            monitor-exit(r2)     // Catch:{ all -> 0x00b1 }
            com.google.android.gms.measurement.internal.zzbr r1 = r6.zzape
            java.lang.Object r1 = r1.zzaoz
            monitor-enter(r1)
            com.google.android.gms.measurement.internal.zzbr r2 = r6.zzape     // Catch:{ all -> 0x00ab }
            java.util.concurrent.Semaphore r2 = r2.zzapa     // Catch:{ all -> 0x00ab }
            r2.release()     // Catch:{ all -> 0x00ab }
            com.google.android.gms.measurement.internal.zzbr r2 = r6.zzape     // Catch:{ all -> 0x00ab }
            java.lang.Object r2 = r2.zzaoz     // Catch:{ all -> 0x00ab }
            r2.notifyAll()     // Catch:{ all -> 0x00ab }
            com.google.android.gms.measurement.internal.zzbr r2 = r6.zzape     // Catch:{ all -> 0x00ab }
            com.google.android.gms.measurement.internal.zzbv r2 = r2.zzaot     // Catch:{ all -> 0x00ab }
            if (r6 != r2) goto L_0x008c
            com.google.android.gms.measurement.internal.zzbr r2 = r6.zzape     // Catch:{ all -> 0x00ab }
            r2.zzaot = null     // Catch:{ all -> 0x00ab }
            goto L_0x00a9
        L_0x008c:
            com.google.android.gms.measurement.internal.zzbr r2 = r6.zzape     // Catch:{ all -> 0x00ab }
            com.google.android.gms.measurement.internal.zzbv r2 = r2.zzaou     // Catch:{ all -> 0x00ab }
            if (r6 != r2) goto L_0x009a
            com.google.android.gms.measurement.internal.zzbr r2 = r6.zzape     // Catch:{ all -> 0x00ab }
            r2.zzaou = null     // Catch:{ all -> 0x00ab }
            goto L_0x00a9
        L_0x009a:
            com.google.android.gms.measurement.internal.zzbr r0 = r6.zzape     // Catch:{ all -> 0x00ab }
        ...
        L_0x00b7:
            r1 = move-exception
            com.google.android.gms.measurement.internal.zzbr r2 = r6.zzape
            java.lang.Object r2 = r2.zzaoz
            monitor-enter(r2)
            com.google.android.gms.measurement.internal.zzbr r3 = r6.zzape     // Catch:{ all -> 0x00fe }
            java.util.concurrent.Semaphore r3 = r3.zzapa     // Catch:{ all -> 0x00fe }
            r3.release()     // Catch:{ all -> 0x00fe }
            com.google.android.gms.measurement.internal.zzbr r3 = r6.zzape     // Catch:{ all -> 0x00fe }
            java.lang.Object r3 = r3.zzaoz     // Catch:{ all -> 0x00fe }
            r3.notifyAll()     // Catch:{ all -> 0x00fe }
            com.google.android.gms.measurement.internal.zzbr r3 = r6.zzape     // Catch:{ all -> 0x00fe }
            com.google.android.gms.measurement.internal.zzbv r3 = r3.zzaot     // Catch:{ all -> 0x00fe }
            if (r6 == r3) goto L_0x00f7
            com.google.android.gms.measurement.internal.zzbr r3 = r6.zzape     // Catch:{ all -> 0x00fe }
            com.google.android.gms.measurement.internal.zzbv r3 = r3.zzaou     // Catch:{ all -> 0x00fe }
            if (r6 != r3) goto L_0x00e7
            com.google.android.gms.measurement.internal.zzbr r3 = r6.zzape     // Catch:{ all -> 0x00fe }
            r3.zzaou = null     // Catch:{ all -> 0x00fe }
            goto L_0x00fc
        L_0x00e7:
            com.google.android.gms.measurement.internal.zzbr r0 = r6.zzape     // Catch:{ all -> 0x00fe }
        ...
        L_0x00f7:
            com.google.android.gms.measurement.internal.zzbr r3 = r6.zzape     // Catch:{ all -> 0x00fe }
            r3.zzaot = null     // Catch:{ all -> 0x00fe }
        L_0x00fc:

    ...
    public final byte[] zzb(zzag zzag, String str) {
        ...
        try {
            ...
            if (zzbm == null) {
                ...
                zzfw3.zzaxr = AbstractSpiCall.ANDROID_CLIENT_TYPE;
                ...
                try {
                    ...
                    String str4 = zzfw3.zztt;
                    List zzbl = zzjt().zzbl(str4);
                    if (zzgv().zzau(str2)) {
                        ...
                        if (zzfw2 == null || zzfw2.value == null) {
                            zzfw zzfw4 = new zzfw(str4, "auto", "_lte", zzbx().currentTimeMillis(), Long.valueOf(0));
                            zzbl.add(zzfw4);
                            zzjt().zza(zzfw4);
                        }
                    }
                    ...
                    if (zzgr().zzcz(zzfw3.zztt)) {
                        ...
                        zzgr().zza(zziy, str3, (Object) Long.valueOf(1));
                    }
                    ...
                    while (it2.hasNext()) {
                        ...
                        zzft.zzaxc[i2] = zzfu;
                        zzfu.name = str5;
                        zzjr().zza(zzfu, zzab.zzahu.get(str5));
                        i2 = i3;
                    }

...
public final class zzbq extends zzfm implements zzs {
    ...
    public final boolean zzcl(String str) {
        return IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(zzf(str, "measurement.upload.blacklist_internal"));
    }

    /* access modifiers changed from: 0000 */
    public final boolean zzcm(String str) {
        return IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(zzf(str, "measurement.upload.blacklist_public"));
    }

...
public final class zzq extends zzcr {
    ...
    public final boolean zzas(String str) {
        return IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(this.zzagx.zzf(str, "gaia_collection_enabled"));
    }

    public final boolean zzat(String str) {
        return IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(this.zzagx.zzf(str, "measurement.event_sampling_enabled"));
    }

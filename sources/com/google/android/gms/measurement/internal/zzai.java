...
public final class zzai {
    ...
    public static zza<Long> zzaiv = zza.zzb("measurement.ad_id_cache_time", (long) WorkRequest.MIN_BACKOFF_MILLIS, (long) WorkRequest.MIN_BACKOFF_MILLIS);
    ...
    public static zza<Long> zzajo = zza.zzb("measurement.upload.realtime_upload_interval", (long) WorkRequest.MIN_BACKOFF_MILLIS, (long) WorkRequest.MIN_BACKOFF_MILLIS);
    ...
    public static zza<Long> zzajt = zza.zzb("measurement.upload.refresh_blacklisted_config_interval", (long) Constants.REGISTRATION_EXPIRY_TIME_MS, (long) Constants.REGISTRATION_EXPIRY_TIME_MS);
    public static zza<Long> zzaju = zza.zzb("measurement.upload.initial_upload_delay_time", (long) AbstractTrafficShapingHandler.DEFAULT_MAX_TIME, (long) AbstractTrafficShapingHandler.DEFAULT_MAX_TIME);

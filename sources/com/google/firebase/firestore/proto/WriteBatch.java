...
import com.google.firestore.p050v1.WriteOrBuilder;
...
public final class WriteBatch extends GeneratedMessageLite<WriteBatch, Builder> implements WriteBatchOrBuilder {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessageLite.Builder<WriteBatch, Builder> implements WriteBatchOrBuilder {
        ...
        public Builder setWrites(int i, com.google.firestore.p050v1.Write.Builder builder) {
            copyOnWrite();
        ...
        public Builder addWrites(com.google.firestore.p050v1.Write.Builder builder) {
            copyOnWrite();
            ((WriteBatch) this.instance).addWrites(builder);
            return this;
        }

        public Builder addWrites(int i, com.google.firestore.p050v1.Write.Builder builder) {
            copyOnWrite();
        ...
        public Builder setBaseWrites(int i, com.google.firestore.p050v1.Write.Builder builder) {
            copyOnWrite();
        ...
        public Builder addBaseWrites(com.google.firestore.p050v1.Write.Builder builder) {
            copyOnWrite();
            ((WriteBatch) this.instance).addBaseWrites(builder);
            return this;
        }

        public Builder addBaseWrites(int i, com.google.firestore.p050v1.Write.Builder builder) {
            copyOnWrite();
    ...
    /* access modifiers changed from: private */
    public void setWrites(int i, com.google.firestore.p050v1.Write.Builder builder) {
        ensureWritesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addWrites(com.google.firestore.p050v1.Write.Builder builder) {
        ensureWritesIsMutable();
        this.writes_.add((Write) builder.build());
    }

    /* access modifiers changed from: private */
    public void addWrites(int i, com.google.firestore.p050v1.Write.Builder builder) {
        ensureWritesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setBaseWrites(int i, com.google.firestore.p050v1.Write.Builder builder) {
        ensureBaseWritesIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addBaseWrites(com.google.firestore.p050v1.Write.Builder builder) {
        ensureBaseWritesIsMutable();
        this.baseWrites_.add((Write) builder.build());
    }

    /* access modifiers changed from: private */
    public void addBaseWrites(int i, com.google.firestore.p050v1.Write.Builder builder) {
        ensureBaseWritesIsMutable();

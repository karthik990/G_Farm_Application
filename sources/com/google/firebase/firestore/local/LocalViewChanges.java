...
public final class LocalViewChanges {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    static /* synthetic */ class C36541 {

        /* renamed from: $SwitchMap$com$google$firebase$firestore$core$DocumentViewChange$Type */
        static final /* synthetic */ int[] f2025x33862af7 = new int[Type.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f2025x33862af7 = r0
                int[] r0 = f2025x33862af7     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f2025x33862af7     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.local.LocalViewChanges.C36541.<clinit>():void");
        }
    }
    ...
    public static LocalViewChanges fromViewSnapshot(int i, ViewSnapshot viewSnapshot) {
        ...
        for (DocumentViewChange documentViewChange : viewSnapshot.getChanges()) {
            int i2 = C36541.f2025x33862af7[documentViewChange.getType().ordinal()];
            if (i2 == 1) {

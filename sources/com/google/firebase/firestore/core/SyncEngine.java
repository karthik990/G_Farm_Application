...
public class SyncEngine implements RemoteStoreCallback {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    static /* synthetic */ class C36481 {

        /* renamed from: $SwitchMap$com$google$firebase$firestore$core$LimboDocumentChange$Type */
        static final /* synthetic */ int[] f2021x84ba890d = new int[Type.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f2021x84ba890d = r0
                int[] r0 = f2021x84ba890d     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f2021x84ba890d     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.core.SyncEngine.C36481.<clinit>():void");
        }
    }
    ...
    private void updateTrackedLimboDocuments(List<LimboDocumentChange> list, int i) {
        for (LimboDocumentChange limboDocumentChange : list) {
            int i2 = C36481.f2021x84ba890d[limboDocumentChange.getType().ordinal()];
            if (i2 == 1) {

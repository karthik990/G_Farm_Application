...
public class View {
    ...
    /* compiled from: com.google.firebase:firebase-firestore@@19.0.0 */
    static /* synthetic */ class C36501 {

        /* renamed from: $SwitchMap$com$google$firebase$firestore$core$DocumentViewChange$Type */
        static final /* synthetic */ int[] f2022x33862af7 = new int[Type.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f2022x33862af7 = r0
                int[] r0 = f2022x33862af7     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f2022x33862af7     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f2022x33862af7     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f2022x33862af7     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.core.View.C36501.<clinit>():void");
        }
    }
    ...
    public static class DocumentChanges {
        ...
        /* synthetic */ DocumentChanges(DocumentSet documentSet2, DocumentViewChangeSet documentViewChangeSet, ImmutableSortedSet immutableSortedSet, boolean z, C36501 r5) {
    ...
    private static int changeTypeOrder(DocumentViewChange documentViewChange) {
        int i = C36501.f2022x33862af7[documentViewChange.getType().ordinal()];
        int i2 = 1;
        if (i != 1) {
            i2 = 2;
            if (!(i == 2 || i == 3)) {

...
public class UserData {
    ...
    static /* synthetic */ class C36491 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.firestore.core.UserData.C36491.<clinit>():void");
        }
    }
    ...
    public static class ParseContext {
        ...
        /* synthetic */ ParseContext(ParseAccumulator parseAccumulator, FieldPath fieldPath, boolean z, C36491 r4) {
        ...
        public boolean isWrite() {
            int i = C36491.$SwitchMap$com$google$firebase$firestore$core$UserData$Source[this.accumulator.dataSource.ordinal()];
            if (i == 1 || i == 2 || i == 3) {
                return true;
            }
            if (i == 4) {

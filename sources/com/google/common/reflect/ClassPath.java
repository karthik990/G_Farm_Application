...
import com.google.common.p049io.ByteSource;
import com.google.common.p049io.CharSource;
import com.google.common.p049io.Resources;
import java.io.File;
...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m1790on(" ").omitEmptyStrings();
    ...
    static final class DefaultScanner extends Scanner {
        ...
        public ImmutableSet<ResourceInfo> getResources() {
            ...
            for (Entry entry : this.resources.entries()) {
                builder.add((Object) ResourceInfo.m2020of((String) entry.getValue(), (ClassLoader) entry.getKey()));
            }
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m2020of(String str, ClassLoader classLoader) {
    ...
    static abstract class Scanner {
        ...
        static com.google.common.collect.ImmutableList<java.net.URL> parseJavaClassPath() {
            /*
                ...
                com.google.common.base.Splitter r1 = com.google.common.base.Splitter.m1790on(r1)

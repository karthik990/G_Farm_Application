...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m1787on((char) StringUtil.COMMA).trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m1787on((char) SignatureVisitor.INSTANCEOF).trimResults();
    ...
    static /* synthetic */ class C29641 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.cache.CacheBuilderSpec.C29641.<clinit>():void");
        }
    }
    ...
    public CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C29641.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
                newBuilder.weakKeys();
            } else {
        ...
        if (this.valueStrength != null) {
            int i = C29641.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {

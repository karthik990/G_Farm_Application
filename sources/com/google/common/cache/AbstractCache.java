...
public abstract class AbstractCache<K, V> implements Cache<K, V> {
    ...
    public static final class SimpleStatsCounter implements StatsCounter {
        ...
        public CacheStats snapshot() {
            CacheStats cacheStats = new CacheStats(this.hitCount.sum(), this.missCount.sum(), this.loadSuccessCount.sum(), this.loadExceptionCount.sum(), this.totalLoadTime.sum(), this.evictionCount.sum());
            return cacheStats;
        }

...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    private static final class Any extends NamedFastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo43444or(CharMatcher charMatcher) {
    ...
    private static final class C2931Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo43444or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo43444or(charMatcher);
        }
    ...
    private static final class C2932Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C2932Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    /* renamed from: is */
    public static CharMatcher m1768is(char c) {
        return new C2931Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m1768is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo43444or(CharMatcher charMatcher) {
        return new C2932Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m1768is((char) bitSet.nextSetBit(0));
        }
        if (i != 2) {

...
abstract class AbstractIterator<T> implements Iterator<T> {
    ...
    static /* synthetic */ class C29241 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.base.AbstractIterator.C29241.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        ...
        int i = C29241.$SwitchMap$com$google$common$base$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i != 2) {

...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.m1768is('-'), "-") {
    ...
    UPPER_UNDERSCORE(CharMatcher.m1768is('_'), r4) {
        /* access modifiers changed from: 0000 */
        public String normalizeWord(String str) {
            return Ascii.toUpperCase(str);
        }
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String str) {
            return this.sourceFormat.mo43423to(this.targetFormat, str);
        }

        /* access modifiers changed from: protected */
        public String doBackward(String str) {
            return this.targetFormat.mo43423to(this.sourceFormat, str);
        }
    ...
    /* renamed from: to */
    public final String mo43423to(CaseFormat caseFormat, String str) {

...
public final class Predicates {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f1882f;

        /* renamed from: p */
        final Predicate<B> f1883p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f1883p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f1882f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f1883p.apply(this.f1882f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f1882f.equals(compositionPredicate.f1882f) || !this.f1883p.equals(compositionPredicate.f1883p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f1882f.hashCode() ^ this.f1883p.hashCode();
        }

        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(this.f1883p);
            sb.append("(");
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m1782or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m1783or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m1781or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m1780in(Collection<? extends T> collection) {

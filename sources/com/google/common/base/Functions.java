...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f1880f;

        /* renamed from: g */
        private final Function<B, C> f1881g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f1881g = (Function) Preconditions.checkNotNull(function);
            this.f1880f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f1881g.apply(this.f1880f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f1880f.equals(functionComposition.f1880f) || !this.f1881g.equals(functionComposition.f1881g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f1880f.hashCode() ^ this.f1881g.hashCode();
        }

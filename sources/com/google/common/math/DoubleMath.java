    ...
    static /* synthetic */ class C33531 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.DoubleMath.C33531.<clinit>():void");
        }
    }

    static double roundIntermediate(double d, RoundingMode roundingMode) {
        if (DoubleUtils.isFinite(d)) {
            switch (C33531.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                ...
                case 5:
                    if (!isMathematicalInteger(d)) {
                        d = (double) (((long) d) + ((long) (d > 0.0d ? 1 : -1)));
                        break;
                    } else {
                        return d;
                    }

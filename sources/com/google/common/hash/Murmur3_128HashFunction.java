...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f1968C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f1969C2 = 5545529020109919103L;
        private static final int CHUNK_SIZE = 16;

        /* renamed from: h1 */
        private long f1970h1;

        /* renamed from: h2 */
        private long f1971h2;
        ...
        private void bmix64(long j, long j2) {
            this.f1970h1 = mixK1(j) ^ this.f1970h1;
            this.f1970h1 = Long.rotateLeft(this.f1970h1, 27);
            long j3 = this.f1970h1;
            long j4 = this.f1971h2;
            this.f1970h1 = j3 + j4;
            this.f1970h1 = (this.f1970h1 * 5) + 1390208809;
            this.f1971h2 = mixK2(j2) ^ j4;
            this.f1971h2 = Long.rotateLeft(this.f1971h2, 31);
            this.f1971h2 += this.f1970h1;
            this.f1971h2 = (this.f1971h2 * 5) + 944331445;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f1970h1 = mixK1(r2) ^ r11.f1970h1;
            r11.f1971h2 = mixK2(r0) ^ r11.f1971h2;
         */
        ...
        public HashCode makeHash() {
            long j = this.f1970h1;
            int i = this.length;
            this.f1970h1 = j ^ ((long) i);
            this.f1971h2 ^= (long) i;
            long j2 = this.f1970h1;
            long j3 = this.f1971h2;
            this.f1970h1 = j2 + j3;
            long j4 = this.f1970h1;
            this.f1971h2 = j3 + j4;
            this.f1970h1 = fmix64(j4);
            this.f1971h2 = fmix64(this.f1971h2);
            long j5 = this.f1970h1;
            long j6 = this.f1971h2;
            this.f1970h1 = j5 + j6;
            this.f1971h2 = j6 + this.f1970h1;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f1970h1).putLong(this.f1971h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f1968C1, 31) * f1969C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f1969C2, 33) * f1968C1;
        }
    }

...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* renamed from: C1 */
    private static final int f1972C1 = -862048943;

    /* renamed from: C2 */
    private static final int f1973C2 = 461845907;
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i, long j) {
            ...
            this.length += i;
            if (this.shift >= 32) {
                this.f1974h1 = Murmur3_32HashFunction.mixH1(this.f1974h1, Murmur3_32HashFunction.mixK1((int) this.buffer));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            this.f1974h1 ^= Murmur3_32HashFunction.mixK1((int) this.buffer);
            return Murmur3_32HashFunction.fmix(this.f1974h1, this.length);
        }
    }
    ...
    public static int mixK1(int i) {
        return Integer.rotateLeft(i * f1972C1, 15) * f1973C2;
    }

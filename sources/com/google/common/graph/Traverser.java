...
public abstract class Traverser<N> {
    ...
    private static final class GraphTraverser<N> extends Traverser<N> {
        ...
        public Iterable<N> breadthFirst(N n) {
            ...
            return breadthFirst((Iterable<? extends N>) ImmutableSet.m1926of(n));
        }
        ...
        public Iterable<N> depthFirstPreOrder(N n) {
            Preconditions.checkNotNull(n);
            return depthFirstPreOrder((Iterable<? extends N>) ImmutableSet.m1926of(n));
        }
        ...
        public Iterable<N> depthFirstPostOrder(N n) {
            Preconditions.checkNotNull(n);
            return depthFirstPostOrder((Iterable<? extends N>) ImmutableSet.m1926of(n));
        }

...
class ConfigurableValueGraph<N, V> extends AbstractValueGraph<N, V> {
    ...
    ConfigurableValueGraph(AbstractGraphBuilder<? super N> abstractGraphBuilder) {
        this(abstractGraphBuilder, abstractGraphBuilder.nodeOrder.createMap(((Integer) abstractGraphBuilder.expectedNodeCount.mo43411or(Integer.valueOf(10))).intValue()), 0);
    }

...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
            ...
            public Set<EndpointPair<N>> edges() {
                ...
                return new AbstractSet<EndpointPair<N>>() {
                    ...
                    public boolean contains(@NullableDecl Object obj) {
                        ...
                        if (C32851.this.isDirected() == endpointPair.isOrdered() && C32851.this.nodes().contains(endpointPair.nodeU()) && C32851.this.successors(endpointPair.nodeU()).contains(endpointPair.nodeV())) {
                            z = true;
                        }
                        return z;
                    }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(incidentNodes.nodeU()), incidentEdges(incidentNodes.nodeV())), ImmutableSet.m1926of(e));
    }

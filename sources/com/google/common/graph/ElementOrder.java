...
public final class ElementOrder<T> {
    ...
    static /* synthetic */ class C32971 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.graph.ElementOrder.C32971.<clinit>():void");
        }
    }
    ...
    public <K extends T, V> Map<K, V> createMap(int i) {
        int i2 = C32971.$SwitchMap$com$google$common$graph$ElementOrder$Type[this.type.ordinal()];
        if (i2 == 1) {

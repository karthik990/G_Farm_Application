...
abstract class AbstractBaseGraph<N> implements BaseGraph<N> {
    ...
    private static abstract class IncidentEdgeSet<N> extends AbstractSet<EndpointPair<N>> {
        ...
        private static final class Directed<N> extends IncidentEdgeSet<N> {
            ...
            public UnmodifiableIterator<EndpointPair<N>> iterator() {
                ...
                }), Iterators.transform(Sets.difference(this.graph.successors(this.node), ImmutableSet.m1926of(this.node)).iterator(), new Function<N, EndpointPair<N>>() {
                    public EndpointPair<N> apply(N n) {
        ...
        /* renamed from: of */
        public static <N> IncidentEdgeSet<N> m1978of(BaseGraph<N> baseGraph, N n) {
    ...
    public Set<EndpointPair<N>> edges() {
        return new AbstractSet<EndpointPair<N>>() {
            public UnmodifiableIterator<EndpointPair<N>> iterator() {
                return EndpointPairIterator.m1984of(AbstractBaseGraph.this);
            }
    ...
    public Set<EndpointPair<N>> incidentEdges(N n) {
        ...
        return IncidentEdgeSet.m1978of(this, n);
    }

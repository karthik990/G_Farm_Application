...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.m1983of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m1980of();
            }
            return DirectedNetworkConnections.m1981of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m1986of();
        } else {
            return UndirectedNetworkConnections.m1987of();
        }
    }
}

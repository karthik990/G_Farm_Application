...
public final class Collections2 {
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list2) {
            ...
            int size = list2.size();
            this.f1957c = new int[size];
            this.f1959o = new int[size];
            Arrays.fill(this.f1957c, 0);
            Arrays.fill(this.f1959o, 1);
        }
        ...
        /* access modifiers changed from: 0000 */
        public void calculateNextPermutation() {
            this.f1958j = this.list.size() - 1;
            if (this.f1958j != -1) {
                int i = 0;
                while (true) {
                    int[] iArr = this.f1957c;
                    int i2 = this.f1958j;
                    int i3 = iArr[i2] + this.f1959o[i2];
                    if (i3 >= 0) {
                        if (i3 != i2 + 1) {
                            Collections.swap(this.list, (i2 - iArr[i2]) + i, (i2 - i3) + i);
                            this.f1957c[this.f1958j] = i3;
                            break;
                        } else if (i2 == 0) {
                            break;
                        } else {

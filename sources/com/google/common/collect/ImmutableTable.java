...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public static final class Builder<R, C, V> {
        ...
        public Builder<R, C, V> put(Cell<? extends R, ? extends C, ? extends V> cell) {
            if (cell instanceof ImmutableCell) {
                ...
                Preconditions.checkNotNull(cell.getValue(), Param.VALUE);
                this.cells.add(cell);
            } else {
    ...
    static final class SerializedForm implements Serializable {
        ...
        public Object readResolve() {
            ...
            int i = 0;
            if (objArr.length == 1) {
                return ImmutableTable.m1977of(this.rowKeys[0], this.columnKeys[0], objArr[0]);
            }
    ...
    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m1976of() {
        return SparseImmutableTable.EMPTY;
    }

    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m1977of(R r, C c, V v) {
    ...
    static <R, C, V> Cell<R, C, V> cellOf(R r, C c, V v) {
        return Tables.immutableCell(Preconditions.checkNotNull(r, "rowKey"), Preconditions.checkNotNull(c, "columnKey"), Preconditions.checkNotNull(v, Param.VALUE));
    }
    ...
    public ImmutableMap<R, V> column(C c) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(c), ImmutableMap.m1902of());
    }
    ...
    public ImmutableMap<C, V> row(R r) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(r), ImmutableMap.m1902of());
    }

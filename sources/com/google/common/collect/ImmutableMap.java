...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>> {
        ...
        public ImmutableSet<V> get(@NullableDecl Object obj) {
            ...
            return ImmutableSet.m1926of(obj2);
        }
                ...
                public Entry<K, ImmutableSet<V>> next() {
                    ...
                    return new AbstractMapEntry<K, ImmutableSet<V>>() {
                        ...
                        public ImmutableSet<V> getValue() {
                            return ImmutableSet.m1926of(entry.getValue());
                        }
                    };
                }
            };
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1902of() {
        return RegularImmutableMap.EMPTY;
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1903of(K k, V v) {
        CollectPreconditions.checkEntryNotNull(k, v);
        return RegularImmutableMap.create(1, new Object[]{k, v});
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1904of(K k, V v, K k2, V v2) {
        CollectPreconditions.checkEntryNotNull(k, v);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1905of(K k, V v, K k2, V v2, K k3, V v3) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1906of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1907of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        CollectPreconditions.checkEntryNotNull(k, v);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    public ImmutableSetMultimap<K, V> asMultimap() {
        if (isEmpty()) {
            return ImmutableSetMultimap.m1932of();
        }

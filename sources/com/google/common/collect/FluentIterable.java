...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return (Iterable) this.iterableDelegate.mo43411or(this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m1873of() {
        return from((Iterable<E>) ImmutableList.m1883of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m1874of(@NullableDecl E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m1776of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m1776of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m1776of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m1776of(next);
    }

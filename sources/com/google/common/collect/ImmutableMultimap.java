...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m1908of() {
        return ImmutableListMultimap.m1896of();
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m1909of(K k, V v) {
        return ImmutableListMultimap.m1897of(k, v);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m1910of(K k, V v, K k2, V v2) {
        return ImmutableListMultimap.m1898of(k, v, k2, v2);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m1911of(K k, V v, K k2, V v2, K k3, V v3) {
        return ImmutableListMultimap.m1899of(k, v, k2, v2, k3, v3);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m1912of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4) {
        return ImmutableListMultimap.m1900of(k, v, k2, v2, k3, v3, k4, v4);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMultimap<K, V> m1913of(K k, V v, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        return ImmutableListMultimap.m1901of(k, v, k2, v2, k3, v3, k4, v4, k5, v5);
    }

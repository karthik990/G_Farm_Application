...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        public V getValue(int i) {
            return ArrayTable.this.mo44978at(i, this.columnIndex);
        }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        /* access modifiers changed from: 0000 */
        public V getValue(int i) {
            return ArrayTable.this.mo44978at(this.rowIndex, i);
        }
    ...
    /* renamed from: at */
    public V mo44978at(int i, int i2) {
    ...
    public V get(@NullableDecl Object obj, @NullableDecl Object obj2) {
        ...
        return mo44978at(num.intValue(), num2.intValue());
    }
    ...
    public Cell<R, C, V> getCell(final int i) {
        return new AbstractCell<R, C, V>() {
            ...
            public V getValue() {
                return ArrayTable.this.mo44978at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    /* access modifiers changed from: private */
    public V getValue(int i) {
        return mo44978at(i / this.columnList.size(), i % this.columnList.size());
    }

    public Map<R, V> column(C c) {
        Preconditions.checkNotNull(c);
        Integer num = (Integer) this.columnKeyToIndex.get(c);
        return num == null ? ImmutableMap.m1902of() : new Column(num.intValue());
    }
    ...
    public Map<C, V> row(R r) {
        Preconditions.checkNotNull(r);
        Integer num = (Integer) this.rowKeyToIndex.get(r);
        return num == null ? ImmutableMap.m1902of() : new Row(num.intValue());
    }

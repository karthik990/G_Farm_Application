...
public final class ImmutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    private static final ImmutableClassToInstanceMap<Object> EMPTY = new ImmutableClassToInstanceMap<>(ImmutableMap.m1902of());
    ...
    public static final class Builder<B> {
        ...
        public ImmutableClassToInstanceMap<B> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableClassToInstanceMap.m1881of();
            }
    ...
    /* renamed from: of */
    public static <B> ImmutableClassToInstanceMap<B> m1881of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <B, T extends B> ImmutableClassToInstanceMap<B> m1882of(Class<T> cls, T t) {
        return new ImmutableClassToInstanceMap<>(ImmutableMap.m1903of(cls, t));
    }

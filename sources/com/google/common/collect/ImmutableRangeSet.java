...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m1884of(Range.all()));
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m1883of());
    @LazyInit
    ...
    private final class AsSet extends ImmutableSortedSet<C> {
        ...
        public ImmutableSortedSet<C> subSetImpl(C c, boolean z, C c2, boolean z2) {
            ...
            return ImmutableSortedSet.m1963of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (build.isEmpty()) {
                return ImmutableRangeSet.m1923of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        public Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m1884of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
    ...
    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m1923of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m1924of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m1884of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.isEmpty()) {
            ...
            ImmutableRangeSet<C> of = m1923of();
            this.complement = of;
            return of;
        }
    }

...
public abstract class AbstractIterator<T> extends UnmodifiableIterator<T> {
    ...
    static /* synthetic */ class C30451 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.AbstractIterator.C30451.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        ...
        int i = C30451.$SwitchMap$com$google$common$collect$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return false;
        }
        if (i != 2) {

...
public final class Range<C extends Comparable> extends RangeGwtSerializationDependencies implements Predicate<C>, Serializable {
    ...
    static /* synthetic */ class C31911 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.Range.C31911.<clinit>():void");
        }
    }
    ...
    public static <C extends Comparable<?>> Range<C> upTo(C c, BoundType boundType) {
        int i = C31911.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()];
        if (i == 1) {
            return lessThan(c);
        }
        if (i == 2) {

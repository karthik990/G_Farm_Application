...
final class TweetTextLinkifier {
    ...
    static List<FormattedUrlEntity> mergeAndSortEntities(List<FormattedUrlEntity> list, List<FormattedMediaEntity> list2, List<FormattedUrlEntity> list3, List<FormattedUrlEntity> list4, List<FormattedUrlEntity> list5) {
        ...
        Collections.sort(arrayList, $$Lambda$TweetTextLinkifier$lprK0wbRLYp22YtUkb5dhr9jYeU.INSTANCE);
        return arrayList;
    }

    static /* synthetic */ int lambda$mergeAndSortEntities$0(FormattedUrlEntity formattedUrlEntity, FormattedUrlEntity formattedUrlEntity2) {
            ...
            for (final FormattedUrlEntity formattedUrlEntity2 : list) {
                ...
                if (i4 >= 0 && i5 <= spannableStringBuilder.length()) {
                    if (formattedUrlEntity != null && formattedUrlEntity.start == formattedUrlEntity2.start) {
                        ...
                        C52441 r2 = new ClickableLinkSpan(i2, i, false) {
                            public void onClick(View view) {
                                LinkClickListener linkClickListener = linkClickListener2;
                                if (linkClickListener != null) {
                                    linkClickListener.onUrlClicked(formattedUrlEntity2.url);
                                }
                            }
                        };
    ...
    static boolean isPhotoEntity(FormattedUrlEntity formattedUrlEntity) {
        if (formattedUrlEntity instanceof FormattedMediaEntity) {
            if ("photo".equals(((FormattedMediaEntity) formattedUrlEntity).type)) {
                return true;
            }
        }
        return false;

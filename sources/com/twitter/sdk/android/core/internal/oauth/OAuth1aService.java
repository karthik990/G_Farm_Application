...
public class OAuth1aService extends OAuthService {
    ...
    public String buildCallbackUrl(TwitterAuthConfig twitterAuthConfig) {
        return Uri.parse(CALLBACK_URL).buildUpon().appendQueryParameter(ClientCookie.VERSION_ATTR, getTwitterCore().getVersion()).appendQueryParameter(SettingsJsonConstants.APP_KEY, twitterAuthConfig.getConsumerKey()).build().toString();
    }
    ...
    public String getAuthorizeUrl(TwitterAuthToken twitterAuthToken) {
        return getApi().buildUponBaseHostUrl(RESOURCE_OAUTH, PayPalRequest.INTENT_AUTHORIZE).appendQueryParameter(OAuthConstants.PARAM_TOKEN, twitterAuthToken.token).build().toString();
    }
    ...
    public static OAuthResponse parseAuthResponse(String str) {
        ...
        String str4 = (String) queryParams.get(PARAM_SCREEN_NAME);
        String str5 = PARAM_USER_ID;
        long parseLong = queryParams.containsKey(str5) ? Long.parseLong((String) queryParams.get(str5)) : 0;
        ...
        return new Callback<ResponseBody>() {
            ...
            public void success(com.twitter.sdk.android.core.Result<okhttp3.ResponseBody> r5) {
                ...
                L_0x006f:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.twitter.sdk.android.core.internal.oauth.OAuth1aService.C52211.success(com.twitter.sdk.android.core.Result):void");
            }

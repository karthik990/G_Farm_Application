...
class OAuthController implements Listener {
    ...
    public void startAuth() {
        Twitter.getLogger().mo20817d("Twitter", "Obtaining request token to start the sign in flow");
    ...
    public Callback<OAuthResponse> newRequestTempTokenCallback() {
        return new Callback<OAuthResponse>() {
            public void success(Result<OAuthResponse> result) {
                ...
                Twitter.getLogger().mo20817d("Twitter", "Redirecting user to web view to complete authorization flow");
            ...
            public void failure(TwitterException twitterException) {
                String str = "Failed to get request token";
                Twitter.getLogger().mo20820e("Twitter", str, twitterException);
                OAuthController.this.handleAuthError(1, new TwitterAuthException(str));
            }
        };
    }
    ...
    private void handleWebViewSuccess(Bundle bundle) {
        String str = "Twitter";
        Twitter.getLogger().mo20817d(str, "OAuth web view completed successfully");
        if (bundle != null) {
            String string = bundle.getString(OAuthConstants.PARAM_VERIFIER);
            if (string != null) {
                Twitter.getLogger().mo20817d(str, "Converting the request token to an access token.");
        ...
        sb.append(bundle);
        logger.mo20820e(str, sb.toString(), null);
    ...
    private void handleWebViewError(WebViewException webViewException) {
        String str = "OAuth web view completed with an error";
        Twitter.getLogger().mo20820e("Twitter", str, webViewException);
        handleAuthError(1, new TwitterAuthException(str));
    }

...
public class ExpandableLayout extends FrameLayout {
    ...
    private class ExpansionListener implements AnimatorListener {
    ...
    public ExpandableLayout(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C4290R.styleable.ExpandableLayout);
    ...
    private void animateSize(int i) {
        ...
        this.animator = ValueAnimator.ofFloat(new float[]{this.expansion, (float) i});

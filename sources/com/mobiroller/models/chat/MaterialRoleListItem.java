...
public class MaterialRoleListItem {
    ...
    public static class Builder {
        ...
        /* renamed from: id */
        public Builder mo56892id(long j) {
            this.f2175id = j;
            return this;
        }
        ...
        public MaterialRoleListItem build() {
            return new MaterialRoleListItem(this);
        }
    }

    private MaterialRoleListItem(Builder builder2) {

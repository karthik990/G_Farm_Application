...
public final class JsonStringEncoder {
    ...
    /* renamed from: HB */
    private static final byte[] f268HB = CharTypes.copyHexBytes();

    /* renamed from: HC */
    private static final char[] f269HC = CharTypes.copyHexChars();
    ...
    public char[] quoteAsString(java.lang.String r12) {
        ...
        L_0x000c:
            ...
            int[] r2 = com.fasterxml.jackson.core.p036io.CharTypes.get7BitOutputEscapes()
            int r3 = r2.length
            int r4 = r12.length()
            r5 = 0
            r6 = r1
        ...
        L_0x0076:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.p036io.JsonStringEncoder.quoteAsString(java.lang.String):char[]");
    }
    ...
    public void quoteAsString(java.lang.CharSequence r8, java.lang.StringBuilder r9) {
        /*
            r7 = this;
            int[] r0 = com.fasterxml.jackson.core.p036io.CharTypes.get7BitOutputEscapes()
            int r1 = r0.length
            int r2 = r8.length()
            r3 = 0
            r4 = 0
        ...
        L_0x003c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.p036io.JsonStringEncoder.quoteAsString(java.lang.CharSequence, java.lang.StringBuilder):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:39:0x009b, code lost:
        r7 = r5 + 1;
        r4[r5] = (byte) ((r2 >> 18) | com.google.android.exoplayer2.extractor.p040ts.PsExtractor.VIDEO_STREAM_MASK);
     */
    ...
    public byte[] quoteAsUTF8(java.lang.String r11) {
        ...
        L_0x0018:
            ...
            int[] r6 = com.fasterxml.jackson.core.p036io.CharTypes.get7BitOutputEscapes()
        L_0x001e:
        ...
        L_0x0101:
            ...
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.p036io.JsonStringEncoder.quoteAsUTF8(java.lang.String):byte[]");
    }
    ...
    private int _appendByte(int i, int i2, ByteArrayBuilder byteArrayBuilder, int i3) {
        ...
        if (i2 < 0) {
            ...
            if (i > 255) {
                int i4 = i >> 8;
                byteArrayBuilder.append(f268HB[i4 >> 4]);
                byteArrayBuilder.append(f268HB[i4 & 15]);
                i &= 255;
            } else {
                byteArrayBuilder.append(48);
                byteArrayBuilder.append(48);
            }
            byteArrayBuilder.append(f268HB[i >> 4]);
            byteArrayBuilder.append(f268HB[i & 15]);
        } else {

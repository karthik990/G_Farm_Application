...
import com.fasterxml.jackson.core.p036io.CharacterEscapes;
...
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    static /* synthetic */ class C13091 {
        ...
        static final /* synthetic */ int[] f264xa51b40dc = new int[Inclusion.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f264xa51b40dc = r0
                int[] r0 = f264xa51b40dc     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f264xa51b40dc     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f264xa51b40dc     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f264xa51b40dc     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r0 = f264xa51b40dc     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.core.JsonGenerator.C13091.<clinit>():void");
        }
    }
    ...
    public WritableTypeId writeTypePrefix(WritableTypeId writableTypeId) throws IOException {
        Object obj = writableTypeId.f283id;
        ...
        if (canWriteTypeId()) {
            ...
            int i = C13091.f264xa51b40dc[inclusion.ordinal()];
            if (!(i == 1 || i == 2)) {
                if (i == 3) {
    ...
    public WritableTypeId writeTypeSuffix(WritableTypeId writableTypeId) throws IOException {
        ...
        if (writableTypeId.wrapperWritten) {
            int i = C13091.f264xa51b40dc[writableTypeId.include.ordinal()];
            if (i == 1) {
                Object obj = writableTypeId.f283id;
    ...
    public void copyCurrentStructure(JsonParser jsonParser) throws IOException {
        ...
        int id = currentToken.mo15042id();
        if (id == 5) {
            writeFieldName(jsonParser.getCurrentName());
            id = jsonParser.nextToken().mo15042id();
        }
        if (id == 1) {
            writeStartObject();

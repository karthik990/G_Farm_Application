...
public final class ImageHeaderParserUtils {
    ...
    private interface TypeReader {
        ImageType getType(ImageHeaderParser imageHeaderParser) throws IOException;
    }

    private ImageHeaderParserUtils() {
    }

    public static ImageType getType(List<ImageHeaderParser> list, final InputStream inputStream, ArrayPool arrayPool) throws IOException {
        if (inputStream == null) {
    ...
    public static ImageType getType(List<ImageHeaderParser> list, final ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer == null) {
            return ImageType.UNKNOWN;
        }
        return getTypeInternal(list, new TypeReader() {
    ...
    public static ImageType getType(List<ImageHeaderParser> list, final ParcelFileDescriptorRewinder parcelFileDescriptorRewinder, final ArrayPool arrayPool) throws IOException {
        return getTypeInternal(list, new TypeReader() {
            ...
            public com.bumptech.glide.load.ImageHeaderParser.ImageType getType(com.bumptech.glide.load.ImageHeaderParser r5) throws java.io.IOException {
                ...
                L_0x002d:
                    ...
                    throw r5
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.ImageHeaderParserUtils.C11693.getType(com.bumptech.glide.load.ImageHeaderParser):com.bumptech.glide.load.ImageHeaderParser$ImageType");
            }
        });
    }

    private static ImageType getTypeInternal(List<ImageHeaderParser> list, TypeReader typeReader) throws IOException {
        int size = list.size();
        ...
        return getOrientationInternal(list, new OrientationReader() {
            ...
            public int getOrientation(com.bumptech.glide.load.ImageHeaderParser r5) throws java.io.IOException {
                ...
                L_0x002f:
                    ...
                    throw r5
                */
                throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.ImageHeaderParserUtils.C11715.getOrientation(com.bumptech.glide.load.ImageHeaderParser):int");
            }
        });
    }

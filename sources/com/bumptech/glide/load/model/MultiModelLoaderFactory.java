...
public class MultiModelLoaderFactory {
    ...
    static class Factory {
        ...
        public <Model, Data> MultiModelLoader<Model, Data> build(List<ModelLoader<Model, Data>> list, Pool<List<Throwable>> pool) {
    ...
    MultiModelLoaderFactory(Pool<List<Throwable>> pool, Factory factory2) {

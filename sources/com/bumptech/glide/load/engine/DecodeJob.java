...
class DecodeJob<R> implements FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, Poolable {
    ...
    static /* synthetic */ class C11771 {
        ...
        static {
            ...
            L_0x0084:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.DecodeJob.C11771.<clinit>():void");
        }
    }
    ...
    private void runWrapped() {
        int i = C11771.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C11771.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage stage2) {
        Stage stage3;
        Stage stage4;
        int i = C11771.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage2.ordinal()];
        if (i == 1) {
            if (this.diskCacheStrategy.decodeCachedData()) {
                stage3 = Stage.DATA_CACHE;
            } else {
                stage3 = getNextStage(Stage.DATA_CACHE);
            }
            return stage3;
        } else if (i == 2) {
            ...
            if (i == 5) {
                if (this.diskCacheStrategy.decodeCachedResource()) {
                    stage4 = Stage.RESOURCE_CACHE;
                } else {
                    stage4 = getNextStage(Stage.RESOURCE_CACHE);
                }
                return stage4;
            }
            StringBuilder sb = new StringBuilder();
    ...
    public <Z> com.bumptech.glide.load.engine.Resource<Z> onResourceDecoded(com.bumptech.glide.load.DataSource r12, com.bumptech.glide.load.engine.Resource<Z> r13) {
        ...
        L_0x0042:
            ...
            int[] r12 = com.bumptech.glide.load.engine.DecodeJob.C11771.$SwitchMap$com$bumptech$glide$load$EncodeStrategy
            int r1 = r13.ordinal()
            r12 = r12[r1]

...
public class LoadPath<Data, ResourceType, Transcode> {
    ...
    private Resource<Transcode> loadWithExceptionList(DataRewinder<Data> dataRewinder, Options options, int i, int i2, DecodeCallback<ResourceType> decodeCallback, List<Throwable> list) throws GlideException {

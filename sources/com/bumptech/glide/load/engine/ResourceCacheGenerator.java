...
class ResourceCacheGenerator implements DataFetcherGenerator, DataCallback<Object> {
    ...
    /* renamed from: cb */
    private final FetcherReadyCallback f252cb;
    ...
    ResourceCacheGenerator(DecodeHelper<?> decodeHelper, FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f252cb = fetcherReadyCallback;
    }
    ...
    public void onDataReady(Object obj) {
        this.f252cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE, this.currentKey);
    }

    public void onLoadFailed(Exception exc) {
        this.f252cb.onDataFetcherFailed(this.currentKey, exc, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE);
    }
}

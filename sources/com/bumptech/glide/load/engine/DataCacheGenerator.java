...
class DataCacheGenerator implements DataFetcherGenerator, DataCallback<Object> {
    ...
    /* renamed from: cb */
    private final FetcherReadyCallback f247cb;
    ...
    DataCacheGenerator(List<Key> list, DecodeHelper<?> decodeHelper, FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f247cb = fetcherReadyCallback;
    }
    ...
    public void onDataReady(Object obj) {
        this.f247cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.DATA_DISK_CACHE, this.sourceKey);
    }

    public void onLoadFailed(Exception exc) {
        this.f247cb.onDataFetcherFailed(this.sourceKey, exc, this.loadData.fetcher, DataSource.DATA_DISK_CACHE);
    }
}

...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    static /* synthetic */ class C11871 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C11871.<clinit>():void");
        }
    }
    ...
    private static Config[] getInConfigs(Config config) {
        ...
        int i = C11871.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {

...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f244ix = readShort();
        this.header.currentFrame.f245iy = readShort();
        this.header.currentFrame.f243iw = readShort();
        this.header.currentFrame.f242ih = readShort();
        int read = read();
        boolean z = false;

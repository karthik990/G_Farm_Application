...
public final class Util {
    ...
    static /* synthetic */ class C12221 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util.C12221.<clinit>():void");
        }
    }
    ...
    private static int getBytesPerPixel(Config config) {
        ...
        int i = C12221.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {

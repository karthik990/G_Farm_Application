...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f239CR = 13;

    /* renamed from: LF */
    private static final byte f240LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f241in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f241in) {
            if (this.buf != null) {
                ...
                C11651 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f241in;
        byte[] bArr = this.buf;

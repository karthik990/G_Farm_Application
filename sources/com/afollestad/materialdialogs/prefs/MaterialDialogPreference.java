...
public class MaterialDialogPreference extends DialogPreference {
    ...
    static /* synthetic */ class C08572 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.afollestad.materialdialogs.prefs.MaterialDialogPreference.C08572.<clinit>():void");
        }
    }
    ...
    public void showDialog(Bundle bundle) {
        Builder autoDismiss = new Builder(this.context).title(getDialogTitle()).icon(getDialogIcon()).dismissListener(this).onAny(new SingleButtonCallback() {
            public void onClick(MaterialDialog materialDialog, DialogAction dialogAction) {
                int i = C08572.$SwitchMap$com$afollestad$materialdialogs$DialogAction[dialogAction.ordinal()];
                if (i == 1) {

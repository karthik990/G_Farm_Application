...
public class MaterialEditTextPreference extends EditTextPreference {
    ...
    static /* synthetic */ class C08602 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.afollestad.materialdialogs.prefs.MaterialEditTextPreference.C08602.<clinit>():void");
        }
    }
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        this.color = DialogUtils.resolveColor(context, C0841R.attr.md_widget_color, DialogUtils.resolveColor(context, C0841R.attr.colorAccent, VERSION.SDK_INT >= 21 ? DialogUtils.resolveColor(context, 16843829) : 0));
    ...
    public void onAddEditTextToDialogView(View view, EditText editText2) {
        ((ViewGroup) view).addView(editText2, new LayoutParams(-1, -2));
    }
    ...
    public void showDialog(Bundle bundle) {
        Builder dismissListener = new Builder(getContext()).title(getDialogTitle()).icon(getDialogIcon()).positiveText(getPositiveButtonText()).negativeText(getNegativeButtonText()).dismissListener(this).onAny(new SingleButtonCallback() {
            public void onClick(MaterialDialog materialDialog, DialogAction dialogAction) {
                int i = C08602.$SwitchMap$com$afollestad$materialdialogs$DialogAction[dialogAction.ordinal()];
                if (i == 1) {
        ...
        View inflate = LayoutInflater.from(getContext()).inflate(C0841R.layout.md_stub_inputpref, null);

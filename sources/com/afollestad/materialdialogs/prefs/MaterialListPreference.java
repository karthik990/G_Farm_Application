...
public class MaterialListPreference extends ListPreference {
    ...
    static /* synthetic */ class C08643 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.afollestad.materialdialogs.prefs.MaterialListPreference.C08643.<clinit>():void");
        }
    }
    ...
    public void showDialog(Bundle bundle) {
        ...
        Builder itemsCallbackSingleChoice = new Builder(this.context).title(getDialogTitle()).icon(getDialogIcon()).dismissListener(this).onAny(new SingleButtonCallback() {
            public void onClick(MaterialDialog materialDialog, DialogAction dialogAction) {
                int i = C08643.$SwitchMap$com$afollestad$materialdialogs$DialogAction[dialogAction.ordinal()];
                if (i == 1) {

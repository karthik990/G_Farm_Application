...
public class DialogUtils {
    ...
    static /* synthetic */ class C08722 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.afollestad.materialdialogs.util.DialogUtils.C08722.<clinit>():void");
        }
    }
    ...
    private static int gravityEnumToAttrInt(GravityEnum gravityEnum) {
        int i = C08722.$SwitchMap$com$afollestad$materialdialogs$GravityEnum[gravityEnum.ordinal()];
        int i2 = 1;
        if (i != 1) {
            i2 = 2;
            if (i != 2) {
    ...
    public static void showKeyboard(DialogInterface dialogInterface, final Builder builder) {
    ...
    public static void hideKeyboard(DialogInterface dialogInterface, Builder builder) {

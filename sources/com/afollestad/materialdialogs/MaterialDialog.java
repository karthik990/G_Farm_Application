...
public class MaterialDialog extends DialogBase implements OnClickListener, InternalListCallback {
    ...
    static /* synthetic */ class C08284 {
        ...
        static final /* synthetic */ int[] f71x59373eeb = new int[ListType.values().length];
        ...
        static {
            /*
                ...
                f71x59373eeb = r0
                r0 = 1
                int[] r1 = f71x59373eeb     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f71x59373eeb     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                r2 = 3
                int[] r3 = f71x59373eeb     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x0051:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.afollestad.materialdialogs.MaterialDialog.C08284.<clinit>():void");
        }
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context2) {
            ...
            this.widgetColor = DialogUtils.resolveColor(context2, C0829R.attr.colorAccent, DialogUtils.getColor(context2, C0829R.C0830color.md_material_blue_600));
            ...
            this.linkColor = DialogUtils.getActionTextStateList(context2, DialogUtils.resolveColor(context2, C0829R.attr.md_link_color, this.widgetColor));
            this.buttonRippleColor = DialogUtils.resolveColor(context2, C0829R.attr.md_btn_ripple_color, DialogUtils.resolveColor(context2, C0829R.attr.colorControlHighlight, VERSION.SDK_INT >= 21 ? DialogUtils.resolveColor(context2, 16843820) : 0));
            this.progressPercentFormat = NumberFormat.getPercentInstance();
            this.progressNumberFormat = "%1d/%2d";
            this.theme = DialogUtils.isColorDark(DialogUtils.resolveColor(context2, 16842806)) ? Theme.LIGHT : Theme.DARK;
            checkSingleton();
            this.titleGravity = DialogUtils.resolveGravityEnum(context2, C0829R.attr.md_title_gravity, this.titleGravity);
            this.contentGravity = DialogUtils.resolveGravityEnum(context2, C0829R.attr.md_content_gravity, this.contentGravity);
            this.btnStackedGravity = DialogUtils.resolveGravityEnum(context2, C0829R.attr.md_btnstacked_gravity, this.btnStackedGravity);
            this.itemsGravity = DialogUtils.resolveGravityEnum(context2, C0829R.attr.md_items_gravity, this.itemsGravity);
            this.buttonsGravity = DialogUtils.resolveGravityEnum(context2, C0829R.attr.md_buttons_gravity, this.buttonsGravity);
            typeface(DialogUtils.resolveString(context2, C0829R.attr.md_medium_font), DialogUtils.resolveString(context2, C0829R.attr.md_regular_font));
            Typeface typeface = this.mediumFont;
            String str = C1996C.SANS_SERIF_NAME;
            if (typeface == null) {
                try {
                    if (VERSION.SDK_INT >= 21) {
                        this.mediumFont = Typeface.create("sans-serif-medium", 0);
                    } else {
                        this.mediumFont = Typeface.create(str, 1);
                    }
            ...
            if (this.regularFont == null) {
                try {
                    this.regularFont = Typeface.create(str, 0);
        ...
        public Builder typeface(String str, String str2) {
            String str3 = "No font asset found for ";
            if (str != null) {
        ...
        public Builder content(int i, boolean z) {
            ...
            if (z) {
                text = Html.fromHtml(text.toString().replace(Constants.NEW_LINE, "<br/>"));
            }
            return content(text);
        }
        ...
        public Builder content(int i, Object... objArr) {
            return content((CharSequence) Html.fromHtml(String.format(this.context.getString(i), objArr).replace(Constants.NEW_LINE, "<br/>")));
        }
        ...
        public com.afollestad.materialdialogs.MaterialDialog.Builder items(java.util.Collection<java.lang.Object> r4) {
            /*
                r3 = this;
                int r0 = r4.size()
        ...
        public Builder btnSelector(int i, DialogAction dialogAction) {
            int i2 = C08284.$SwitchMap$com$afollestad$materialdialogs$DialogAction[dialogAction.ordinal()];
            if (i2 == 1) {
                this.btnSelectorNeutral = i;
            } else if (i2 != 2) {
                this.btnSelectorPositive = i;
        ...
        public Builder checkBoxPrompt(CharSequence charSequence, boolean z, OnCheckedChangeListener onCheckedChangeListener) {
        ...
        public Builder checkBoxPromptRes(int i, boolean z, OnCheckedChangeListener onCheckedChangeListener) {
        ...
        public Builder adapter(Adapter<?> adapter2, LayoutManager layoutManager2) {
            if (this.customView != null) {
        ...
        public Builder keyListener(OnKeyListener onKeyListener) {
        ...
        public Builder inputRange(int i, int i2, int i3) {
            if (i >= 0) {
                ...
                if (i3 == 0) {
                    this.inputRangeErrorColor = DialogUtils.getColor(this.context, C0829R.C0830color.md_edittext_error);
                } else {
    ...
    enum ListType {
        ...
        public static int getLayoutForType(ListType listType) {
            int i = C08284.f71x59373eeb[listType.ordinal()];
            if (i == 1) {
                return C0829R.layout.md_listitem;
            }
            if (i == 2) {
                return C0829R.layout.md_listitem_singlechoice;
            }
            if (i == 3) {
                return C0829R.layout.md_listitem_multichoice;
            }
    ...
    protected MaterialDialog(Builder builder2) {
        ...
        this.view = (MDRootLayout) LayoutInflater.from(builder2.context).inflate(DialogInit.getInflateLayout(builder2), null);
    ...
    public final void checkIfListInitScroll() {
        ...
        if (recyclerView2 != null) {
            recyclerView2.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
    ...
    public boolean onItemSelected(MaterialDialog materialDialog, View view, int i, CharSequence charSequence, boolean z) {
        ...
        if (listType2 == null || listType2 == ListType.REGULAR) {
            ...
            if (!z && this.builder.listCallback != null) {
                this.builder.listCallback.onSelection(this, view, i, (CharSequence) this.builder.items.get(i));
            }
            if (z && this.builder.listLongCallback != null) {
                return this.builder.listLongCallback.onLongSelection(this, view, i, (CharSequence) this.builder.items.get(i));
            }
        } else if (this.listType == ListType.MULTI) {
            CheckBox checkBox = (CheckBox) view.findViewById(C0829R.C0832id.md_control);
            ...
            RadioButton radioButton = (RadioButton) view.findViewById(C0829R.C0832id.md_control);
    ...
    public final Drawable getListSelector() {
        ...
        Drawable resolveDrawable = DialogUtils.resolveDrawable(this.builder.context, C0829R.attr.md_list_selector);
        if (resolveDrawable != null) {
            return resolveDrawable;
        }
        return DialogUtils.resolveDrawable(getContext(), C0829R.attr.md_list_selector);
    }
    ...
    public Drawable getButtonSelector(DialogAction dialogAction, boolean z) {
        if (!z) {
            int i = C08284.$SwitchMap$com$afollestad$materialdialogs$DialogAction[dialogAction.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    ...
                    Drawable resolveDrawable = DialogUtils.resolveDrawable(this.builder.context, C0829R.attr.md_btn_positive_selector);
                    if (resolveDrawable != null) {
                        return resolveDrawable;
                    }
                    Drawable resolveDrawable2 = DialogUtils.resolveDrawable(getContext(), C0829R.attr.md_btn_positive_selector);
                    if (VERSION.SDK_INT >= 21) {
                    ...
                    Drawable resolveDrawable3 = DialogUtils.resolveDrawable(this.builder.context, C0829R.attr.md_btn_negative_selector);
                    if (resolveDrawable3 != null) {
                        return resolveDrawable3;
                    }
                    Drawable resolveDrawable4 = DialogUtils.resolveDrawable(getContext(), C0829R.attr.md_btn_negative_selector);
                    if (VERSION.SDK_INT >= 21) {
                ...
                Drawable resolveDrawable5 = DialogUtils.resolveDrawable(this.builder.context, C0829R.attr.md_btn_neutral_selector);
                if (resolveDrawable5 != null) {
                    return resolveDrawable5;
                }
                Drawable resolveDrawable6 = DialogUtils.resolveDrawable(getContext(), C0829R.attr.md_btn_neutral_selector);
                if (VERSION.SDK_INT >= 21) {
            ...
            Drawable resolveDrawable7 = DialogUtils.resolveDrawable(this.builder.context, C0829R.attr.md_btn_stacked_selector);
            if (resolveDrawable7 != null) {
                return resolveDrawable7;
            }
            return DialogUtils.resolveDrawable(getContext(), C0829R.attr.md_btn_stacked_selector);
        }
    }
    ...
    private boolean sendSingleChoiceCallback(View view) {
        ...
        if (this.builder.selectedIndex >= 0 && this.builder.selectedIndex < this.builder.items.size()) {
            charSequence = (CharSequence) this.builder.items.get(this.builder.selectedIndex);
        }

...
public class MDRootLayout extends ViewGroup {
    ...
    private OnScrollChangedListener bottomOnScrollChangedListener;
    ...
    private OnScrollChangedListener topOnScrollChangedListener;
    ...
    static /* synthetic */ class C08554 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.afollestad.materialdialogs.internal.MDRootLayout.C08554.<clinit>():void");
        }
    }
    ...
    private void init(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0829R.styleable.MDRootLayout, i, 0);
        this.reducePaddingNoTitleNoButtons = obtainStyledAttributes.getBoolean(C0829R.styleable.MDRootLayout_md_reduce_padding_no_title_no_buttons, true);
        obtainStyledAttributes.recycle();
        this.noTitlePaddingFull = resources.getDimensionPixelSize(C0829R.dimen.md_notitle_vertical_padding);
        this.buttonPaddingFull = resources.getDimensionPixelSize(C0829R.dimen.md_button_frame_vertical_padding);
        this.buttonHorizontalEdgeMargin = resources.getDimensionPixelSize(C0829R.dimen.md_button_padding_frame_side);
        this.buttonBarHeight = resources.getDimensionPixelSize(C0829R.dimen.md_button_height);
        this.dividerPaint = new Paint();
        this.dividerWidth = resources.getDimensionPixelSize(C0829R.dimen.md_divider_height);
        this.dividerPaint.setColor(DialogUtils.resolveColor(context, C0829R.attr.md_divider_color));
    ...
    public void onFinishInflate() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt.getId() == C0829R.C0832id.md_titleFrame) {
                this.titleBar = childAt;
            } else if (childAt.getId() == C0829R.C0832id.md_buttonDefaultNeutral) {
                this.buttons[0] = (MDButton) childAt;
            } else if (childAt.getId() == C0829R.C0832id.md_buttonDefaultNegative) {
                this.buttons[1] = (MDButton) childAt;
            } else if (childAt.getId() == C0829R.C0832id.md_buttonDefaultPositive) {
    ...
    public void onMeasure(int r12, int r13) {
        ...
        L_0x0043:
            ...
            int r4 = com.afollestad.materialdialogs.C0829R.dimen.md_neutral_button_margin
    ...
    private void invertGravityIfNecessary() {
        if (VERSION.SDK_INT >= 17 && getResources().getConfiguration().getLayoutDirection() == 1) {
            int i = C08554.$SwitchMap$com$afollestad$materialdialogs$GravityEnum[this.buttonGravity.ordinal()];
            if (i == 1) {
    ...
    public void addScrollListener(final ViewGroup viewGroup, final boolean z, final boolean z2) {
        if ((!z2 && this.topOnScrollChangedListener == null) || (z2 && this.bottomOnScrollChangedListener == null)) {
            if (viewGroup instanceof RecyclerView) {
                C08532 r0 = new OnScrollListener() {
            ...
            C08543 r02 = new OnScrollChangedListener() {

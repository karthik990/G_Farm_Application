...
public class MaterialSearchView extends FrameLayout implements FilterListener {
    ...
    private void initStyle(AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, C3867R.styleable.MaterialSearchView, i, 0);
        if (obtainStyledAttributes != null) {
            if (obtainStyledAttributes.hasValue(C3867R.styleable.MaterialSearchView_searchBackground)) {
                setBackground(obtainStyledAttributes.getDrawable(C3867R.styleable.MaterialSearchView_searchBackground));
            }
            if (obtainStyledAttributes.hasValue(C3867R.styleable.MaterialSearchView_android_textColor)) {
                setTextColor(obtainStyledAttributes.getColor(C3867R.styleable.MaterialSearchView_android_textColor, 0));
            }
            if (obtainStyledAttributes.hasValue(C3867R.styleable.MaterialSearchView_android_textColorHint)) {
                setHintTextColor(obtainStyledAttributes.getColor(C3867R.styleable.MaterialSearchView_android_textColorHint, 0));
            }
            if (obtainStyledAttributes.hasValue(C3867R.styleable.MaterialSearchView_android_hint)) {
                setHint(obtainStyledAttributes.getString(C3867R.styleable.MaterialSearchView_android_hint));
            }
            if (obtainStyledAttributes.hasValue(C3867R.styleable.MaterialSearchView_searchVoiceIcon)) {
                setVoiceIcon(obtainStyledAttributes.getDrawable(C3867R.styleable.MaterialSearchView_searchVoiceIcon));
            }
            if (obtainStyledAttributes.hasValue(C3867R.styleable.MaterialSearchView_searchCloseIcon)) {
                setCloseIcon(obtainStyledAttributes.getDrawable(C3867R.styleable.MaterialSearchView_searchCloseIcon));
            }
            if (obtainStyledAttributes.hasValue(C3867R.styleable.MaterialSearchView_searchBackIcon)) {
                setBackIcon(obtainStyledAttributes.getDrawable(C3867R.styleable.MaterialSearchView_searchBackIcon));
            }
            if (obtainStyledAttributes.hasValue(C3867R.styleable.MaterialSearchView_searchSuggestionBackground)) {
                setSuggestionBackground(obtainStyledAttributes.getDrawable(C3867R.styleable.MaterialSearchView_searchSuggestionBackground));
            }
            if (obtainStyledAttributes.hasValue(C3867R.styleable.MaterialSearchView_searchSuggestionIcon)) {
                setSuggestionIcon(obtainStyledAttributes.getDrawable(C3867R.styleable.MaterialSearchView_searchSuggestionIcon));
            }
    ...
    private void initiateView() {
        LayoutInflater.from(this.mContext).inflate(C3867R.layout.search_view, this, true);
        this.mSearchLayout = findViewById(C3867R.C3870id.search_layout);
        this.mSearchTopBar = (RelativeLayout) this.mSearchLayout.findViewById(C3867R.C3870id.search_top_bar);
        this.mSuggestionsListView = (ListView) this.mSearchLayout.findViewById(C3867R.C3870id.suggestion_list);
        this.mSearchSrcTextView = (EditText) this.mSearchLayout.findViewById(C3867R.C3870id.searchTextView);
        this.mBackBtn = (ImageButton) this.mSearchLayout.findViewById(C3867R.C3870id.action_up_btn);
        this.mVoiceBtn = (ImageButton) this.mSearchLayout.findViewById(C3867R.C3870id.action_voice_btn);
        this.mEmptyBtn = (ImageButton) this.mSearchLayout.findViewById(C3867R.C3870id.action_empty_btn);
        this.mTintView = this.mSearchLayout.findViewById(C3867R.C3870id.transparent_view);
    ...
    private void setVisibleWithAnimation() {
        C38657 r0 = new AnimationListener() {

...
class JsonUtils {
    ...
    static /* synthetic */ class C08931 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.JsonUtils.C08931.<clinit>():void");
        }
    }
    ...
    static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        int i = C08931.$SwitchMap$android$util$JsonToken[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i = C08931.$SwitchMap$android$util$JsonToken[peek.ordinal()];
        if (i == 1) {

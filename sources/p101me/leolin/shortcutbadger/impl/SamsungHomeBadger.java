...
import p101me.leolin.shortcutbadger.util.CloseHelper;
    ...
    public void executeBadge(Context context, ComponentName componentName, int i) throws ShortcutBadgeException {
        ...
        if (defaultBadger2 == null || !defaultBadger2.isSupported(context)) {
            ...
            try {
                ...
                Uri uri = parse;
                cursor = contentResolver2.query(uri, CONTENT_PROJECTION, "package=?", new String[]{componentName.getPackageName()}, null);
                if (cursor != null) {

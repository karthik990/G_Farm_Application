...
public class XiaomiHomeBadger implements Badger {
    ...
    public void executeBadge(android.content.Context r5, android.content.ComponentName r6, int r7) throws p101me.leolin.shortcutbadger.ShortcutBadgeException {
        /*
            r4 = this;
            java.lang.String r0 = ""
        ...
        L_0x0062:
            ...
            r1.putExtra(r0, r6)
            boolean r6 = p101me.leolin.shortcutbadger.util.BroadcastHelper.canResolveBroadcast(r5, r1)
        ...
        L_0x0081:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p101me.leolin.shortcutbadger.impl.XiaomiHomeBadger.executeBadge(android.content.Context, android.content.ComponentName, int):void");
    }
    ...
    private void tryNewMiuiBadge(Context context, int i) throws ShortcutBadgeException {
        ...
        if (this.resolveInfo != null) {
            ...
            String str = "";
            Notification build = builder.setContentTitle(str).setContentText(str).setSmallIcon(this.resolveInfo.getIconResource()).build();
            try {

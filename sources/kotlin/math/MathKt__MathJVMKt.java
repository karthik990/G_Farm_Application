...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m4016ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m4017ln(float f) {

...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x00bc, code lost:
        kotlin.p044io.CloseableKt.closeFinally(r0, r11);
     */
    ...
    public static final byte[] readBytes(java.io.File r11) {
        /*
            ...
            r3 = r0
            java.io.FileInputStream r3 = (java.io.FileInputStream) r3     // Catch:{ all -> 0x00b9 }
            long r4 = r11.length()     // Catch:{ all -> 0x00b9 }
            ...
            int r5 = (int) r4
            byte[] r4 = new byte[r5]     // Catch:{ all -> 0x00b9 }
            r6 = 0
            r7 = 0
        L_0x0026:
            if (r5 <= 0) goto L_0x0032
            int r9 = r3.read(r4, r7, r5)     // Catch:{ all -> 0x00b9 }
        ...
        L_0x0032:
            ...
            byte[] r4 = java.util.Arrays.copyOf(r4, r7)     // Catch:{ all -> 0x00b9 }
            kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r4, r9)     // Catch:{ all -> 0x00b9 }
            goto L_0x0075
        L_0x003e:
            int r5 = r3.read()     // Catch:{ all -> 0x00b9 }
            r7 = -1
            if (r5 != r7) goto L_0x0046
            goto L_0x0075
        L_0x0046:
            kotlin.io.ExposingBufferByteArrayOutputStream r7 = new kotlin.io.ExposingBufferByteArrayOutputStream     // Catch:{ all -> 0x00b9 }
            r10 = 8193(0x2001, float:1.1481E-41)
            r7.<init>(r10)     // Catch:{ all -> 0x00b9 }
            r7.write(r5)     // Catch:{ all -> 0x00b9 }
            java.io.InputStream r3 = (java.io.InputStream) r3     // Catch:{ all -> 0x00b9 }
            r5 = r7
            java.io.OutputStream r5 = (java.io.OutputStream) r5     // Catch:{ all -> 0x00b9 }
            r10 = 2
            kotlin.p044io.ByteStreamsKt.copyTo$default(r3, r5, r6, r10, r1)     // Catch:{ all -> 0x00b9 }
            int r1 = r4.length     // Catch:{ all -> 0x00b9 }
            int r3 = r7.size()     // Catch:{ all -> 0x00b9 }
            int r1 = r1 + r3
            if (r1 < 0) goto L_0x0079
            byte[] r11 = r7.getBuffer()     // Catch:{ all -> 0x00b9 }
            byte[] r1 = java.util.Arrays.copyOf(r4, r1)     // Catch:{ all -> 0x00b9 }
            kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r1, r9)     // Catch:{ all -> 0x00b9 }
            int r3 = r4.length     // Catch:{ all -> 0x00b9 }
            int r4 = r7.size()     // Catch:{ all -> 0x00b9 }
            byte[] r4 = kotlin.collections.ArraysKt.copyInto(r11, r1, r3, r6, r4)     // Catch:{ all -> 0x00b9 }
        L_0x0075:
            kotlin.p044io.CloseableKt.closeFinally(r0, r2)
            return r4
        L_0x0079:
            java.lang.OutOfMemoryError r1 = new java.lang.OutOfMemoryError     // Catch:{ all -> 0x00b9 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x00b9 }
            r2.<init>()     // Catch:{ all -> 0x00b9 }
            r2.append(r8)     // Catch:{ all -> 0x00b9 }
            r2.append(r11)     // Catch:{ all -> 0x00b9 }
            java.lang.String r11 = " is too big to fit in memory."
            r2.append(r11)     // Catch:{ all -> 0x00b9 }
            java.lang.String r11 = r2.toString()     // Catch:{ all -> 0x00b9 }
            r1.<init>(r11)     // Catch:{ all -> 0x00b9 }
            java.lang.Throwable r1 = (java.lang.Throwable) r1     // Catch:{ all -> 0x00b9 }
        ...
        L_0x00c1:
            goto L_0x00c0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p044io.FilesKt__FileReadWriteKt.readBytes(java.io.File):byte[]");
    }
    ...
    public static final void writeBytes(java.io.File r2, byte[] r3) {
        ...
        L_0x0022:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p044io.FilesKt__FileReadWriteKt.writeBytes(java.io.File, byte[]):void");
    }
    ...
    public static final void appendBytes(java.io.File r2, byte[] r3) {
        ...
        L_0x0023:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p044io.FilesKt__FileReadWriteKt.appendBytes(java.io.File, byte[]):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x002b, code lost:
        kotlin.p044io.CloseableKt.closeFinally(r1, r2);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final java.lang.String readText(java.io.File r1, java.nio.charset.Charset r2) {
        /*
            ...
            java.lang.String r0 = kotlin.p044io.TextStreamsKt.readText(r0)     // Catch:{ all -> 0x0028 }
            kotlin.p044io.CloseableKt.closeFinally(r1, r2)
            return r0
        L_0x0028:
            r2 = move-exception
        ...
        L_0x002a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p044io.FilesKt__FileReadWriteKt.readText(java.io.File, java.nio.charset.Charset):java.lang.String");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0036, code lost:
        kotlin.p044io.CloseableKt.closeFinally(r0, r3);
     */
    ...
    public static final void forEachBlock(java.io.File r3, int r4, kotlin.jvm.functions.Function2<? super byte[], ? super java.lang.Integer, kotlin.Unit> r5) {
        ...
        L_0x003b:
            goto L_0x003a
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p044io.FilesKt__FileReadWriteKt.forEachBlock(java.io.File, int, kotlin.jvm.functions.Function2):void");
    }
    ...
    public static /* synthetic */ java.lang.Object useLines$default(java.io.File r1, java.nio.charset.Charset r2, kotlin.jvm.functions.Function1 r3, int r4, java.lang.Object r5) {
        ...
        L_0x0032:
            ...
            kotlin.sequences.Sequence r0 = kotlin.p044io.TextStreamsKt.lineSequence(r0)     // Catch:{ all -> 0x0057 }
        ...
        L_0x006a:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p044io.FilesKt__FileReadWriteKt.useLines$default(java.io.File, java.nio.charset.Charset, kotlin.jvm.functions.Function1, int, java.lang.Object):java.lang.Object");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0062, code lost:
        kotlin.p044io.CloseableKt.closeFinally(r3, r4);
     */
    ...
    public static final <T> T useLines(java.io.File r3, java.nio.charset.Charset r4, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r5) {
        ...
        L_0x002c:
            ...
            kotlin.sequences.Sequence r2 = kotlin.p044io.TextStreamsKt.lineSequence(r2)     // Catch:{ all -> 0x0052 }
        ...
        L_0x0065:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p044io.FilesKt__FileReadWriteKt.useLines(java.io.File, java.nio.charset.Charset, kotlin.jvm.functions.Function1):java.lang.Object");
    }
}

...
public final class DurationKt {
    ...
    private static final double m5230timesmvk6XK0(int i, double d) {
        return Duration.m5212timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk reason: not valid java name */
    private static final double m5229timeskIfJnKk(double d, double d2) {
        return Duration.m5211timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m5185constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}

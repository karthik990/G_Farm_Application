...
class CollectionsKt__CollectionsKt extends CollectionsKt__CollectionsJVMKt {
    ...
    public static final <T> List<T> listOf(T... tArr) {
        ...
        return tArr.length > 0 ? ArraysKt.asList((Object[]) tArr) : CollectionsKt.emptyList();
    }

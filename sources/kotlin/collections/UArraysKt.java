...
public final class UArraysKt {
    ...
    public static final int m4268random2D5oskM(int[] iArr, Random random) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UIntArray.m4419isEmptyimpl(iArr)) {
            return UIntArray.m4416getimpl(iArr, random.nextInt(UIntArray.m4417getSizeimpl(iArr)));
        }
    ...
    public static final long m4269randomJzugnMA(long[] jArr, Random random) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!ULongArray.m4488isEmptyimpl(jArr)) {
            return ULongArray.m4485getimpl(jArr, random.nextInt(ULongArray.m4486getSizeimpl(jArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final byte m4270randomoSF2wD8(byte[] bArr, Random random) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UByteArray.m4350isEmptyimpl(bArr)) {
            return UByteArray.m4347getimpl(bArr, random.nextInt(UByteArray.m4348getSizeimpl(bArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final short m4271randoms5X_as8(short[] sArr, Random random) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UShortArray.m4583isEmptyimpl(sArr)) {
            return UShortArray.m4580getimpl(sArr, random.nextInt(UShortArray.m4581getSizeimpl(sArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final boolean m4256contentEqualsctEhBpI(int[] iArr, int[] iArr2) {
    ...
    public static final boolean m4259contentEqualsus8wMrg(long[] jArr, long[] jArr2) {
    ...
    public static final boolean m4257contentEqualskdPth3s(byte[] bArr, byte[] bArr2) {
    ...
    public static final boolean m4258contentEqualsmazbYpA(short[] sArr, short[] sArr2) {
    ...
    public static final int m4260contentHashCodeajY9A(int[] iArr) {
    ...
    public static final int m4262contentHashCodeQwZRm1k(long[] jArr) {
    ...
    public static final int m4261contentHashCodeGBYM_sE(byte[] bArr) {
    ...
    public static final int m4263contentHashCoderL5Bavg(short[] sArr) {
    ...
    public static final String m4264contentToStringajY9A(int[] iArr) {
    ...
    public static final String m4266contentToStringQwZRm1k(long[] jArr) {
    ...
    public static final String m4265contentToStringGBYM_sE(byte[] bArr) {
    ...
    public static final String m4267contentToStringrL5Bavg(short[] sArr) {
    ...
    public static final UInt[] m4272toTypedArrayajY9A(int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$toTypedArray");
        int r0 = UIntArray.m4417getSizeimpl(iArr);
        UInt[] uIntArr = new UInt[r0];
        for (int i = 0; i < r0; i++) {
            uIntArr[i] = UInt.m4359boximpl(UIntArray.m4416getimpl(iArr, i));
        }
        return uIntArr;
    }
    ...
    public static final ULong[] m4274toTypedArrayQwZRm1k(long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$toTypedArray");
        int r0 = ULongArray.m4486getSizeimpl(jArr);
        ULong[] uLongArr = new ULong[r0];
        for (int i = 0; i < r0; i++) {
            uLongArr[i] = ULong.m4428boximpl(ULongArray.m4485getimpl(jArr, i));
        }
        return uLongArr;
    }
    ...
    public static final UByte[] m4273toTypedArrayGBYM_sE(byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$toTypedArray");
        int r0 = UByteArray.m4348getSizeimpl(bArr);
        UByte[] uByteArr = new UByte[r0];
        for (int i = 0; i < r0; i++) {
            uByteArr[i] = UByte.m4292boximpl(UByteArray.m4347getimpl(bArr, i));
        }
        return uByteArr;
    }
    ...
    public static final UShort[] m4275toTypedArrayrL5Bavg(short[] sArr) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$toTypedArray");
        int r0 = UShortArray.m4581getSizeimpl(sArr);
        UShort[] uShortArr = new UShort[r0];
        for (int i = 0; i < r0; i++) {
            uShortArr[i] = UShort.m4525boximpl(UShortArray.m4580getimpl(sArr, i));
        }
        return uShortArr;
    }
}

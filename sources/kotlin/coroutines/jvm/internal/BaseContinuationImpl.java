        ...
        while (true) {
            ...
            try {
                ...
                if (invokeSuspend != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    obj = Result.m4280constructorimpl(invokeSuspend);
                ...
                obj = Result.m4280constructorimpl(ResultKt.createFailure(th));
            }
        }
    }

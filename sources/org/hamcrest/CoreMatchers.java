...
import org.hamcrest.core.C6127Is;
...
public class CoreMatchers {
    ...
    /* renamed from: is */
    public static <T> Matcher<T> m4135is(T t) {
        return C6127Is.m4140is(t);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m4136is(Matcher<T> matcher) {
        return C6127Is.m4141is(matcher);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m4134is(Class<T> cls) {
        return C6127Is.m4139is(cls);
    }

    public static <T> Matcher<T> isA(Class<T> cls) {
        return C6127Is.isA(cls);
    }

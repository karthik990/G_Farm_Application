...
public final class HttpClientParamConfig {
    ...
    public static RequestConfig getRequestConfig(HttpParams httpParams, RequestConfig requestConfig) {
        ...
        Collection collection = (Collection) httpParams.getParameter(AuthPNames.TARGET_AUTH_PREF);
        if (collection != null) {
            relativeRedirectsAllowed.setTargetPreferredAuthSchemes(collection);
        }
        Collection collection2 = (Collection) httpParams.getParameter(AuthPNames.PROXY_AUTH_PREF);
        if (collection2 != null) {

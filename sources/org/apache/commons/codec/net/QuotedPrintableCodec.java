...
public class QuotedPrintableCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
    ...
    /* renamed from: CR */
    private static final byte f4516CR = 13;
    private static final byte ESCAPE_CHAR = 61;

    /* renamed from: LF */
    private static final byte f4517LF = 10;
    ...
    private static final int encodeQuotedPrintable(int i, ByteArrayOutputStream byteArrayOutputStream) {
        ...
        char hexDigit = C6065Utils.hexDigit(i >> 4);
        char hexDigit2 = C6065Utils.hexDigit(i);
    ...
    public static final byte[] decodeQuotedPrintable(byte[] bArr) throws DecoderException {
        ...
        while (i < bArr.length) {
            ...
            if (b == 61) {
                ...
                try {
                    if (bArr[i] != 13) {
                        int digit16 = C6065Utils.digit16(bArr[i]);
                        i++;

...
public class MatchRatingApproachEncoder implements StringEncoder {
    ...
    public String cleanName(String str) {
        ...
        while (true) {
            String str2 = "";
            if (i >= length) {
                return removeAccents(upperCase).replaceAll("\\s+", str2);
            }
            upperCase = upperCase.replaceAll(strArr[i], str2);
            i++;
        }
    }
    ...
    public final String encode(String str) {
        String str2 = "";
        return (str == null || str2.equalsIgnoreCase(str) || SPACE.equalsIgnoreCase(str) || str.length() == 1) ? str2 : getFirst3Last3(removeDoubleConsonants(removeVowels(cleanName(str))));
    }
    ...
    public boolean isEncodeEquals(String str, String str2) {
        ...
        if (str != null) {
            ...
            if (!str3.equalsIgnoreCase(str)) {
                String str4 = SPACE;
                if (!str4.equalsIgnoreCase(str) && str2 != null && !str3.equalsIgnoreCase(str2) && !str4.equalsIgnoreCase(str2) && str.length() != 1 && str2.length() != 1) {
    ...
    public int leftToRightThenRightToLeftProcessing(String str, String str2) {
        ...
        String str4 = "";
        String str5 = "\\s+";
        String replaceAll = str3.replaceAll(str5, str4);
        String replaceAll2 = new String(charArray2).replaceAll(str5, str4);
    ...
    public String removeVowels(String str) {
        ...
        String str2 = "";
        String replaceAll = str.replaceAll(ExifInterface.GPS_MEASUREMENT_IN_PROGRESS, str2).replaceAll(ExifInterface.LONGITUDE_EAST, str2).replaceAll("I", str2).replaceAll("O", str2).replaceAll("U", str2).replaceAll("\\s{2,}\\b", SPACE);

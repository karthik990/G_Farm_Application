...
public class Context {
    ...
    public static final class CancellableContext extends Context implements Closeable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:8:0x000d, code lost:
            if (p043io.grpc.Context.super.isCancelled() == false) goto L_0x0017;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:9:0x000f, code lost:
            cancel(p043io.grpc.Context.super.cancellationCause());
         */
        ...
        public boolean isCancelled() {
            ...
            L_0x0008:
                monitor-exit(r2)     // Catch:{ all -> 0x0019 }
                boolean r0 = p043io.grpc.Context.super.isCancelled()
                if (r0 == 0) goto L_0x0017
                java.lang.Throwable r0 = p043io.grpc.Context.super.cancellationCause()
                r2.cancel(r0)
                return r1
            L_0x0017:
                r0 = 0
            ...
            L_0x0019:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.grpc.Context.CancellableContext.isCancelled():boolean");
        }
    ...
    public static final class Key<T> {
        ...
        Key(String str, T t) {
            this.name = (String) Context.checkNotNull(str, PostalAddressParser.USER_ADDRESS_NAME_KEY);
            this.defaultValue = t;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0028, code lost:
        if ((p043io.grpc.Context.ExecutableListener.access$500((p043io.grpc.Context.ExecutableListener) r0.get(r2)) instanceof p043io.grpc.Context.ParentListener) != false) goto L_0x0033;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x002a, code lost:
        p043io.grpc.Context.ExecutableListener.access$400((p043io.grpc.Context.ExecutableListener) r0.get(r2));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0048, code lost:
        if ((p043io.grpc.Context.ExecutableListener.access$500((p043io.grpc.Context.ExecutableListener) r0.get(r1)) instanceof p043io.grpc.Context.ParentListener) == false) goto L_0x0053;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x004a, code lost:
        p043io.grpc.Context.ExecutableListener.access$400((p043io.grpc.Context.ExecutableListener) r0.get(r1));
     */
    ...
    public void notifyAndClearListeners() {
        ...
        L_0x0016:
            ...
            io.grpc.Context$ExecutableListener r3 = (p043io.grpc.Context.ExecutableListener) r3
            io.grpc.Context$CancellationListener r3 = r3.listener
            boolean r3 = r3 instanceof p043io.grpc.Context.ParentListener
        ...
        L_0x0036:
            ...
            io.grpc.Context$ExecutableListener r2 = (p043io.grpc.Context.ExecutableListener) r2
            io.grpc.Context$CancellationListener r2 = r2.listener
            boolean r2 = r2 instanceof p043io.grpc.Context.ParentListener
        ...
        L_0x0064:
            goto L_0x0063
        */
        throw new UnsupportedOperationException("Method not decompiled: p043io.grpc.Context.notifyAndClearListeners():void");
    }

...
import p043io.grpc.internal.ServiceConfigUtil;

/* renamed from: io.grpc.util.RoundRobinLoadBalancerFactory */
public final class RoundRobinLoadBalancerFactory extends Factory {
    ...
    /* renamed from: io.grpc.util.RoundRobinLoadBalancerFactory$EmptyPicker */
    ...
    /* renamed from: io.grpc.util.RoundRobinLoadBalancerFactory$RoundRobinPicker */
    ...
    /* renamed from: io.grpc.util.RoundRobinLoadBalancerFactory$ReadyPicker */
    static final class ReadyPicker extends RoundRobinPicker {
        ...
        public p043io.grpc.LoadBalancer.PickResult pickSubchannel(p043io.grpc.LoadBalancer.PickSubchannelArgs r3) {
            /*
                r2 = this;
                io.grpc.util.RoundRobinLoadBalancerFactory$RoundRobinLoadBalancer$StickinessState r0 = r2.stickinessState
                ...
                boolean r1 = p043io.grpc.util.RoundRobinLoadBalancerFactory.RoundRobinLoadBalancer.isReady(r0)
            ...
            L_0x0035:
                io.grpc.LoadBalancer$PickResult r3 = p043io.grpc.LoadBalancer.PickResult.withSubchannel(r0)
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.grpc.util.RoundRobinLoadBalancerFactory.ReadyPicker.pickSubchannel(io.grpc.LoadBalancer$PickSubchannelArgs):io.grpc.LoadBalancer$PickResult");
        }
    ...
    /* renamed from: io.grpc.util.RoundRobinLoadBalancerFactory$Ref */
    ...
    /* renamed from: io.grpc.util.RoundRobinLoadBalancerFactory$RoundRobinLoadBalancer */
    static final class RoundRobinLoadBalancer extends LoadBalancer {
        private static final Status EMPTY_OK = Status.f3691OK.withDescription("no subchannels ready");
        ...
        /* renamed from: io.grpc.util.RoundRobinLoadBalancerFactory$RoundRobinLoadBalancer$StickinessState */
        static final class StickinessState {
            ...
            StickinessState(@Nonnull String str) {
                this.key = Metadata.Key.m3992of(str, Metadata.ASCII_STRING_MARSHALLER);
            }

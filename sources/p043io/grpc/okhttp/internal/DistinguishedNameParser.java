...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f3697dn;
    private int end;
    private final int length = this.f3697dn.length();
    private int pos;

    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f3697dn = x500Principal.getName("RFC2253");
    }
    ...
    private java.lang.String escapedAV() {
        ...
        L_0x009b:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p043io.grpc.okhttp.internal.DistinguishedNameParser.escapedAV():java.lang.String");
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f3697dn.toCharArray();

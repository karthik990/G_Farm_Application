...
import p043io.grpc.InternalStatus;
import p043io.grpc.Metadata;
import p043io.grpc.Status;

/* renamed from: io.grpc.internal.AbstractServerStream */
public abstract class AbstractServerStream extends AbstractStream implements ServerStream, p043io.grpc.internal.MessageFramer.Sink {
    ...
    protected static abstract class TransportState extends p043io.grpc.internal.AbstractStream.TransportState {
        ...
        public void complete() {
            if (this.deframerClosed) {
                this.deframerClosedTask = null;
                closeListener(Status.f3691OK);
                return;
            }
            this.deframerClosedTask = new Runnable() {
                public void run() {
                    TransportState.this.closeListener(Status.f3691OK);
                }
            };
            this.immediateCloseRequested = true;
            closeDeframer(true);

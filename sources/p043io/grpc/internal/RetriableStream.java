...
abstract class RetriableStream<ReqT> implements ClientStream {
    ...
    static final Key<String> GRPC_PREVIOUS_RPC_ATTEMPTS = Key.m3992of("grpc-previous-rpc-attempts", Metadata.ASCII_STRING_MARSHALLER);
    static final Key<String> GRPC_RETRY_PUSHBACK_MS = Key.m3992of("grpc-retry-pushback-ms", Metadata.ASCII_STRING_MARSHALLER);
    /* access modifiers changed from: private */
    ...
    class BufferSizeTracer extends ClientStreamTracer {
        ...
        public void outboundWireSize(long r8) {
            /*
                r7 = this;
                io.grpc.internal.RetriableStream r0 = p043io.grpc.internal.RetriableStream.this
            ...
            L_0x000b:
                r0 = 0
                io.grpc.internal.RetriableStream r1 = p043io.grpc.internal.RetriableStream.this
                java.lang.Object r1 = r1.lock
                monitor-enter(r1)
                io.grpc.internal.RetriableStream r2 = p043io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
            ...
            L_0x0037:
                ...
                goto L_0x0071
            L_0x0049:
                io.grpc.internal.RetriableStream r8 = p043io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream$ChannelBufferMeter r8 = r8.channelBufferUsed     // Catch:{ all -> 0x0088 }
                long r2 = r7.bufferNeeded     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream r9 = p043io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
            ...
            L_0x0088:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.grpc.internal.RetriableStream.BufferSizeTracer.outboundWireSize(long):void");
        }
    }
    ...
    private final class Sublistener implements ClientStreamListener {
        ...
        private RetryPlan makeRetryDecision(RetryPolicy retryPolicy, Status status, Metadata metadata) {
            ...
            if (retryPolicy.maxAttempts > this.substream.previousAttempts + 1 && !z2) {
                if (num == null) {
                    if (contains) {
                        double access$1300 = (double) RetriableStream.this.nextBackoffIntervalNanos;
                        double nextDouble = RetriableStream.random.nextDouble();
                        Double.isNaN(access$1300);
                        j = (long) (access$1300 * nextDouble);
                        RetriableStream retriableStream = RetriableStream.this;
                        double access$13002 = (double) retriableStream.nextBackoffIntervalNanos;
                        double d = retryPolicy.backoffMultiplier;
                        Double.isNaN(access$13002);
                        retriableStream.nextBackoffIntervalNanos = Math.min((long) (access$13002 * d), retryPolicy.maxBackoffNanos);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0061, code lost:
        r3 = (p043io.grpc.internal.RetriableStream.BufferEntry) r1.next();
        r4 = r7.state;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0074, code lost:
        if (r4.cancelled == false) goto L_0x0082;
     */
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void drain(p043io.grpc.internal.RetriableStream.Substream r8) {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x0004:
            ...
            monitor-enter(r3)
            io.grpc.internal.RetriableStream$State r4 = r7.state     // Catch:{ all -> 0x0089 }
            io.grpc.internal.RetriableStream$Substream r5 = r4.winningSubstream     // Catch:{ all -> 0x0089 }
            ...
            return
        L_0x001a:
            java.util.List<io.grpc.internal.RetriableStream$BufferEntry> r5 = r4.buffer     // Catch:{ all -> 0x0089 }
            int r5 = r5.size()     // Catch:{ all -> 0x0089 }
            if (r1 != r5) goto L_0x002a
            io.grpc.internal.RetriableStream$State r8 = r4.substreamDrained(r8)     // Catch:{ all -> 0x0089 }
            r7.state = r8     // Catch:{ all -> 0x0089 }
            monitor-exit(r3)     // Catch:{ all -> 0x0089 }
            return
        L_0x002a:
            boolean r5 = r8.closed     // Catch:{ all -> 0x0089 }
            if (r5 == 0) goto L_0x0030
            monitor-exit(r3)     // Catch:{ all -> 0x0089 }
            return
        L_0x0030:
            int r5 = r1 + 128
            java.util.List<io.grpc.internal.RetriableStream$BufferEntry> r6 = r4.buffer     // Catch:{ all -> 0x0089 }
            int r6 = r6.size()     // Catch:{ all -> 0x0089 }
            int r5 = java.lang.Math.min(r5, r6)     // Catch:{ all -> 0x0089 }
            if (r2 != 0) goto L_0x004a
            java.util.ArrayList r2 = new java.util.ArrayList     // Catch:{ all -> 0x0089 }
            java.util.List<io.grpc.internal.RetriableStream$BufferEntry> r4 = r4.buffer     // Catch:{ all -> 0x0089 }
            java.util.List r1 = r4.subList(r1, r5)     // Catch:{ all -> 0x0089 }
        ...
        L_0x005b:
            ...
            io.grpc.internal.RetriableStream$BufferEntry r3 = (p043io.grpc.internal.RetriableStream.BufferEntry) r3
        ...
        L_0x008d:
            goto L_0x008c
        */
        throw new UnsupportedOperationException("Method not decompiled: p043io.grpc.internal.RetriableStream.drain(io.grpc.internal.RetriableStream$Substream):void");
    }

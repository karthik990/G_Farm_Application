...
public abstract class AbstractClientStream extends AbstractStream implements ClientStream, p043io.grpc.internal.MessageFramer.Sink {
    ...
    protected static abstract class TransportState extends p043io.grpc.internal.AbstractStream.TransportState {
        ...
        public void inboundHeadersReceived(p043io.grpc.Metadata r6) {
            /*
                r5 = this;
                ...
                io.grpc.Metadata$Key<java.lang.String> r0 = p043io.grpc.internal.GrpcUtil.CONTENT_ENCODING_KEY
            ...
            L_0x002f:
                ...
                boolean r2 = r0.equalsIgnoreCase(r2)
                if (r2 != 0) goto L_0x004f
                io.grpc.Status r6 = p043io.grpc.Status.INTERNAL
            ...
            L_0x004f:
                r0 = 0
            L_0x0050:
                io.grpc.Metadata$Key<java.lang.String> r2 = p043io.grpc.internal.GrpcUtil.MESSAGE_ENCODING_KEY
                ...
                return
            L_0x007a:
                io.grpc.Codec r1 = p043io.grpc.Codec.Identity.NONE
            ...
            L_0x0099:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.grpc.internal.AbstractClientStream.TransportState.inboundHeadersReceived(io.grpc.Metadata):void");
        }
    ...
    protected AbstractClientStream(WritableBufferAllocator writableBufferAllocator, StatsTraceContext statsTraceContext, TransportTracer transportTracer2, Metadata metadata, boolean z) {

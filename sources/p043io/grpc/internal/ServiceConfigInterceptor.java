...
final class ServiceConfigInterceptor implements ClientInterceptor {
    ...
    /* renamed from: io.grpc.internal.ServiceConfigInterceptor$MethodInfo */
    static final class MethodInfo {
        ...
        private static RetryPolicy retryPolicy(Map<String, Object> map, int i) {
            ...
            Preconditions.checkArgument(doubleValue > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, "backoffMultiplier must be greater than 0: %s", (Object) Double.valueOf(doubleValue));

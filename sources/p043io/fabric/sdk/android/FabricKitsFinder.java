...
class FabricKitsFinder implements Callable<Map<String, KitInfo>> {
    ...
    public Map<String, KitInfo> call() throws Exception {
        ...
        logger.mo64085v(Fabric.TAG, sb.toString());
        return hashMap;
    }
    ...
    private Map<String, KitInfo> findImplicitKits() {
        ...
        try {
            ...
            Fabric.getLogger().mo64085v(Fabric.TAG, "Found kit: com.google.firebase.firebase-ads");
        ...
        while (entries.hasMoreElements()) {
            ...
            if (zipEntry.getName().startsWith(FABRIC_DIR) && zipEntry.getName().length() > 7) {
                ...
                if (loadKitInfo != null) {
                    ...
                    Fabric.getLogger().mo64085v(Fabric.TAG, String.format("Found kit:[%s] version:[%s]", new Object[]{loadKitInfo.getIdentifier(), loadKitInfo.getVersion()}));
                }
            }
        }
        if (loadApkFile != null) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    logger.mo64077e(str, sb2.toString(), e);
                    CommonUtils.closeQuietly(inputStream);
                    return null;
                } catch (Throwable th) {
                    th = th;
            ...
            logger2.mo64077e(str2, sb22.toString(), e);
            CommonUtils.closeQuietly(inputStream);
            return null;
        } catch (Throwable th2) {
            th = th2;

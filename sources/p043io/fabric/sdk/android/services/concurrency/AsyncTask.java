...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    static /* synthetic */ class C53354 {

        /* renamed from: $SwitchMap$io$fabric$sdk$android$services$concurrency$AsyncTask$Status */
        static final /* synthetic */ int[] f3689x37f1d2cc = new int[Status.values().length];
        ...
        static {
            /*
                io.fabric.sdk.android.services.concurrency.AsyncTask$Status[] r0 = p043io.fabric.sdk.android.services.concurrency.AsyncTask.Status.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f3689x37f1d2cc = r0
                int[] r0 = f3689x37f1d2cc     // Catch:{ NoSuchFieldError -> 0x0014 }
                io.fabric.sdk.android.services.concurrency.AsyncTask$Status r1 = p043io.fabric.sdk.android.services.concurrency.AsyncTask.Status.RUNNING     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f3689x37f1d2cc     // Catch:{ NoSuchFieldError -> 0x001f }
                io.fabric.sdk.android.services.concurrency.AsyncTask$Status r1 = p043io.fabric.sdk.android.services.concurrency.AsyncTask.Status.FINISHED     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.fabric.sdk.android.services.concurrency.AsyncTask.C53354.<clinit>():void");
        }
    }
    ...
    public final AsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.status != Status.PENDING) {
            int i = C53354.f3689x37f1d2cc[this.status.ordinal()];
            if (i == 1) {

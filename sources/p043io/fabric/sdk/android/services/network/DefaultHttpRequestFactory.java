...
import p043io.fabric.sdk.android.DefaultLogger;
...
public class DefaultHttpRequestFactory implements HttpRequestFactory {
    ...
    static /* synthetic */ class C53431 {
        ...
        static {
            /*
                io.fabric.sdk.android.services.network.HttpMethod[] r0 = p043io.fabric.sdk.android.services.network.HttpMethod.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                io.fabric.sdk.android.services.network.HttpMethod r1 = p043io.fabric.sdk.android.services.network.HttpMethod.GET     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$io$fabric$sdk$android$services$network$HttpMethod     // Catch:{ NoSuchFieldError -> 0x001f }
                io.fabric.sdk.android.services.network.HttpMethod r1 = p043io.fabric.sdk.android.services.network.HttpMethod.POST     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = $SwitchMap$io$fabric$sdk$android$services$network$HttpMethod     // Catch:{ NoSuchFieldError -> 0x002a }
                io.fabric.sdk.android.services.network.HttpMethod r1 = p043io.fabric.sdk.android.services.network.HttpMethod.PUT     // Catch:{ NoSuchFieldError -> 0x002a }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                int[] r0 = $SwitchMap$io$fabric$sdk$android$services$network$HttpMethod     // Catch:{ NoSuchFieldError -> 0x0035 }
                io.fabric.sdk.android.services.network.HttpMethod r1 = p043io.fabric.sdk.android.services.network.HttpMethod.DELETE     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.fabric.sdk.android.services.network.DefaultHttpRequestFactory.C53431.<clinit>():void");
        }
    }
    ...
    public HttpRequest buildHttpRequest(HttpMethod httpMethod, String str, Map<String, String> map) {
        ...
        int i = C53431.$SwitchMap$io$fabric$sdk$android$services$network$HttpMethod[httpMethod.ordinal()];
        if (i == 1) {
    ...
    private synchronized SSLSocketFactory initSSLSocketFactory() {
        ...
        try {
            ...
            this.logger.mo64074d(Fabric.TAG, "Custom SSL pinning enabled");
        } catch (Exception e) {
            this.logger.mo64077e(Fabric.TAG, "Exception while validating pinned certs", e);
            return null;
        }

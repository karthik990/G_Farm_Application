...
class AdvertisingInfoServiceStrategy implements AdvertisingInfoStrategy {
    ...
    private static final class AdvertisingConnection implements ServiceConnection {
        ...
        public IBinder getBinder() {
            if (this.retrieved) {
                Fabric.getLogger().mo64076e(Fabric.TAG, "getBinder already called");
            }
            this.retrieved = true;
            try {
    ...
    private static final class AdvertisingInterface implements IInterface {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:6:?, code lost:
            p043io.fabric.sdk.android.Fabric.getLogger().mo64074d(p043io.fabric.sdk.android.Fabric.TAG, "Could not get parcel from Google Play Service to capture AdvertisingId");
         */
        ...
        public java.lang.String getId() throws android.os.RemoteException {
            ...
            L_0x0022:
                ...
                goto L_0x0037
            L_0x0024:
                io.fabric.sdk.android.Logger r2 = p043io.fabric.sdk.android.Fabric.getLogger()     // Catch:{ all -> 0x0022 }
                java.lang.String r3 = "Fabric"
                java.lang.String r4 = "Could not get parcel from Google Play Service to capture AdvertisingId"
                r2.mo64074d(r3, r4)     // Catch:{ all -> 0x0022 }
                r1.recycle()
                r0.recycle()
                r2 = 0
            L_0x0036:
            ...
            L_0x0037:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.fabric.sdk.android.services.common.AdvertisingInfoServiceStrategy.AdvertisingInterface.getId():java.lang.String");
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:7:?, code lost:
            p043io.fabric.sdk.android.Fabric.getLogger().mo64074d(p043io.fabric.sdk.android.Fabric.TAG, "Could not get parcel from Google Play Service to capture Advertising limitAdTracking");
         */
        /* JADX WARNING: Failed to process nested try/catch */
        ...
        public boolean isLimitAdTrackingEnabled() throws android.os.RemoteException {
            ...
            L_0x0023:
                ...
                goto L_0x0037
            L_0x0025:
                io.fabric.sdk.android.Logger r3 = p043io.fabric.sdk.android.Fabric.getLogger()     // Catch:{ all -> 0x0023 }
                ...
                r3.mo64074d(r4, r5)     // Catch:{ all -> 0x0023 }
            L_0x0030:
                r1.recycle()
                r0.recycle()
                return r2
            L_0x0037:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.fabric.sdk.android.services.common.AdvertisingInfoServiceStrategy.AdvertisingInterface.isLimitAdTrackingEnabled():boolean");
        }
    }
    ...
    public AdvertisingInfo getAdvertisingInfo() {
        ...
        if (myLooper == mainLooper) {
            Fabric.getLogger().mo64074d(str2, "AdvertisingInfoServiceStrategy cannot be called on the main thread");
            return null;
        }
        try {
            ...
            try {
                if (this.context.bindService(intent, advertisingConnection, 1)) {
                    try {
                        ...
                        Fabric.getLogger().mo64088w(str2, "Exception in binding to Google Play Service to capture AdvertisingId", e);
                        this.context.unbindService(advertisingConnection);
                    }
                } else {
                    Fabric.getLogger().mo64074d(str2, str);
                    return null;
                }
            } catch (Throwable th) {
                Fabric.getLogger().mo64075d(str2, str, th);
            }
        } catch (NameNotFoundException unused) {
            Fabric.getLogger().mo64074d(str2, "Unable to find Google Play Services package name");
            return null;
        } catch (Exception e2) {
            Fabric.getLogger().mo64075d(str2, "Unable to determine if Google Play Services is available", e2);
            return null;
        }
    }
}

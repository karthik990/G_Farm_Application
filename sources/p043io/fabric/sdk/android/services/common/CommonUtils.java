...
public class CommonUtils {
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Fabric.getLogger().mo64074d(Fabric.TAG, "Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    public static String extractFieldFromSystemFile(File file, String str) {
        ...
        if (file.exists()) {
            try {
                ...
                while (true) {
                    try {
                        ...
                        try {
                            ...
                            sb.append(file);
                            logger.mo64077e(str4, sb.toString(), e);
                ...
                sb2.append(file);
                logger2.mo64077e(str42, sb2.toString(), e);
                closeOrLog(bufferedReader, str2);
                return str3;
            } catch (Throwable th2) {
                th = th2;
            ...
            if (totalRamInBytes == -1) {
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        ...
                        logger2.mo64077e(str2, sb2.toString(), e);
                    }
                }
                totalRamInBytes = j2;
            }
    ...
    private static String hash(InputStream inputStream, String str) {
        try {
            ...
            Fabric.getLogger().mo64077e(Fabric.TAG, "Could not calculate hash for app icon.", e);
            return "";
        }
    }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            logger.mo64077e(Fabric.TAG, sb.toString(), e);
            return "";
        }
    }
    ...
    public static Float getBatteryLevel(Context context) {
        ...
        return Float.valueOf(((float) registerReceiver.getIntExtra(Param.LEVEL, -1)) / ((float) registerReceiver.getIntExtra(SlidingMenu.SCALED_MENU, -1)));
    }
    ...
    public static void logControlled(Context context, String str) {
        if (isClsTrace(context)) {
            Fabric.getLogger().mo64074d(Fabric.TAG, str);
        }
    }

    public static void logControlledError(Context context, String str, Throwable th) {
        if (isClsTrace(context)) {
            Fabric.getLogger().mo64076e(Fabric.TAG, str);
        }
    }
    ...
    public static String hexify(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            cArr[i2] = cArr2[b >>> 4];
            cArr[i2 + 1] = cArr2[b & Ascii.f1875SI];
        }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Fabric.getLogger().mo64077e(Fabric.TAG, str, e);
            }
        }
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    logger.mo64087w(str3, sb.toString());
                    closeOrLog(inputStream, str);
                    return null;
                } catch (Throwable th) {
                    th = th;
            ...
            logger2.mo64087w(str32, sb2.toString());
            closeOrLog(inputStream, str);
            return null;
        } catch (Throwable th2) {
            th = th2;
    ...
    public static void logOrThrowIllegalStateException(String str, String str2) {
        if (!Fabric.isDebuggable()) {
            Fabric.getLogger().mo64087w(str, str2);
            return;
        }

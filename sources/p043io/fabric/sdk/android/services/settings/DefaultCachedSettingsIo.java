...
class DefaultCachedSettingsIo implements CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        logger.mo64074d(str2, "Reading cached settings...");
        ...
        try {
            ...
            if (file.exists()) {
                ...
                try {
                    ...
                    e = e;
                    try {
                        Fabric.getLogger().mo64077e(str2, "Failed to fetch cached settings", e);
                ...
                Fabric.getLogger().mo64074d(str2, "No cached settings found.");
                jSONObject = null;
            }
            CommonUtils.closeOrLog(fileInputStream2, str);
            return jSONObject;
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        ...
        Logger logger = Fabric.getLogger();
        String str2 = Fabric.TAG;
        logger.mo64074d(str2, "Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        Fabric.getLogger().mo64077e(str2, "Failed to cache settings", e);

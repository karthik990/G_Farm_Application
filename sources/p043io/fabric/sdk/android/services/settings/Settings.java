...
import p043io.fabric.sdk.android.services.common.SystemCurrentTimeProvider;
...
public class Settings {
    ...
    public SettingsData awaitSettingsData() {
        try {
            ...
            Fabric.getLogger().mo64076e(Fabric.TAG, "Interrupted while waiting for settings data.");
            return null;
        }
    }
    ...
    public synchronized boolean loadSettingsSkippingCache() {
        ...
        if (loadSettingsData == null) {
            Fabric.getLogger().mo64077e(Fabric.TAG, "Failed to force reload of settings from Crashlytics.", null);
        }
        return loadSettingsData != null;
    }

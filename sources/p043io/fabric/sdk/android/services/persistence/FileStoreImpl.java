...
public class FileStoreImpl implements FileStore {
    ...
    public File prepare(File file) {
        ...
        if (file == null) {
            Fabric.getLogger().mo64074d(str, "Null File");
        } else if (file.exists() || file.mkdirs()) {
            return file;
        } else {
            Fabric.getLogger().mo64087w(str, "Couldn't create file");
        }
        return null;
    }
    ...
    public boolean isExternalStorageAvailable() {
        ...
        Fabric.getLogger().mo64087w(Fabric.TAG, "External Storage is not mounted and/or writable\nHave you declared android.permission.WRITE_EXTERNAL_STORAGE in the manifest?");
        return false;
    }
}

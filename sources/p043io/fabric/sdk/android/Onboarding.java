...
import p043io.fabric.sdk.android.services.settings.AppRequestData;
import p043io.fabric.sdk.android.services.settings.AppSettingsData;
import p043io.fabric.sdk.android.services.settings.CreateAppSpiCall;
import p043io.fabric.sdk.android.services.settings.IconRequest;
...
import p043io.fabric.sdk.android.services.settings.UpdateAppSpiCall;
...
class Onboarding extends Kit<Boolean> {
    ...
    public boolean onPreExecute() {
        try {
            ...
            Fabric.getLogger().mo64077e(Fabric.TAG, "Failed init", e);
            return false;
        }
    }
    ...
    public Boolean doInBackground() {
        ...
        if (retrieveSettingsData != null) {
            try {
                ...
                Fabric.getLogger().mo64077e(Fabric.TAG, "Error performing auto configuration.", e);
            }
    ...
    private SettingsData retrieveSettingsData() {
        try {
            ...
            Fabric.getLogger().mo64077e(Fabric.TAG, "Error dealing with settings", e);
            return null;
        }
    }
    ...
    private boolean performAutoConfigure(String str, AppSettingsData appSettingsData, Collection<KitInfo> collection) {
        ...
        if (!equals) {
            ...
            if (appSettingsData.updateRequired) {
                Fabric.getLogger().mo64074d(str2, "Server says an update is required - forcing a full App update.");
            ...
            Fabric.getLogger().mo64077e(str2, "Failed to create app with Crashlytics service.", null);
            return false;
        }
    }

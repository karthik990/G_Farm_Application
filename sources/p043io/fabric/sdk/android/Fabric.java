...
import p043io.fabric.sdk.android.ActivityLifecycleManager.Callbacks;
...
import p043io.fabric.sdk.android.services.concurrency.PriorityThreadPoolExecutor;
...
public class Fabric {
                ...
                if (!DataCollectionArbiter.getInstance(this.context).isDataCollectionEnabled()) {
                    ...
                    for (Kit kit : kitArr) {
                        ...
                        if (c == 0 || c == 1) {
                            ...
                            Fabric.getLogger().mo64087w(Fabric.TAG, "Fabric will not initialize any kits when Firebase automatic data collection is disabled; to use Third-party kits with automatic data collection disabled, initialize these kits via non-Fabric means.");
                            z = true;
                        }
                    }
    ...
    public void initializeKits(Context context2) {
        ...
        if (sb != null) {
            getLogger().mo64074d(str, sb.toString());
        }
    }

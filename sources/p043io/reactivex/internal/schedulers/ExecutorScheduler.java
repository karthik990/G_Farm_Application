...
public final class ExecutorScheduler extends Scheduler {
    ...
    final class DelayedDispose implements Runnable {
        ...
        /* renamed from: dr */
        private final DelayedRunnable f4143dr;

        DelayedDispose(DelayedRunnable delayedRunnable) {
            this.f4143dr = delayedRunnable;
        }

        public void run() {
            this.f4143dr.direct.replace(ExecutorScheduler.this.scheduleDirect(this.f4143dr));
        }
    }
    ...
    public static final class ExecutorWorker extends Worker implements Runnable {
        ...
        public void run() {
            ...
            L_0x0025:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.schedulers.ExecutorScheduler.ExecutorWorker.run():void");
        }
    }

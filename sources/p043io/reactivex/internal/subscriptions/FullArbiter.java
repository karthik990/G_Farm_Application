package p043io.reactivex.internal.subscriptions;
...
public final class FullArbiter<T> extends FullArbiterPad2 implements Subscription {
    ...
    /* renamed from: s */
    volatile Subscription f4172s = INITIAL;

    /* renamed from: io.reactivex.internal.subscriptions.FullArbiter$InitialSubscription */
    ...
    public boolean setSubscription(Subscription subscription) {
        ...
        this.queue.offer(this.f4172s, NotificationLite.subscription(subscription));
        drain();
        return true;
    }
                ...
                if (poll == null) {
                    ...
                    if (poll == REQUEST) {
                        ...
                        if (andSet != 0) {
                            ...
                            this.f4172s.request(andSet);
                        }
                    } else if (poll == this.f4172s) {
                        if (NotificationLite.isSubscription(poll2)) {
                            Subscription subscription = NotificationLite.getSubscription(poll2);
                            if (!this.cancelled) {
                                this.f4172s = subscription;

...
import p043io.reactivex.internal.fuseable.HasUpstreamObservableSource;
...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, Disposable {
    ...
    static final class Replay<T> extends ConnectableObservable<T> {
        ...
        /* renamed from: co */
        private final ConnectableObservable<T> f4045co;
        private final Observable<T> observable;

        Replay(ConnectableObservable<T> connectableObservable, Observable<T> observable2) {
            this.f4045co = connectableObservable;
            this.observable = observable2;
        }

        public void connect(Consumer<? super Disposable> consumer) {
            this.f4045co.connect(consumer);
        }
    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public void subscribe(p043io.reactivex.Observer<? super T> r4) {
            /*
                r3 = this;
            L_0x0000:
                ...
                io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver r0 = (p043io.reactivex.internal.operators.observable.ObservableReplay.ReplayObserver) r0
            ...
            L_0x0035:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.observable.ObservableReplay.ReplaySource.subscribe(io.reactivex.Observer):void");
        }
    }
    ...
    static final class SizeAndTimeBoundReplayBuffer<T> extends BoundedReplayBuffer<T> {
        ...
        public void truncateFinal() {
            /*
                ...
                io.reactivex.internal.operators.observable.ObservableReplay$Node r2 = (p043io.reactivex.internal.operators.observable.ObservableReplay.Node) r2
                java.lang.Object r3 = r2.get()
                io.reactivex.internal.operators.observable.ObservableReplay$Node r3 = (p043io.reactivex.internal.operators.observable.ObservableReplay.Node) r3
                r4 = 0
            L_0x0018:
                r9 = r3
                r3 = r2
            ...
            L_0x0041:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.observable.ObservableReplay.SizeAndTimeBoundReplayBuffer.truncateFinal():void");
        }
    ...
    public void connect(p043io.reactivex.functions.Consumer<? super p043io.reactivex.disposables.Disposable> r5) {
        ...
        L_0x0056:
            goto L_0x0055
        */
        throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.observable.ObservableReplay.connect(io.reactivex.functions.Consumer):void");
    }
}

...
public final class ObservableTimeout<T, U, V> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class TimeoutObserver<T, U, V> extends AtomicReference<Disposable> implements Observer<T>, Disposable, OnTimeout {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f4076s, disposable)) {
                this.f4076s = disposable;
    ...
    static final class TimeoutOtherObserver<T, U, V> extends AtomicReference<Disposable> implements Observer<T>, Disposable, OnTimeout {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f4077s, disposable)) {
                this.f4077s = disposable;
        ...
        public void onNext(T t) {
            if (!this.done) {
                long j = this.index + 1;
                this.index = j;
                if (this.arbiter.onNext(t, this.f4077s)) {
                    Disposable disposable = (Disposable) get();
                    if (disposable != null) {
                        disposable.dispose();
                    }
        ...
        public void onError(Throwable th) {
            ...
            this.done = true;
            dispose();
            this.arbiter.onError(th, this.f4077s);
        }
        ...
        public void onComplete() {
            if (!this.done) {
                this.done = true;
                dispose();
                this.arbiter.onComplete(this.f4077s);
            }
        }

...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
    ...
    static final class PublishObserver<T> implements Observer<T>, Disposable {
        ...
        /* renamed from: s */
        final AtomicReference<Disposable> f4038s = new AtomicReference<>();
        ...
        public void dispose() {
            ...
            if (obj != obj2 && ((InnerDisposable[]) this.observers.getAndSet(obj2)) != TERMINATED) {
                ...
                DisposableHelper.dispose(this.f4038s);
            }
        }
        ...
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f4038s, disposable);
        }
    ...
    public void connect(p043io.reactivex.functions.Consumer<? super p043io.reactivex.disposables.Disposable> r5) {
        ...
        L_0x0000:
            ...
            io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver r0 = (p043io.reactivex.internal.operators.observable.ObservablePublish.PublishObserver) r0
        ...
        L_0x004a:
            goto L_0x0049
        */
        throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.observable.ObservablePublish.connect(io.reactivex.functions.Consumer):void");
    }
}

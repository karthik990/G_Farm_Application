...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    static /* synthetic */ class C59401 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C59401.<clinit>():void");
        }
    }
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f4101s, subscription)) {
                this.f4101s = subscription;
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.Object r6 = p043io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, r7)     // Catch:{ all -> 0x004c }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p043io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x004c }
                int[] r7 = p043io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C59401.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x004c:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f4102s, subscription)) {
                this.f4102s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p043io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, r7)     // Catch:{ all -> 0x004b }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p043io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x004b }
                int[] r7 = p043io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C59401.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x004b:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextSubscriber.tryOnNext(java.lang.Object):boolean");
        }

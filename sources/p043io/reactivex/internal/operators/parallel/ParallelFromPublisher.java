...
public final class ParallelFromPublisher<T> extends ParallelFlowable<T> {
    ...
    static final class ParallelDispatcher<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        final class RailSubscription implements Subscription {
            ...
            public void request(long j) {
                ...
                if (SubscriptionHelper.validate(j)) {
                    ...
                    do {
                        j2 = atomicLongArray.get(this.f4106j);
                        if (j2 != Long.MAX_VALUE) {
                        } else {
                            return;
                        }
                    } while (!atomicLongArray.compareAndSet(this.f4106j, j2, BackpressureHelper.addCap(j2, j)));
                    if (ParallelDispatcher.this.subscriberCount.get() == this.f4107m) {
            ...
            public void cancel() {
                if (ParallelDispatcher.this.requests.compareAndSet(this.f4106j + this.f4107m, 0, 1)) {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f4105s, subscription)) {
                this.f4105s = subscription;

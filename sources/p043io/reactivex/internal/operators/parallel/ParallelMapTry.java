...
public final class ParallelMapTry<T, R> extends ParallelFlowable<R> {
    ...
    static /* synthetic */ class C59421 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.parallel.ParallelMapTry.C59421.<clinit>():void");
        }
    }
    ...
    static final class ParallelMapTryConditionalSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f4110s, subscription)) {
                this.f4110s = subscription;
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0008:
                ...
                java.lang.Object r10 = p043io.reactivex.internal.functions.ObjectHelper.requireNonNull(r0, r4)     // Catch:{ all -> 0x001b }
            ...
            L_0x001b:
                ...
                java.lang.Object r6 = p043io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, r7)     // Catch:{ all -> 0x0053 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p043io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x0053 }
                int[] r7 = p043io.reactivex.internal.operators.parallel.ParallelMapTry.C59421.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x0053:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTryConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static final class ParallelMapTrySubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f4111s, subscription)) {
                this.f4111s = subscription;
                this.actual.onSubscribe(this);
            }
        }
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0008:
                ...
                java.lang.Object r10 = p043io.reactivex.internal.functions.ObjectHelper.requireNonNull(r4, r5)     // Catch:{ all -> 0x001b }
            ...
            L_0x0052:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.parallel.ParallelMapTry.ParallelMapTrySubscriber.tryOnNext(java.lang.Object):boolean");
        }

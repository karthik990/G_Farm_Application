...
public final class MaybeFlatMapIterableObservable<T, R> extends Observable<R> {
    ...
    static final class FlatMapIterableObserver<T, R> extends BasicQueueDisposable<R> implements MaybeObserver<T> {
        ...
        /* renamed from: it */
        volatile Iterator<? extends R> f3959it;
        final Function<? super T, ? extends Iterable<? extends R>> mapper;
        boolean outputFused;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f3958d, disposable)) {
                this.f3958d = disposable;
        ...
        public void onError(Throwable th) {
            this.f3958d = DisposableHelper.DISPOSED;
        ...
        public boolean isEmpty() {
            return this.f3959it == null;
        }

        public R poll() throws Exception {
            Iterator<? extends R> it = this.f3959it;
            if (it == null) {
                return null;
            }

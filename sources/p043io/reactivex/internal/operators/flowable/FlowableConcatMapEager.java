...
import p043io.reactivex.internal.subscribers.InnerQueuedSubscriber;
import p043io.reactivex.internal.subscribers.InnerQueuedSubscriberSupport;
...
public final class FlowableConcatMapEager<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class ConcatMapEagerDelayErrorSubscriber<T, R> extends AtomicInteger implements FlowableSubscriber<T>, Subscription, InnerQueuedSubscriberSupport<R> {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f3839s, subscription)) {
                this.f3839s = subscription;
        ...
        public void drain() {
            ...
            L_0x0010:
                ...
                io.reactivex.internal.util.ErrorMode r0 = p043io.reactivex.internal.util.ErrorMode.END
            ...
            L_0x0033:
                ...
                io.reactivex.internal.subscribers.InnerQueuedSubscriber r8 = (p043io.reactivex.internal.subscribers.InnerQueuedSubscriber) r8
            ...
            L_0x0065:
                ...
                return
            L_0x0073:
                io.reactivex.internal.util.ErrorMode r0 = p043io.reactivex.internal.util.ErrorMode.IMMEDIATE
            ...
            L_0x00a2:
                ...
                r1.current = r11
                org.reactivestreams.Subscription r0 = r1.f3839s
                r0.request(r4)
                r8 = r11
                r17 = 1
                goto L_0x00cf
            ...
            L_0x0133:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p043io.reactivex.internal.operators.flowable.FlowableConcatMapEager.ConcatMapEagerDelayErrorSubscriber.drain():void");
        }
    }

...
import p043io.reactivex.internal.subscriptions.BasicQueueSubscription;
...
public final class FlowableFromIterable<T> extends Flowable<T> {
    ...
    static abstract class BaseRangeSubscription<T> extends BasicQueueSubscription<T> {
        ...
        public final T poll() {
            Iterator<? extends T> it = this.f3866it;
            if (it == null) {
                return null;
            }
            if (!this.once) {
            ...
            return ObjectHelper.requireNonNull(this.f3866it.next(), "Iterator.next() returned a null value");
        }

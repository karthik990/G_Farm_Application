...
import p043io.reactivex.internal.observers.BiConsumerSingleObserver;
import p043io.reactivex.internal.observers.BlockingMultiObserver;
import p043io.reactivex.internal.observers.ConsumerSingleObserver;
import p043io.reactivex.internal.observers.FutureSingleObserver;
import p043io.reactivex.internal.operators.completable.CompletableFromSingle;
import p043io.reactivex.internal.operators.completable.CompletableToFlowable;
...
import p043io.reactivex.internal.operators.maybe.MaybeFilterSingle;
...
import p043io.reactivex.internal.operators.single.SingleAmb;
import p043io.reactivex.internal.operators.single.SingleCache;
import p043io.reactivex.internal.operators.single.SingleContains;
import p043io.reactivex.internal.operators.single.SingleCreate;
import p043io.reactivex.internal.operators.single.SingleDefer;
import p043io.reactivex.internal.operators.single.SingleDelay;
import p043io.reactivex.internal.operators.single.SingleDelayWithCompletable;
import p043io.reactivex.internal.operators.single.SingleDelayWithObservable;
import p043io.reactivex.internal.operators.single.SingleDelayWithPublisher;
import p043io.reactivex.internal.operators.single.SingleDelayWithSingle;
import p043io.reactivex.internal.operators.single.SingleDoAfterSuccess;
import p043io.reactivex.internal.operators.single.SingleDoAfterTerminate;
import p043io.reactivex.internal.operators.single.SingleDoFinally;
import p043io.reactivex.internal.operators.single.SingleDoOnDispose;
import p043io.reactivex.internal.operators.single.SingleDoOnError;
import p043io.reactivex.internal.operators.single.SingleDoOnEvent;
import p043io.reactivex.internal.operators.single.SingleDoOnSubscribe;
import p043io.reactivex.internal.operators.single.SingleDoOnSuccess;
import p043io.reactivex.internal.operators.single.SingleEquals;
import p043io.reactivex.internal.operators.single.SingleError;
import p043io.reactivex.internal.operators.single.SingleFlatMap;
import p043io.reactivex.internal.operators.single.SingleFlatMapCompletable;
import p043io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import p043io.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import p043io.reactivex.internal.operators.single.SingleFlatMapMaybe;
import p043io.reactivex.internal.operators.single.SingleFromCallable;
import p043io.reactivex.internal.operators.single.SingleFromPublisher;
import p043io.reactivex.internal.operators.single.SingleFromUnsafeSource;
import p043io.reactivex.internal.operators.single.SingleHide;
import p043io.reactivex.internal.operators.single.SingleInternalHelper;
import p043io.reactivex.internal.operators.single.SingleJust;
import p043io.reactivex.internal.operators.single.SingleLift;
import p043io.reactivex.internal.operators.single.SingleMap;
import p043io.reactivex.internal.operators.single.SingleNever;
import p043io.reactivex.internal.operators.single.SingleObserveOn;
import p043io.reactivex.internal.operators.single.SingleOnErrorReturn;
import p043io.reactivex.internal.operators.single.SingleResumeNext;
import p043io.reactivex.internal.operators.single.SingleSubscribeOn;
import p043io.reactivex.internal.operators.single.SingleTakeUntil;
import p043io.reactivex.internal.operators.single.SingleTimeout;
import p043io.reactivex.internal.operators.single.SingleTimer;
import p043io.reactivex.internal.operators.single.SingleToFlowable;
import p043io.reactivex.internal.operators.single.SingleToObservable;
import p043io.reactivex.internal.operators.single.SingleUnsubscribeOn;
import p043io.reactivex.internal.operators.single.SingleUsing;
import p043io.reactivex.internal.operators.single.SingleZipArray;
import p043io.reactivex.internal.operators.single.SingleZipIterable;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo21985to(Function<? super Single<T>, R> function) {
        try {

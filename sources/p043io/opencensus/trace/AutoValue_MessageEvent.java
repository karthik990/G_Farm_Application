...
final class AutoValue_MessageEvent extends MessageEvent {
    ...
    static final class Builder extends p043io.opencensus.trace.MessageEvent.Builder {
        ...
        public p043io.opencensus.trace.MessageEvent.Builder setType(Type type2) {
            if (type2 != null) {
                this.type = type2;
                return this;
            }
        ...
        /* access modifiers changed from: 0000 */
        public p043io.opencensus.trace.MessageEvent.Builder setMessageId(long j) {
            this.messageId = Long.valueOf(j);
            return this;
        }

        public p043io.opencensus.trace.MessageEvent.Builder setUncompressedMessageSize(long j) {
            this.uncompressedMessageSize = Long.valueOf(j);
            return this;
        }

        public p043io.opencensus.trace.MessageEvent.Builder setCompressedMessageSize(long j) {

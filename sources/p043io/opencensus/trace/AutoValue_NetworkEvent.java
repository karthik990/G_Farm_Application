...
import p043io.opencensus.trace.NetworkEvent.Type;
...
final class AutoValue_NetworkEvent extends NetworkEvent {
    ...
    static final class Builder extends p043io.opencensus.trace.NetworkEvent.Builder {
        ...
        public p043io.opencensus.trace.NetworkEvent.Builder setKernelTimestamp(@Nullable Timestamp timestamp) {
            this.kernelTimestamp = timestamp;
            return this;
        }

        /* access modifiers changed from: 0000 */
        public p043io.opencensus.trace.NetworkEvent.Builder setType(Type type2) {
            if (type2 != null) {
                this.type = type2;
                return this;
            }
        ...
        /* access modifiers changed from: 0000 */
        public p043io.opencensus.trace.NetworkEvent.Builder setMessageId(long j) {
            this.messageId = Long.valueOf(j);
            return this;
        }

        public p043io.opencensus.trace.NetworkEvent.Builder setUncompressedMessageSize(long j) {
            this.uncompressedMessageSize = Long.valueOf(j);
            return this;
        }

        public p043io.opencensus.trace.NetworkEvent.Builder setCompressedMessageSize(long j) {
    ...
    public boolean equals(java.lang.Object r8) {
        /*
            ...
            return r0
        L_0x0004:
            boolean r1 = r8 instanceof p043io.opencensus.trace.NetworkEvent
            r2 = 0
            if (r1 == 0) goto L_0x004d
            io.opencensus.trace.NetworkEvent r8 = (p043io.opencensus.trace.NetworkEvent) r8
        ...
        L_0x004d:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p043io.opencensus.trace.AutoValue_NetworkEvent.equals(java.lang.Object):boolean");
    }

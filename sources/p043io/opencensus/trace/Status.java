...
public final class Status {
    ...
    /* renamed from: OK */
    public static final Status f3765OK = CanonicalCode.OK.toStatus();
    ...
    private Status(CanonicalCode canonicalCode2, @Nullable String str) {
        this.canonicalCode = (CanonicalCode) C5887Utils.checkNotNull(canonicalCode2, "canonicalCode");
        this.description = str;
    }

    public Status withDescription(@Nullable String str) {
        if (C5887Utils.equalsObjects(this.description, str)) {
            return this;
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (this.canonicalCode != status.canonicalCode || !C5887Utils.equalsObjects(this.description, status.description)) {
            z = false;
        }
        return z;
    }

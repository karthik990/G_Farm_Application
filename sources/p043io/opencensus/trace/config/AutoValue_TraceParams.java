...
final class AutoValue_TraceParams extends TraceParams {
    ...
    static final class Builder extends p043io.opencensus.trace.config.TraceParams.Builder {
        ...
        public p043io.opencensus.trace.config.TraceParams.Builder setSampler(Sampler sampler2) {
            if (sampler2 != null) {
        ...
        public p043io.opencensus.trace.config.TraceParams.Builder setMaxNumberOfAttributes(int i) {
            this.maxNumberOfAttributes = Integer.valueOf(i);
            return this;
        }

        public p043io.opencensus.trace.config.TraceParams.Builder setMaxNumberOfAnnotations(int i) {
            this.maxNumberOfAnnotations = Integer.valueOf(i);
            return this;
        }

        public p043io.opencensus.trace.config.TraceParams.Builder setMaxNumberOfMessageEvents(int i) {
            this.maxNumberOfMessageEvents = Integer.valueOf(i);
            return this;
        }

        public p043io.opencensus.trace.config.TraceParams.Builder setMaxNumberOfLinks(int i) {
    ...
    public p043io.opencensus.trace.config.TraceParams.Builder toBuilder() {

...
final class AutoValue_EndSpanOptions extends EndSpanOptions {
    ...
    static final class Builder extends p043io.opencensus.trace.EndSpanOptions.Builder {
        ...
        public p043io.opencensus.trace.EndSpanOptions.Builder setSampleToLocalSpanStore(boolean z) {
            this.sampleToLocalSpanStore = Boolean.valueOf(z);
            return this;
        }

        public p043io.opencensus.trace.EndSpanOptions.Builder setStatus(@Nullable Status status2) {
            this.status = status2;
            return this;
        }

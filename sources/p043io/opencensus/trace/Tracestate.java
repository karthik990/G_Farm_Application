...
public abstract class Tracestate {
    ...
    public static final class Builder {
        ...
        private Builder(Tracestate tracestate) {
            C5887Utils.checkNotNull(tracestate, "parent");
    ...
    public static abstract class Entry {
        ...
        public static Entry create(String str, String str2) {
            C5887Utils.checkNotNull(str, "key");
            C5887Utils.checkNotNull(str2, Param.VALUE);
            C5887Utils.checkArgument(Tracestate.validateKey(str), "Invalid key %s", str);
            C5887Utils.checkArgument(Tracestate.validateValue(str2), "Invalid value %s", str2);
    ...
    public static Tracestate create(List<Entry> list) {
        C5887Utils.checkState(list.size() <= 32, "Invalid size");

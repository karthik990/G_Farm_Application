...
public final class Http2Stream {
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean z) throws IOException {
            ...
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.f4510id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
                Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002d, code lost:
            r8.this$0.connection.writeData(r8.this$0.f4510id, true, null, 0);
         */
                                ...
                                if (Http2Stream.this.headersQueue.isEmpty() || Http2Stream.this.headersListener == null) {
                                    if (this.readBuffer.size() > 0) {
                                        ...
                                        if (errorCode == null && Http2Stream.this.unacknowledgedBytesRead >= ((long) (Http2Stream.this.connection.okHttpSettings.getInitialWindowSize() / 2))) {
                                            Http2Stream.this.connection.writeWindowUpdateLater(Http2Stream.this.f4510id, Http2Stream.this.unacknowledgedBytesRead);
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f4510id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public void writeHeaders(List<Header> list, boolean z) throws IOException {
        ...
        if (list != null) {
            ...
            this.connection.writeSynReply(this.f4510id, z3, list);
            if (z2) {
    ...
    public void close(ErrorCode errorCode2) throws IOException {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f4510id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f4510id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f4510id);
            return true;
        }
    }

...
import okhttp3.internal.p047io.FileSystem;
...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        ...
        public void run() {
            ...
            L_0x0045:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache.DiskLruCache.C24141.run():void");
        }
    };
    boolean closed;
        ...
        public Sink newSink(int i) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    ...
                    try {
                        C24131 r1 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) {
    ...
    private void readJournal() throws java.io.IOException {
        /*
            ...
            java.lang.String r2 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a9 }
            java.lang.String r3 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a9 }
            java.lang.String r4 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a9 }
            java.lang.String r5 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a9 }
            java.lang.String r6 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a9 }
        ...
        L_0x0053:
            ...
            goto L_0x0053
        L_0x005d:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r2 = r9.lruEntries     // Catch:{ all -> 0x00a9 }
            int r2 = r2.size()     // Catch:{ all -> 0x00a9 }
            int r0 = r0 - r2
            r9.redundantOpCount = r0     // Catch:{ all -> 0x00a9 }
            boolean r0 = r1.exhausted()     // Catch:{ all -> 0x00a9 }

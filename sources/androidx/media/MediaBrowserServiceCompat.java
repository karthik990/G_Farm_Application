...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        class MediaBrowserServiceApi21 extends MediaBrowserService {
            ...
            public void onLoadChildren(String str, android.service.media.MediaBrowserService.Result<List<MediaItem>> result) {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:16:0x0079 A[RETURN] */
        /* JADX WARNING: Removed duplicated region for block: B:17:0x007a  */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public androidx.media.MediaBrowserServiceCompat.BrowserRoot onGetRoot(java.lang.String r12, int r13, android.os.Bundle r14) {
            /*
                r11 = this;
                r0 = -1
                r1 = 0
                ...
                androidx.media.MediaBrowserServiceCompat$ServiceHandler r3 = r3.mHandler
                r2.<init>(r3)
                r11.mMessenger = r2
                ...
                r2.putInt(r4, r3)
                android.os.Messenger r3 = r11.mMessenger
                android.os.IBinder r3 = r3.getBinder()
                java.lang.String r4 = "extra_messenger"
                androidx.core.app.BundleCompat.putBinder(r2, r4, r3)
                androidx.media.MediaBrowserServiceCompat r3 = androidx.media.MediaBrowserServiceCompat.this
            ...
            L_0x0047:
                ...
                goto L_0x0052
            L_0x004d:
                java.util.List<android.os.Bundle> r3 = r11.mRootExtrasList
                r3.add(r2)
            L_0x0052:
            ...
            L_0x005d:
                ...
                r7 = -1
            L_0x005f:
                androidx.media.MediaBrowserServiceCompat$ConnectionRecord r0 = new androidx.media.MediaBrowserServiceCompat$ConnectionRecord
                ...
                androidx.media.MediaBrowserServiceCompat r3 = androidx.media.MediaBrowserServiceCompat.this
                r3.mCurConnection = r0
                androidx.media.MediaBrowserServiceCompat$BrowserRoot r12 = r3.onGetRoot(r12, r13, r14)
                androidx.media.MediaBrowserServiceCompat r13 = androidx.media.MediaBrowserServiceCompat.this
                r13.mCurConnection = r1
                if (r12 != 0) goto L_0x007a
                return r1
            L_0x007a:
                android.os.Messenger r14 = r11.mMessenger
                if (r14 == 0) goto L_0x0083
                java.util.ArrayList<androidx.media.MediaBrowserServiceCompat$ConnectionRecord> r13 = r13.mPendingConnections
                r13.add(r0)
            L_0x0083:
            ...
            L_0x0097:
                ...
                return r13
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.onGetRoot(java.lang.String, int, android.os.Bundle):androidx.media.MediaBrowserServiceCompat$BrowserRoot");
        }

        public void onLoadChildren(String str, final ResultWrapper<List<Parcel>> resultWrapper) {
            C04672 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 {
        ...
        class MediaBrowserServiceApi23 extends MediaBrowserServiceApi21 {
            ...
            public void onLoadItem(String str, android.service.media.MediaBrowserService.Result<MediaItem> result) {
        ...
        public void onLoadItem(String str, final ResultWrapper<Parcel> resultWrapper) {
            C04701 r0 = new Result<MediaBrowserCompat.MediaItem>(str) {
                /* access modifiers changed from: 0000 */
    ...
    class MediaBrowserServiceImplApi26 extends MediaBrowserServiceImplApi23 {
        ...
        class MediaBrowserServiceApi26 extends MediaBrowserServiceApi23 {
            ...
            public void onLoadChildren(String str, android.service.media.MediaBrowserService.Result<List<MediaItem>> result, Bundle bundle) {
                MediaSessionCompat.ensureClassLoader(bundle);
        ...
        public void onLoadChildren(String str, final ResultWrapper<List<Parcel>> resultWrapper, final Bundle bundle) {
            C04711 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
                /* access modifiers changed from: 0000 */
                public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                    if (list == null) {
                        resultWrapper.sendResult(null);
    ...
    class MediaBrowserServiceImplApi28 extends MediaBrowserServiceImplApi26 {
        ...
        public RemoteUserInfo getCurrentBrowserInfo() {
            if (MediaBrowserServiceCompat.this.mCurConnection == null) {
                ...
                return new RemoteUserInfo(this.mServiceFwk.getCurrentBrowserInfo());
            } else {
                return MediaBrowserServiceCompat.this.mCurConnection.browserInfo;
            }
        }
    ...
    static class ResultWrapper<T> {
        ...
        public void sendResult(T t) {
            if (t instanceof List) {
                ...
                this.mResultFwk.sendResult(MediaItem.CREATOR.createFromParcel(parcel));
                parcel.recycle();
            } else {
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
        ...
        C04611 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            /* access modifiers changed from: 0000 */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C04622 r0 = new Result<MediaBrowserCompat.MediaItem>(str) {
            /* access modifiers changed from: 0000 */
            public void onResultSent(MediaBrowserCompat.MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C04633 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            /* access modifiers changed from: 0000 */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C04644 r0 = new Result<Bundle>(str) {
            /* access modifiers changed from: 0000 */

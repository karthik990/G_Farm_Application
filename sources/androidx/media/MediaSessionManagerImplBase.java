...
class MediaSessionManagerImplBase implements MediaSessionManagerImpl {
    ...
    public boolean isTrustedForMediaControl(RemoteUserInfoImpl remoteUserInfoImpl) {
        ...
        try {
            ...
            if (isPermissionGranted(remoteUserInfoImpl, PERMISSION_STATUS_BAR_SERVICE) || isPermissionGranted(remoteUserInfoImpl, "android.permission.MEDIA_CONTENT_CONTROL") || remoteUserInfoImpl.getUid() == 1000 || isEnabledNotificationListener(remoteUserInfoImpl)) {
                z = true;
            }
            return z;

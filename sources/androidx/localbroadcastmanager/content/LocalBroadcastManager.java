...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(android.content.Intent r22) {
        /*
            ...
            monitor-enter(r2)
            java.lang.String r10 = r22.getAction()     // Catch:{ all -> 0x0177 }
            android.content.Context r3 = r1.mAppContext     // Catch:{ all -> 0x0177 }
            android.content.ContentResolver r3 = r3.getContentResolver()     // Catch:{ all -> 0x0177 }
            java.lang.String r11 = r0.resolveTypeIfNeeded(r3)     // Catch:{ all -> 0x0177 }
            android.net.Uri r12 = r22.getData()     // Catch:{ all -> 0x0177 }
            java.lang.String r13 = r22.getScheme()     // Catch:{ all -> 0x0177 }
            java.util.Set r14 = r22.getCategories()     // Catch:{ all -> 0x0177 }
            int r3 = r22.getFlags()     // Catch:{ all -> 0x0177 }
            r3 = r3 & 8
        ...
        L_0x002e:
            ...
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0177 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0177 }
        L_0x0056:
            java.util.HashMap<java.lang.String, java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord>> r3 = r1.mActions     // Catch:{ all -> 0x0177 }
            java.lang.String r4 = r22.getAction()     // Catch:{ all -> 0x0177 }
            java.lang.Object r3 = r3.get(r4)     // Catch:{ all -> 0x0177 }
            r8 = r3
            java.util.ArrayList r8 = (java.util.ArrayList) r8     // Catch:{ all -> 0x0177 }
        ...
        L_0x007d:
            ...
            r7 = 0
        L_0x0080:
            int r3 = r8.size()     // Catch:{ all -> 0x0177 }
            if (r7 >= r3) goto L_0x0144
            java.lang.Object r3 = r8.get(r7)     // Catch:{ all -> 0x0177 }
            r5 = r3
            androidx.localbroadcastmanager.content.LocalBroadcastManager$ReceiverRecord r5 = (androidx.localbroadcastmanager.content.LocalBroadcastManager.ReceiverRecord) r5     // Catch:{ all -> 0x0177 }
            ...
            android.content.IntentFilter r9 = r5.filter     // Catch:{ all -> 0x0177 }
            r4.append(r9)     // Catch:{ all -> 0x0177 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0177 }
            android.util.Log.v(r3, r4)     // Catch:{ all -> 0x0177 }
        L_0x00a7:
            boolean r3 = r5.broadcasting     // Catch:{ all -> 0x0177 }
        ...
        L_0x00b4:
            ...
            goto L_0x0139
        L_0x00c0:
            android.content.IntentFilter r3 = r5.filter     // Catch:{ all -> 0x0177 }
            ...
            r20 = r11
            r11 = 1
            int r3 = r3.match(r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x0177 }
            ...
            java.lang.String r3 = java.lang.Integer.toHexString(r3)     // Catch:{ all -> 0x0177 }
            r5.append(r3)     // Catch:{ all -> 0x0177 }
            java.lang.String r3 = r5.toString()     // Catch:{ all -> 0x0177 }
        ...
        L_0x0144:
            ...
            r3 = 0
        L_0x0149:
            int r4 = r10.size()     // Catch:{ all -> 0x0177 }
            if (r3 >= r4) goto L_0x015b
            java.lang.Object r4 = r10.get(r3)     // Catch:{ all -> 0x0177 }
            ...
            goto L_0x0149
        L_0x015b:
            java.util.ArrayList<androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord> r3 = r1.mPendingBroadcasts     // Catch:{ all -> 0x0177 }
            androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord r4 = new androidx.localbroadcastmanager.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x0177 }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x0177 }
            r3.add(r4)     // Catch:{ all -> 0x0177 }
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x0177 }
            boolean r0 = r0.hasMessages(r11)     // Catch:{ all -> 0x0177 }

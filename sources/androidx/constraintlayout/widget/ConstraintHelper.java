...
import androidx.constraintlayout.widget.C0270R.C0271id;
...
public abstract class ConstraintHelper extends View {
    ...
    private void addID(String str) {
        ...
        if (str != null && this.myContext != null) {
            ...
            try {
                i = C0271id.class.getField(trim).getInt(null);
            } catch (Exception unused) {
                i = 0;
            }
            if (i == 0) {
                i = this.myContext.getResources().getIdentifier(trim, TtmlNode.ATTR_ID, this.myContext.getPackageName());
            }

...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f36id == -1 || solverVariable.f36id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f36id] == null) {
                if (solverVariable.f36id != -1) {
                    solverVariable.reset();
                }
                this.mVariablesID++;
                this.mNumColumns++;
                solverVariable.f36id = this.mVariablesID;
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID++;
        this.mNumColumns++;
        acquireSolverVariable.f36id = this.mVariablesID;
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f36id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f36id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f36id] = true;
            }
            if (pivotCandidate != null) {
                int i3 = -1;

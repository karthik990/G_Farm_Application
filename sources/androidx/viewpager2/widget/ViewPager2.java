...
import androidx.viewpager2.C0688R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        C07042 r3 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
        ...
        C07053 r4 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0688R.styleable.ViewPager2);
        if (VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0688R.styleable.ViewPager2, attributeSet, obtainStyledAttributes, 0, 0);
        }
        try {
            setOrientation(obtainStyledAttributes.getInt(C0688R.styleable.ViewPager2_android_orientation, 0));
        } finally {

...
public class LifecycleRegistry extends Lifecycle {
    ...
    static /* synthetic */ class C04271 {
        ...
        static {
            ...
            L_0x0091:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C04271.<clinit>():void");
        }
    }
    ...
    private static Event downEvent(State state) {
        int i = C04271.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {

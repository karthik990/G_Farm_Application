...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        /* renamed from: P */
        private final AlertParams f25P;
        ...
        public Builder(Context context, int i) {
            this.f25P = new AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, i)));
            this.mTheme = i;
        }
        ...
        public Builder setTitle(int i) {
            AlertParams alertParams = this.f25P;
            alertParams.mTitle = alertParams.mContext.getText(i);
            return this;
        }

        public Builder setTitle(CharSequence charSequence) {
            this.f25P.mTitle = charSequence;
            return this;
        }

        public Builder setCustomTitle(View view) {
            this.f25P.mCustomTitleView = view;
            return this;
        }
        ...
        public Builder setMessage(CharSequence charSequence) {
            this.f25P.mMessage = charSequence;
            return this;
        }
        ...
        public Builder setIcon(Drawable drawable) {
            this.f25P.mIcon = drawable;
            return this;
        }

        public Builder setIconAttribute(int i) {
            TypedValue typedValue = new TypedValue();
            this.f25P.mContext.getTheme().resolveAttribute(i, typedValue, true);
            this.f25P.mIconId = typedValue.resourceId;
            return this;
        }
        ...
        public Builder setPositiveButton(int i, OnClickListener onClickListener) {
            ...
            this.f25P.mPositiveButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setPositiveButtonIcon(Drawable drawable) {
            this.f25P.mPositiveButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNegativeButton(int i, OnClickListener onClickListener) {
            ...
            this.f25P.mNegativeButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setNegativeButtonIcon(Drawable drawable) {
            this.f25P.mNegativeButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNeutralButton(int i, OnClickListener onClickListener) {
            ...
            this.f25P.mNeutralButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setNeutralButtonIcon(Drawable drawable) {
            this.f25P.mNeutralButtonIcon = drawable;
            return this;
        }

        public Builder setCancelable(boolean z) {
            this.f25P.mCancelable = z;
            return this;
        }
        ...
        public Builder setItems(int i, OnClickListener onClickListener) {
            ...
            this.f25P.mOnClickListener = onClickListener;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(int i, boolean[] zArr, OnMultiChoiceClickListener onMultiChoiceClickListener) {
            AlertParams alertParams = this.f25P;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i);
            AlertParams alertParams2 = this.f25P;
        ...
        public Builder setOnItemSelectedListener(OnItemSelectedListener onItemSelectedListener) {
            this.f25P.mOnItemSelectedListener = onItemSelectedListener;
            return this;
        }
        ...
        public Builder setInverseBackgroundForced(boolean z) {
            this.f25P.mForceInverseBackground = z;
            return this;
        }

        public Builder setRecycleOnMeasureEnabled(boolean z) {
            this.f25P.mRecycleOnMeasure = z;
            return this;
        }

        public AlertDialog create() {
            AlertDialog alertDialog = new AlertDialog(this.f25P.mContext, this.mTheme);
            this.f25P.apply(alertDialog.mAlert);
            alertDialog.setCancelable(this.f25P.mCancelable);
            if (this.f25P.mCancelable) {
                alertDialog.setCanceledOnTouchOutside(true);
            }
            alertDialog.setOnCancelListener(this.f25P.mOnCancelListener);
            alertDialog.setOnDismissListener(this.f25P.mOnDismissListener);
            if (this.f25P.mOnKeyListener != null) {
                alertDialog.setOnKeyListener(this.f25P.mOnKeyListener);
            }
            return alertDialog;
        }
    ...
    static int resolveDialogTheme(Context context, int i) {
        ...
        TypedValue typedValue = new TypedValue();
        context.getTheme().resolveAttribute(C0118R.attr.alertDialogTheme, typedValue, true);

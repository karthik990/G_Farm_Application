...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r19, int r20) {
        /*
            ...
            int[] r4 = androidx.appcompat.C0118R.styleable.AppCompatTextHelper
            r5 = 0
            ...
            int r6 = androidx.appcompat.C0118R.styleable.AppCompatTextHelper_android_textAppearance
            r8 = -1
            int r6 = r4.getResourceId(r6, r8)
            int r9 = androidx.appcompat.C0118R.styleable.AppCompatTextHelper_android_drawableLeft
        ...
        L_0x0032:
            int r9 = androidx.appcompat.C0118R.styleable.AppCompatTextHelper_android_drawableTop
            boolean r9 = r4.hasValue(r9)
        ...
        L_0x0046:
            int r9 = androidx.appcompat.C0118R.styleable.AppCompatTextHelper_android_drawableRight
            boolean r9 = r4.hasValue(r9)
        ...
        L_0x005a:
            int r9 = androidx.appcompat.C0118R.styleable.AppCompatTextHelper_android_drawableBottom
            boolean r9 = r4.hasValue(r9)
        ...
        L_0x006e:
            ...
            int r9 = androidx.appcompat.C0118R.styleable.AppCompatTextHelper_android_drawableStart
            boolean r9 = r4.hasValue(r9)
        ...
        L_0x0088:
            int r9 = androidx.appcompat.C0118R.styleable.AppCompatTextHelper_android_drawableEnd
            boolean r9 = r4.hasValue(r9)
        ...
        L_0x009c:
            ...
            int[] r13 = androidx.appcompat.C0118R.styleable.TextAppearance
            ...
            int r13 = androidx.appcompat.C0118R.styleable.TextAppearance_textAllCaps
        ...
        L_0x00c8:
            ...
            int r15 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textColor
        ...
        L_0x00de:
            r15 = 0
        L_0x00df:
            int r10 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textColorHint
        ...
        L_0x00ee:
            r10 = 0
        L_0x00ef:
            int r12 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textColorLink
        ...
        L_0x0107:
            r15 = 0
        L_0x0108:
            int r8 = androidx.appcompat.C0118R.styleable.TextAppearance_textLocale
        ...
        L_0x0118:
            ...
            int r11 = androidx.appcompat.C0118R.styleable.TextAppearance_fontVariationSettings
        ...
        L_0x0130:
            ...
            r15 = 0
        L_0x0137:
            int[] r6 = androidx.appcompat.C0118R.styleable.TextAppearance
            ...
            int r9 = androidx.appcompat.C0118R.styleable.TextAppearance_textAllCaps
        ...
        L_0x014e:
            ...
            int r5 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textColor
            boolean r5 = r6.hasValue(r5)
            if (r5 == 0) goto L_0x0162
            int r5 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textColor
            android.content.res.ColorStateList r12 = r6.getColorStateList(r5)
        L_0x0162:
            int r5 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textColorHint
            boolean r5 = r6.hasValue(r5)
            if (r5 == 0) goto L_0x0170
            int r5 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textColorHint
            android.content.res.ColorStateList r10 = r6.getColorStateList(r5)
        L_0x0170:
            int r5 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textColorLink
            boolean r5 = r6.hasValue(r5)
            if (r5 == 0) goto L_0x017e
            int r5 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textColorLink
            android.content.res.ColorStateList r15 = r6.getColorStateList(r5)
        L_0x017e:
            int r5 = androidx.appcompat.C0118R.styleable.TextAppearance_textLocale
            boolean r5 = r6.hasValue(r5)
        ...
        L_0x018c:
            ...
            int r5 = androidx.appcompat.C0118R.styleable.TextAppearance_fontVariationSettings
            boolean r5 = r6.hasValue(r5)
        ...
        L_0x01a0:
            ...
            int r5 = androidx.appcompat.C0118R.styleable.TextAppearance_android_textSize
            boolean r5 = r6.hasValue(r5)
        ...
        L_0x0274:
            int[] r1 = androidx.appcompat.C0118R.styleable.AppCompatTextView
            androidx.appcompat.widget.TintTypedArray r8 = androidx.appcompat.widget.TintTypedArray.obtainStyledAttributes(r2, r0, r1)
            int r0 = androidx.appcompat.C0118R.styleable.AppCompatTextView_drawableLeftCompat
            r1 = -1
        ...
        L_0x028b:
            r4 = 0
        L_0x028c:
            int r0 = androidx.appcompat.C0118R.styleable.AppCompatTextView_drawableTopCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x029a:
            r5 = 0
        L_0x029b:
            int r0 = androidx.appcompat.C0118R.styleable.AppCompatTextView_drawableRightCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x02a9:
            r6 = 0
        L_0x02aa:
            int r0 = androidx.appcompat.C0118R.styleable.AppCompatTextView_drawableBottomCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x02b8:
            r9 = 0
        L_0x02b9:
            int r0 = androidx.appcompat.C0118R.styleable.AppCompatTextView_drawableStartCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x02c7:
            r10 = 0
        L_0x02c8:
            int r0 = androidx.appcompat.C0118R.styleable.AppCompatTextView_drawableEndCompat
            int r0 = r8.getResourceId(r0, r1)
        ...
        L_0x02d7:
            ...
            int r0 = androidx.appcompat.C0118R.styleable.AppCompatTextView_drawableTint
        ...
        L_0x02f5:
            int r0 = androidx.appcompat.C0118R.styleable.AppCompatTextView_drawableTintMode
            boolean r0 = r8.hasValue(r0)
        ...
        L_0x030f:
            r1 = -1
        L_0x0310:
            int r0 = androidx.appcompat.C0118R.styleable.AppCompatTextView_firstBaselineToTopHeight
            int r0 = r8.getDimensionPixelSize(r0, r1)
            int r2 = androidx.appcompat.C0118R.styleable.AppCompatTextView_lastBaselineToBottomHeight
            int r2 = r8.getDimensionPixelSize(r2, r1)
            int r3 = androidx.appcompat.C0118R.styleable.AppCompatTextView_lineHeight
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray tintTypedArray) {
        this.mStyle = tintTypedArray.getInt(C0118R.styleable.TextAppearance_android_textStyle, this.mStyle);
        boolean z = false;
        if (VERSION.SDK_INT >= 28) {
            this.mFontWeight = tintTypedArray.getInt(C0118R.styleable.TextAppearance_android_textFontWeight, -1);
            if (this.mFontWeight != -1) {
                this.mStyle = (this.mStyle & 2) | 0;
            }
        }
        if (tintTypedArray.hasValue(C0118R.styleable.TextAppearance_android_fontFamily) || tintTypedArray.hasValue(C0118R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            int i = tintTypedArray.hasValue(C0118R.styleable.TextAppearance_fontFamily) ? C0118R.styleable.TextAppearance_fontFamily : C0118R.styleable.TextAppearance_android_fontFamily;
        ...
        if (tintTypedArray.hasValue(C0118R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            int i5 = tintTypedArray.getInt(C0118R.styleable.TextAppearance_android_typeface, 1);
            if (i5 == 1) {
    ...
    public void onSetTextAppearance(Context context, int i) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, i, C0118R.styleable.TextAppearance);
        if (obtainStyledAttributes.hasValue(C0118R.styleable.TextAppearance_textAllCaps)) {
            setAllCaps(obtainStyledAttributes.getBoolean(C0118R.styleable.TextAppearance_textAllCaps, false));
        }
        if (VERSION.SDK_INT < 23 && obtainStyledAttributes.hasValue(C0118R.styleable.TextAppearance_android_textColor)) {
            ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C0118R.styleable.TextAppearance_android_textColor);
            if (colorStateList != null) {
                this.mView.setTextColor(colorStateList);
            }
        }
        if (obtainStyledAttributes.hasValue(C0118R.styleable.TextAppearance_android_textSize) && obtainStyledAttributes.getDimensionPixelSize(C0118R.styleable.TextAppearance_android_textSize, -1) == 0) {
            this.mView.setTextSize(0, 0.0f);
        }
        updateTypefaceAndStyle(context, obtainStyledAttributes);
        if (VERSION.SDK_INT >= 26 && obtainStyledAttributes.hasValue(C0118R.styleable.TextAppearance_fontVariationSettings)) {
            String string = obtainStyledAttributes.getString(C0118R.styleable.TextAppearance_fontVariationSettings);
            if (string != null) {

...
public abstract class CustomTabsService extends Service {
    ...
    private Stub mBinder = new Stub() {
            ...
            try {
                $$Lambda$CustomTabsService$1$3KabmmsBQr_A7ceXhU8FiwltY6M r1 = new DeathRecipient(customTabsSessionToken) {
                    ...
                    public final void binderDied() {
                        C02481.this.lambda$newSessionInternal$0$CustomTabsService$1(this.f$1);
                    }
                };
        ...
        private PendingIntent getSessionIdFromBundle(Bundle bundle) {
            ...
            String str = CustomTabsIntent.EXTRA_SESSION_ID;
            PendingIntent pendingIntent = (PendingIntent) bundle.getParcelable(str);
            bundle.remove(str);

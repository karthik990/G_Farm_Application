...
class PackageIdentityUtils {
    ...
    static class Api28Implementation implements SignaturesCompat {
        ...
        public List<byte[]> getFingerprintsForPackage(String str, PackageManager packageManager) throws NameNotFoundException {
        ...
        public boolean packageMatchesToken(String str, PackageManager packageManager, TokenContents tokenContents) throws NameNotFoundException, IOException {
            List fingerprintsForPackage = getFingerprintsForPackage(str, packageManager);
    ...
    static class Pre28Implementation implements SignaturesCompat {
        ...
        public boolean packageMatchesToken(String str, PackageManager packageManager, TokenContents tokenContents) throws IOException, NameNotFoundException {
            List fingerprintsForPackage = getFingerprintsForPackage(str, packageManager);
            if (fingerprintsForPackage == null) {
                return false;
            }
    ...
    interface SignaturesCompat {
        List<byte[]> getFingerprintsForPackage(String str, PackageManager packageManager) throws NameNotFoundException;

        boolean packageMatchesToken(String str, PackageManager packageManager, TokenContents tokenContents) throws IOException, NameNotFoundException;
    }

...
public class NotificationCompat {
    ...
    public static final class BubbleMetadata {
        ...
        public static android.app.Notification.BubbleMetadata toPlatform(BubbleMetadata bubbleMetadata) {
        ...
        public static BubbleMetadata fromPlatform(android.app.Notification.BubbleMetadata bubbleMetadata) {
            if (bubbleMetadata == null) {
                return null;
            }
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            if (bitmap != null && VERSION.SDK_INT < 27) {
                ...
                int dimensionPixelSize = resources.getDimensionPixelSize(C0280R.dimen.compat_notification_large_icon_max_width);
                int dimensionPixelSize2 = resources.getDimensionPixelSize(C0280R.dimen.compat_notification_large_icon_max_height);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private android.widget.RemoteViews createRemoteViews(android.widget.RemoteViews r8, boolean r9) {
            /*
                r7 = this;
                int r0 = androidx.core.C0280R.layout.notification_template_custom_big
                r1 = 1
                r2 = 0
                android.widget.RemoteViews r0 = r7.applyStandardTemplate(r1, r0, r2)
                int r3 = androidx.core.C0280R.C0283id.actions
            ...
            L_0x0025:
                ...
                int r6 = androidx.core.C0280R.C0283id.actions
                r0.addView(r6, r5)
                int r4 = r4 + 1
                goto L_0x0025
            L_0x0039:
            ...
            L_0x003d:
                r2 = 8
            L_0x003f:
                int r9 = androidx.core.C0280R.C0283id.actions
                r0.setViewVisibility(r9, r2)
                int r9 = androidx.core.C0280R.C0283id.action_divider
                r0.setViewVisibility(r9, r2)
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0280R.layout.notification_action_tombstone : C0280R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0280R.C0283id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0280R.C0281color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0280R.C0283id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0280R.C0283id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0280R.C0283id.action_container, action.title);
            }
            return remoteViews;
        }
    }
            ...
            if (VERSION.SDK_INT >= 16) {
                ...
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    ...
                    if (size != this.mMessages.size() - 1) {
                        spannableStringBuilder.insert(0, Constants.NEW_LINE);
                    }
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            L_0x0023:
                ...
                int r14 = androidx.core.C0280R.C0283id.notification_background
                int r4 = androidx.core.C0280R.C0282drawable.notification_bg_low
                r7.setInt(r14, r2, r4)
                int r14 = androidx.core.C0280R.C0283id.icon
                int r4 = androidx.core.C0280R.C0282drawable.notification_template_icon_low_bg
                r7.setInt(r14, r2, r4)
                goto L_0x0050
            L_0x0042:
                int r14 = androidx.core.C0280R.C0283id.notification_background
                int r4 = androidx.core.C0280R.C0282drawable.notification_bg
                r7.setInt(r14, r2, r4)
                int r14 = androidx.core.C0280R.C0283id.icon
                int r4 = androidx.core.C0280R.C0282drawable.notification_template_icon_bg
                r7.setInt(r14, r2, r4)
            L_0x0050:
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0070:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x0104
                int r13 = androidx.core.C0280R.dimen.notification_right_icon_size
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = androidx.core.C0280R.dimen.notification_small_icon_background_padding
                ...
                int r14 = androidx.core.C0280R.C0283id.right_icon
                r7.setImageViewBitmap(r14, r13)
                goto L_0x00b3
            L_0x00a4:
                int r13 = androidx.core.C0280R.C0283id.right_icon
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x00b9:
                ...
                int r13 = r13.icon
                if (r13 == 0) goto L_0x0104
                int r13 = androidx.core.C0280R.C0283id.icon
                r7.setViewVisibility(r13, r9)
                int r13 = android.os.Build.VERSION.SDK_INT
                if (r13 < r3) goto L_0x00f5
                int r13 = androidx.core.C0280R.dimen.notification_large_icon_width
                int r13 = r0.getDimensionPixelSize(r13)
                int r14 = androidx.core.C0280R.dimen.notification_big_circle_margin
                int r14 = r0.getDimensionPixelSize(r14)
                int r13 = r13 - r14
                int r14 = androidx.core.C0280R.dimen.notification_small_icon_size_as_large
                int r14 = r0.getDimensionPixelSize(r14)
                androidx.core.app.NotificationCompat$Builder r1 = r12.mBuilder
                android.app.Notification r1 = r1.mNotification
                int r1 = r1.icon
            ...
            L_0x0104:
                ...
                int r13 = androidx.core.C0280R.C0283id.title
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0113:
                ...
                int r13 = androidx.core.C0280R.C0283id.text
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0132:
                ...
                int r13 = androidx.core.C0280R.C0283id.info
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
            ...
            L_0x0149:
                ...
                int r13 = androidx.core.C0280R.integer.status_bar_notification_info_maxnum
                int r13 = r0.getInteger(r13)
                androidx.core.app.NotificationCompat$Builder r14 = r12.mBuilder
                int r14 = r14.mNumber
                if (r14 <= r13) goto L_0x0167
                int r13 = androidx.core.C0280R.C0283id.info
                int r14 = androidx.core.C0280R.C0284string.status_bar_notification_info_overflow
                java.lang.String r14 = r0.getString(r14)
                r7.setTextViewText(r13, r14)
                goto L_0x0179
            L_0x0167:
                java.text.NumberFormat r13 = java.text.NumberFormat.getIntegerInstance()
                int r14 = androidx.core.C0280R.C0283id.info
                androidx.core.app.NotificationCompat$Builder r1 = r12.mBuilder
                int r1 = r1.mNumber
                long r1 = (long) r1
            ...
            L_0x0179:
                ...
                goto L_0x0146
            L_0x017f:
                int r1 = androidx.core.C0280R.C0283id.info
            ...
            L_0x0184:
                ...
                int r1 = androidx.core.C0280R.C0283id.text
                androidx.core.app.NotificationCompat$Builder r2 = r12.mBuilder
                ...
                int r1 = androidx.core.C0280R.C0283id.text2
                androidx.core.app.NotificationCompat$Builder r2 = r12.mBuilder
            ...
            L_0x01b3:
                ...
                int r15 = androidx.core.C0280R.dimen.notification_subtext_size
                int r15 = r0.getDimensionPixelSize(r15)
                float r15 = (float) r15
                int r0 = androidx.core.C0280R.C0283id.text
                r7.setTextViewTextSize(r0, r9, r15)
            L_0x01c7:
                int r2 = androidx.core.C0280R.C0283id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x01d1:
                ...
                int r14 = androidx.core.C0280R.C0283id.chronometer
                r7.setViewVisibility(r14, r9)
                int r14 = androidx.core.C0280R.C0283id.chronometer
                androidx.core.app.NotificationCompat$Builder r15 = r12.mBuilder
                long r0 = r15.getWhenIfShowing()
                ...
                goto L_0x0233
            L_0x0220:
                int r14 = androidx.core.C0280R.C0283id.time
                r7.setViewVisibility(r14, r9)
                int r14 = androidx.core.C0280R.C0283id.time
                androidx.core.app.NotificationCompat$Builder r15 = r12.mBuilder
                long r0 = r15.getWhenIfShowing()
            ...
            L_0x0233:
                r14 = 1
            L_0x0234:
                int r15 = androidx.core.C0280R.C0283id.right_side
            ...
            L_0x023c:
                ...
                int r14 = androidx.core.C0280R.C0283id.line3
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0280R.C0282drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0280R.C0283id.notification_main_column);
            remoteViews.addView(C0280R.C0283id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0280R.C0283id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0280R.C0283id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0280R.C0283id.title, 8);
            remoteViews.setViewVisibility(C0280R.C0283id.text2, 8);
            remoteViews.setViewVisibility(C0280R.C0283id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0280R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0280R.dimen.notification_top_pad_large_text);

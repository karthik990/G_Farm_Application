...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        private IntentBuilder(Context context, ComponentName componentName) {
            ...
            this.mIntent.putExtra(str, context.getPackageName());
            this.mIntent.putExtra(str, context.getPackageName());
            String str2 = "androidx.core.app.EXTRA_CALLING_ACTIVITY";
            this.mIntent.putExtra(str2, componentName);
            this.mIntent.putExtra(str2, componentName);
        ...
        public IntentBuilder setStream(Uri uri) {
            ...
            if (!str.equals(this.mIntent.getAction())) {
                this.mIntent.setAction(str);
            }
            this.mStreams = null;
    ...
    static String getCallingPackage(Intent intent) {
        ...
        return stringExtra == null ? intent.getStringExtra(str) : stringExtra;
    }
    ...
    static ComponentName getCallingActivity(Intent intent) {
        ...
        return componentName == null ? (ComponentName) intent.getParcelableExtra(str) : componentName;
    }

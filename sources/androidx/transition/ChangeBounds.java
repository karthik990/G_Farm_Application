...
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, Constants.KEY_RSS_POSITION) {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (i > 0) {
                ...
                if (!this.mResizeClip) {
                    ...
                    if (!rect.equals(rect8)) {
                        ...
                        final int i17 = i8;
                        final int i18 = i10;
                        C06188 r0 = new AnimatorListenerAdapter() {
            ...
            if (!(intValue == intValue3 && intValue2 == intValue4)) {
                ...
                C061110 r02 = new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animator) {
